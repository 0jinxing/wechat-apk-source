...
public class JsStubGenerator
{
  ...
  String[] classGenerator(ReflectionHelper paramReflectionHelper)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if (localMemberInfo.isStatic)
      {
        ...
        label127: switch (JsStubGenerator.1.$SwitchMap$org$xwalk$core$extension$ReflectionHelper$MemberType[localMemberInfo.type.ordinal()])
        {
        default:
      ...
      label222: str1 = str1 + paramReflectionHelper;
    }
  ...
  String generate()
  {
    ...
    label93: ReflectionHelper.MemberInfo localMemberInfo;
  ...
  String generateEntryPoint(ReflectionHelper.MemberInfo paramMemberInfo)
  {
    ...
    while (true)
    {
      ...
      else if (paramMemberInfo.type == ReflectionHelper.MemberType.JS_CONSTRUCTOR)
      {
  ...
  String generateMethod(String paramString, ReflectionHelper.MemberInfo paramMemberInfo, boolean paramBoolean)
  {
    ...
    {
      bool = true;
      label84: localObject = new StringBuilder("function %s(%s) {\n");
      if (!bool)
        break label218;
      paramMemberInfo = "  return ";
      label105: paramMemberInfo = String.format(paramMemberInfo + "helper.invokeNative(\"%s\", \"%s\", [%s], %b);\n};\n", new Object[] { str2, str3, paramString, str1, str3, Boolean.valueOf(bool) });
      if (!paramBoolean)
        break label225;
    }
    label218: label225: for (paramString = String.format("exports[\"%s\"] = %s;\n", new Object[] { str1, str2 }); ; paramString = "")
    {
  ...
  String generatePromiseMethod(String paramString, ReflectionHelper.MemberInfo paramMemberInfo)
  {
    ...
    {
      str2 = paramMemberInfo.wrapArgs;
      if (paramMemberInfo.wrapReturns.length() <= 0)
        break label86;
    }
    label86: for (paramMemberInfo = paramMemberInfo.wrapReturns; ; paramMemberInfo = "null")
    {
      paramString = String.format("jsStub.addMethodWithPromise(\"%s\", exports, \"%s\", %s, %s);\n", new Object[] { paramString, str1, str2, paramMemberInfo });
