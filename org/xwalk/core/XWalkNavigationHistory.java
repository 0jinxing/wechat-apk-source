...
public class XWalkNavigationHistory
{
  ...
  public boolean canGoBack()
  {
    ...
    try
    {
      bool = ((Boolean)this.canGoBackMethod.invoke(new Object[0])).booleanValue();
  ...
  public boolean canGoForward()
  {
    ...
    try
    {
      bool = ((Boolean)this.canGoForwardMethod.invoke(new Object[0])).booleanValue();
  ...
  public int getCurrentIndex()
  {
    ...
    try
    {
      i = ((Integer)this.getCurrentIndexMethod.invoke(new Object[0])).intValue();
  ...
  public boolean hasItemAt(int paramInt)
  {
    ...
    try
    {
      bool = ((Boolean)this.hasItemAtintMethod.invoke(new Object[] { Integer.valueOf(paramInt) })).booleanValue();
  ...
  public int size()
  {
    ...
    try
    {
      i = ((Integer)this.sizeMethod.invoke(new Object[0])).intValue();
