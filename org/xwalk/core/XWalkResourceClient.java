...
public class XWalkResourceClient
{
  ...
  void reflectionInit()
  {
    ...
    while (true)
    {
      ...
      Object localObject = new ReflectConstructor(this.coreWrapper.getBridgeClass("XWalkResourceClientBridge"), arrayOfClass);
      try
      {
  ...
  public boolean shouldOverrideUrlLoading(XWalkView paramXWalkView, String paramString)
  {
    ...
    try
    {
      bool = ((Boolean)this.shouldOverrideUrlLoadingXWalkViewInternalStringMethod.invoke(new Object[] { paramXWalkView.getBridge(), paramString })).booleanValue();
