...
public class Frame extends Mirror
{
  ...
  public ValueMirror getArgumentValue(int paramInt)
  {
    ...
    try
    {
      ...
      if (!isValue(localV8Object1))
      {
        ...
        localObject1 = localV8Object1;
        ((IllegalStateException)localObject2).<init>("Argument value is not a ValueMirror");
        localObject1 = localV8Object1;
  ...
  public ValueMirror getLocalValue(int paramInt)
  {
    ...
    try
    {
      ...
      if (!isValue(localV8Object1))
      {
        ...
        localObject2 = new java/lang/IllegalStateException;
        localObject1 = localV8Object1;
        ((IllegalStateException)localObject2).<init>("Local value is not a ValueMirror");
        localObject1 = localV8Object1;
  ...
  public SourceLocation getSourceLocation()
  {
    ...
    String str = localFunctionMirror.getScriptName();
    while (true)
    {
      try
      {
        ...
        if (localV8Object2 != null)
        {
          Object localObject1 = localV8Object2.getString("name");
          localV8Object2.release();
