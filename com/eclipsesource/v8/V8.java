...
public class V8 extends V8Object
{
  ...
  private void checkArgs(Object[] paramArrayOfObject)
  {
    ...
    for (int j = 0; j < i; j++)
      if (paramArrayOfObject[j] == invalid)
      {
  ...
  private Object checkResult(Object paramObject)
  {
    ...
    while (true)
    {
      ...
      else if (((paramObject instanceof Integer)) || ((paramObject instanceof Double)) || ((paramObject instanceof Boolean)) || ((paramObject instanceof String)))
      {
        AppMethodBeat.o(75235);
      }
      else
  ...
  private Object[] getArgs(V8Object paramV8Object, V8.MethodDescriptor paramMethodDescriptor, V8Array paramV8Array, boolean paramBoolean)
  {
    ...
    int i = paramMethodDescriptor.method.getParameterTypes().length;
    if (paramBoolean);
    for (int j = i - 1; ; j = i)
    {
      paramV8Object = setDefaultValues(new Object[i], paramMethodDescriptor.method.getParameterTypes(), paramV8Object, paramMethodDescriptor.includeReceiver);
      ArrayList localArrayList = new ArrayList();
      populateParamters(paramV8Array, j, paramV8Object, localArrayList, paramMethodDescriptor.includeReceiver);
      if (paramBoolean)
      {
        ...
        paramV8Object[j] = paramMethodDescriptor;
      }
  ...
  private Object getArrayItem(V8Array paramV8Array, int paramInt)
  {
    ...
    try
    {
      ...
      while (true)
      {
        ...
        paramV8Array = Integer.valueOf(paramInt);
        AppMethodBeat.o(75243);
        continue;
        double d = paramV8Array.getDouble(paramInt);
        paramV8Array = Double.valueOf(d);
        AppMethodBeat.o(75243);
        continue;
        boolean bool = paramV8Array.getBoolean(paramInt);
        paramV8Array = Boolean.valueOf(bool);
        AppMethodBeat.o(75243);
        continue;
  ...
  private void releaseArguments(Object[] paramArrayOfObject, boolean paramBoolean)
  {
    ...
    if ((paramBoolean) && (paramArrayOfObject.length > 0) && ((paramArrayOfObject[(paramArrayOfObject.length - 1)] instanceof Object[])))
      for (Object localObject2 : (Object[])paramArrayOfObject[(paramArrayOfObject.length - 1)])
  ...
  protected Object callObjectJavaMethod(long paramLong, V8Object paramV8Object, V8Array paramV8Array)
  {
    ...
    //   81: aload_0
    //   82: aload 4
    //   84: invokespecial 822	com/eclipsesource/v8/V8:checkArgs	([Ljava/lang/Object;)V
    //   87: aload_0
    //   88: aload 5
    //   90: getfield 421	com/eclipsesource/v8/V8$MethodDescriptor:method	Ljava/lang/reflect/Method;
    //   93: aload 5
    //   95: getfield 825	com/eclipsesource/v8/V8$MethodDescriptor:object	Ljava/lang/Object;
    //   98: aload 4
    //   100: invokevirtual 828	java/lang/reflect/Method:invoke	(Ljava/lang/Object;[Ljava/lang/Object;)Ljava/lang/Object;
    //   103: invokespecial 815	com/eclipsesource/v8/V8:checkResult	(Ljava/lang/Object;)Ljava/lang/Object;
    //   106: astore_3
    //   107: aload_0
    //   108: aload 4
    //   110: iload 6
    //   112: invokespecial 830	com/eclipsesource/v8/V8:releaseArguments	([Ljava/lang/Object;Z)V
    //   115: ldc_w 798
    //   118: invokestatic 97	com/tencent/matrix/trace/core/AppMethodBeat:o	(I)V
    //   121: goto -65 -> 56
    //   124: astore_3
    //   125: aload_3
    //   126: invokevirtual 834	java/lang/reflect/InvocationTargetException:getTargetException	()Ljava/lang/Throwable;
    //   129: astore_3
    //   130: ldc_w 798
    ...
    //   140: aload 4
    //   142: iload 6
    //   144: invokespecial 830	com/eclipsesource/v8/V8:releaseArguments	([Ljava/lang/Object;Z)V
    //   147: ldc_w 798
    ...
    //   164: astore_3
    //   165: ldc_w 798
    //   168: invokestatic 97	com/tencent/matrix/trace/core/AppMethodBeat:o	(I)V
    //   171: aload_3
    //   172: athrow
    //
    // Exception table:
    //   from	to	target	type
    //   87	107	124	java/lang/reflect/InvocationTargetException
    //   87	107	138	finally
    //   125	138	138	finally
    //   156	164	138	finally
    //   165	173	138	finally
    //   87	107	155	java/lang/IllegalAccessException
    //   87	107	164	java/lang/IllegalArgumentException
  }
  ...
  protected void callVoidJavaMethod(long paramLong, V8Object paramV8Object, V8Array paramV8Array)
  {
    ...
    //   110: astore 4
    //   112: aload 4
    //   114: invokevirtual 834	java/lang/reflect/InvocationTargetException:getTargetException	()Ljava/lang/Throwable;
    //   117: astore 4
    //   119: ldc_w 837
    //   122: invokestatic 97	com/tencent/matrix/trace/core/AppMethodBeat:o	(I)V
    //   125: aload 4
    //   127: athrow
    //   128: astore 4
    //   130: aload_0
    //   131: aload_3
    //   132: iload 6
    //   134: invokespecial 830	com/eclipsesource/v8/V8:releaseArguments	([Ljava/lang/Object;Z)V
    //   137: ldc_w 837
    ...
    // Exception table:
    //   from	to	target	type
    //   79	94	110	java/lang/reflect/InvocationTargetException
    //   79	94	128	finally
    //   112	128	128	finally
    //   148	157	128	finally
    //   159	168	128	finally
    //   79	94	146	java/lang/IllegalAccessException
    //   79	94	157	java/lang/IllegalArgumentException
  }
