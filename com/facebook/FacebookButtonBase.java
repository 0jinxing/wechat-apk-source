...
public abstract class FacebookButtonBase extends Button
{
  ...
  private void parseBackgroundAttributes(Context paramContext, AttributeSet paramAttributeSet, int paramInt1, int paramInt2)
  {
    ...
    while (true)
    {
      ...
      setBackgroundColor(b.i(paramContext, 2131689891));
    }
  }
  ...
  {
    paramAttributeSet = paramContext.getTheme().obtainStyledAttributes(paramAttributeSet, new int[] { 16842966, 16842967, 16842968, 16842969 }, paramInt1, paramInt2);
    try
    {
      setPadding(paramAttributeSet.getDimensionPixelSize(0, 0), paramAttributeSet.getDimensionPixelSize(1, 0), paramAttributeSet.getDimensionPixelSize(2, 0), paramAttributeSet.getDimensionPixelSize(3, 0));
      return;
    }
    finally
    {
  ...
  public int getCompoundPaddingLeft()
  {
    ...
    for (int i = this.overrideCompoundPaddingLeft; ; i = super.getCompoundPaddingLeft())
      return i;
  }
  ...
  {
    if (this.overrideCompoundPadding);
    for (int i = this.overrideCompoundPaddingRight; ; i = super.getCompoundPaddingRight())
      return i;
  }
  ...
  public android.support.v4.app.Fragment getFragment()
  {
    ...
    for (android.support.v4.app.Fragment localFragment = this.parentFragment.getSupportFragment(); ; localFragment = null)
  ...
  {
    if (this.parentFragment != null);
    for (android.app.Fragment localFragment = this.parentFragment.getNativeFragment(); ; localFragment = null)
      return localFragment;
  }
