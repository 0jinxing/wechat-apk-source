...
public final class FacebookSdk
{
  ...
  public static String getApplicationSignature(Context paramContext)
  {
    ...
    while (true)
    {
      ...
      else
      {
        ...
        try
        {
          paramContext = ((PackageManager)localObject2).getPackageInfo(paramContext, 64);
          localObject2 = paramContext.signatures;
        ...
        try
        {
          label90: localObject2 = MessageDigest.getInstance("SHA-1");
          ((MessageDigest)localObject2).update(paramContext.signatures[0].toByteArray());
          paramContext = Base64.encodeToString(((MessageDigest)localObject2).digest(), 9);
          AppMethodBeat.o(71627);
        }
  ...
  {
    if ((paramInt >= callbackRequestCodeOffset) && (paramInt < callbackRequestCodeOffset + 100));
  ...
  static void publishInstallAndWaitForResponse(Context paramContext, String paramString)
  {
    ...
    while (true)
    {
      ...
      catch (JSONException paramContext)
      {
        ...
        paramString.<init>("An error occurred while publishing install.", paramContext);
        AppMethodBeat.o(71621);
      }
    }
    throw paramString;
  ...
  public static void sdkInitialize(Context paramContext, InitializeCallback paramInitializeCallback)
  {
    while (true)
    {
      try
      {
        ...
        applicationContext = (Context)localObject1;
        loadDefaultsFromMetadata((Context)localObject1);
      ...
      Object localObject1 = new com/facebook/FacebookSdk$2;
      ((FacebookSdk.2)localObject1).<init>();
      FetchedAppSettingsManager.getAppSettingsAsync((FetchedAppSettingsManager.FetchedAppSettingsCallback)localObject1);
      NativeProtocol.updateAllAvailableProtocolVersionsAsync();
      BoltsMeasurementEventListener.getInstance(applicationContext);
      Object localObject2 = new com/facebook/internal/LockOnGetVariable;
      localObject1 = new com/facebook/FacebookSdk$3;
      ((FacebookSdk.3)localObject1).<init>();
      ((LockOnGetVariable)localObject2).<init>((Callable)localObject1);
      cacheDir = (LockOnGetVariable)localObject2;
      localObject2 = new java/util/concurrent/FutureTask;
      localObject1 = new com/facebook/FacebookSdk$4;
      ((FacebookSdk.4)localObject1).<init>(paramInitializeCallback, paramContext);
      ((FutureTask)localObject2).<init>((Callable)localObject1);
      getExecutor().execute((Runnable)localObject2);
      AppMethodBeat.o(71608);
    }
  }
