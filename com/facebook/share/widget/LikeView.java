...
public class LikeView extends FrameLayout
{
  ...
  private void associateWithLikeActionController(LikeActionController paramLikeActionController)
  {
    ...
    paramLikeActionController = d.S(getContext());
  ...
  private void initialize(Context paramContext)
  {
    ...
    this.edgePadding = getResources().getDimensionPixelSize(2131428241);
    this.internalPadding = getResources().getDimensionPixelSize(2131428242);
    if (this.foregroundColor == -1)
      this.foregroundColor = getResources().getColor(2131689905);
  ...
  private void initializeSocialSentenceView(Context paramContext)
  {
    ...
    this.socialSentenceView.setTextSize(0, getResources().getDimension(2131428243));
  ...
  private void updateLayout()
  {
    ...
    {
      j = 3;
      ((FrameLayout.LayoutParams)localObject1).gravity = (j | 0x30);
      ((LinearLayout.LayoutParams)localObject2).gravity = j;
      ...
      if ((this.likeViewStyle != LikeView.Style.STANDARD) || (this.likeActionController == null) || (Utility.isNullOrEmpty(this.likeActionController.getSocialSentence())))
        break label273;
      localObject2 = this.socialSentenceView;
      label111: ((View)localObject2).setVisibility(0);
      ((LinearLayout.LayoutParams)((View)localObject2).getLayoutParams()).gravity = j;
      localObject1 = this.containerView;
      j = i;
      if (this.auxiliaryViewPosition == LikeView.AuxiliaryViewPosition.INLINE)
        j = 0;
      ((LinearLayout)localObject1).setOrientation(j);
      ...
      this.containerView.addView(this.likeButton);
      label207: switch (LikeView.2.$SwitchMap$com$facebook$share$widget$LikeView$AuxiliaryViewPosition[this.auxiliaryViewPosition.ordinal()])
      {
      default:
      case 1:
      case 2:
    ...
    while (true)
    {
      ...
      while (true)
      {
        ...
        j = 5;
        break;
        label273: if ((this.likeViewStyle == LikeView.Style.BOX_COUNT) && (this.likeActionController != null) && (!Utility.isNullOrEmpty(this.likeActionController.getLikeCountString())))
        {
          updateBoxCountCaretPosition();
          localObject2 = this.likeBoxCountView;
          break label111;
        }
        AppMethodBeat.o(97670);
        continue;
        label324: this.containerView.removeView((View)localObject2);
        this.containerView.addView((View)localObject2);
        break label207;
        ((View)localObject2).setPadding(this.edgePadding, this.edgePadding, this.edgePadding, this.internalPadding);
        AppMethodBeat.o(97670);
        continue;
        ((View)localObject2).setPadding(this.edgePadding, this.internalPadding, this.edgePadding, this.edgePadding);
        AppMethodBeat.o(97670);
        continue;
        if (this.horizontalAlignment != LikeView.HorizontalAlignment.RIGHT)
          break label440;
        ((View)localObject2).setPadding(this.edgePadding, this.edgePadding, this.internalPadding, this.edgePadding);
        AppMethodBeat.o(97670);
      }
      label440: ((View)localObject2).setPadding(this.internalPadding, this.edgePadding, this.edgePadding, this.edgePadding);
    }
  }
  ...
  private void updateLikeStateAndLayout()
  {
    ...
    while (true)
    {
      ...
      bool = false;
      break;
      label75: this.likeButton.setSelected(this.likeActionController.isObjectLiked());
