  ...
  implements Serializable
{
  ...
  private String calculateChecksum()
  {
    ...
    while (true)
    {
      ...
      localObject1 = this.jsonObject.keys();
  ...
  private static JSONObject getJSONObjectForAppEvent(String paramString1, String paramString2, Double paramDouble, Bundle paramBundle, boolean paramBoolean, UUID paramUUID)
  {
    ...
    if (paramBundle != null)
    {
      ...
      while (paramDouble.hasNext())
      {
        ...
        {
          paramString1 = new FacebookException(String.format("Parameter value '%s' for key '%s' should be a string or a numeric type.", new Object[] { paramString1, paramString2 }));
          AppMethodBeat.o(71871);
          throw paramString1;
        }
        localJSONObject.put(paramString2, paramString1.toString());
      }
    }
    if (!paramBoolean)
  ...
  public boolean isChecksumValid()
  {
    ...
    {
      return bool;
      bool = calculateChecksum().equals(this.checksum);
      AppMethodBeat.o(71869);
    }
  }
