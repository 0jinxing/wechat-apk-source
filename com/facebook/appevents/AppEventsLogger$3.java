  ...
  implements Runnable
{
  ...
  public final void run()
  {
    ...
    try
    {
      ...
      try
      {
        label26: Class.forName("com.facebook.login.Login");
        localBundle.putInt("login_lib_included", 1);
        try
        {
          label39: Class.forName("com.facebook.share.Share");
          localBundle.putInt("share_lib_included", 1);
          try
          {
            label52: Class.forName("com.facebook.places.Places");
            localBundle.putInt("places_lib_included", 1);
            try
            {
              label65: Class.forName("com.facebook.messenger.Messenger");
              localBundle.putInt("messenger_lib_included", 1);
              try
              {
                label78: Class.forName("com.facebook.applinks.AppLinks");
                localBundle.putInt("applinks_lib_included", 1);
                try
                {
                  label91: Class.forName("com.facebook.marketing.Marketing");
                  localBundle.putInt("marketing_lib_included", 1);
                  try
                  {
                    label104: Class.forName("com.facebook.all.All");
                    localBundle.putInt("all_lib_included", 1);
                    try
                    {
                      label117: Class.forName("com.android.billingclient.api.BillingClient");
                      localBundle.putInt("billing_client_lib_included", 1);
                      try
                      {
                        label130: Class.forName("com.android.vending.billing.IInAppBillingService");
                        localBundle.putInt("billing_service_lib_included", 1);
                        label143: this.val$logger.logSdkEvent("fb_sdk_initialize", null, localBundle);
