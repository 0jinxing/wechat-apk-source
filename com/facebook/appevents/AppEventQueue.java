...
class AppEventQueue
{
  ...
  private static GraphRequest buildRequestForSession(AccessTokenAppIdPair paramAccessTokenAppIdPair, SessionEventsState paramSessionEventsState, boolean paramBoolean, FlushStatistics paramFlushStatistics)
  {
    ...
    for (boolean bool = localFetchedAppSettings.supportsImplicitLogging(); ; bool = false)
    {
      ...
      for (paramAccessTokenAppIdPair = null; ; paramAccessTokenAppIdPair = localGraphRequest)
      {
  ...
  static void flushAndWait(FlushReason paramFlushReason)
  {
    ...
    try
    {
      ...
      if (localObject != null)
      {
        paramFlushReason = new Intent("com.facebook.sdk.APP_EVENTS_FLUSHED");
        paramFlushReason.putExtra("com.facebook.sdk.APP_EVENTS_NUM_EVENTS_FLUSHED", ((FlushStatistics)localObject).numEvents);
        paramFlushReason.putExtra("com.facebook.sdk.APP_EVENTS_FLUSH_RESULT", ((FlushStatistics)localObject).result);
        d.S(FacebookSdk.getApplicationContext()).c(paramFlushReason);
      }
