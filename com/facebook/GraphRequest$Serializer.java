  ...
  implements GraphRequest.KeyValueSerializer
{
  ...
  public void write(String paramString, Object[] paramArrayOfObject)
  {
    ...
    {
      return;
      this.outputStream.write(URLEncoder.encode(String.format(Locale.US, paramString, paramArrayOfObject), "UTF-8").getBytes());
      AppMethodBeat.o(71662);
    }
  }
  ...
  public void writeObject(String paramString, Object paramObject, GraphRequest paramGraphRequest)
  {
    ...
    AppMethodBeat.o(71652);
    throw paramString;
    label232: paramString = getInvalidTypeError();
    AppMethodBeat.o(71652);
    throw paramString;
  }
  ...
  public void writeRequestsAsJson(String paramString, JSONArray paramJSONArray, Collection<GraphRequest> paramCollection)
  {
    ...
    while (true)
    {
      ...
      {
        paramCollection = (GraphRequest)localIterator.next();
