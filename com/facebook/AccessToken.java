  ...
  implements Parcelable
{
  ...
  public AccessToken(String paramString1, String paramString2, String paramString3, Collection<String> paramCollection1, Collection<String> paramCollection2, AccessTokenSource paramAccessTokenSource, Date paramDate1, Date paramDate2, Date paramDate3)
  {
    ...
    if (paramDate1 != null)
    {
      ...
      label54: this.permissions = Collections.unmodifiableSet(paramCollection1);
      if (paramCollection2 == null)
        break label172;
      paramCollection1 = new HashSet(paramCollection2);
      label79: this.declinedPermissions = Collections.unmodifiableSet(paramCollection1);
      this.token = paramString1;
      if (paramAccessTokenSource == null)
        break label184;
      label98: this.source = paramAccessTokenSource;
      if (paramDate2 == null)
        break label192;
      label109: this.lastRefresh = paramDate2;
    ...
    while (true)
    {
      ...
      break;
      label160: paramCollection1 = new HashSet();
      break label54;
      label172: paramCollection1 = new HashSet();
      break label79;
      label184: paramAccessTokenSource = DEFAULT_ACCESS_TOKEN_SOURCE;
      break label98;
      label192: paramDate2 = DEFAULT_LAST_REFRESH_TIME;
      break label109;
      label200: paramDate3 = DEFAULT_EXPIRATION_TIME;
    }
  }
  ...
  private static AccessToken createFromBundle(List<String> paramList, Bundle paramBundle, AccessTokenSource paramAccessTokenSource, Date paramDate, String paramString)
  {
    ...
    {
      return paramList;
      paramList = new AccessToken(str, paramString, paramDate, paramList, null, paramAccessTokenSource, localDate, new Date(), paramBundle);
      AppMethodBeat.o(71533);
    }
  }
  ...
  static AccessToken createFromLegacyCache(Bundle paramBundle)
  {
    ...
    try
    {
      ...
      paramBundle = new AccessToken(str1, str2, (String)localObject, localList1, localList2, LegacyTokenHelper.getSource(paramBundle), LegacyTokenHelper.getDate(paramBundle, "com.facebook.TokenCachingStrategy.ExpirationDate"), LegacyTokenHelper.getDate(paramBundle, "com.facebook.TokenCachingStrategy.LastRefreshDate"), null);
  ...
  public final boolean equals(Object paramObject)
  {
    ...
    while (true)
    {
      ...
      else
      {
        ...
        label194: AppMethodBeat.o(71523);
        bool = false;
      }
    }
  }
  ...
  public final int hashCode()
  {
    ...
    int i = this.expires.hashCode();
    int j = this.permissions.hashCode();
    int k = this.declinedPermissions.hashCode();
    int m = this.token.hashCode();
    int n = this.source.hashCode();
    int i1 = this.lastRefresh.hashCode();
    if (this.applicationId == null);
    for (int i2 = 0; ; i2 = this.applicationId.hashCode())
    {
      int i3 = this.userId.hashCode();
      int i4 = this.dataAccessExpirationTime.hashCode();
      AppMethodBeat.o(71524);
      return ((i2 + ((((((i + 527) * 31 + j) * 31 + k) * 31 + m) * 31 + n) * 31 + i1) * 31) * 31 + i3) * 31 + i4;
    }
  }
