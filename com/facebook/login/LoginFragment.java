...
public class LoginFragment extends Fragment
{
  ...
  public void onCreate(Bundle paramBundle)
  {
    ...
    while (true)
    {
      ...
      break;
      label76: initializeCallingPackage(paramBundle);
  ...
  public View onCreateView(LayoutInflater paramLayoutInflater, ViewGroup paramViewGroup, Bundle paramBundle)
  {
    ...
    paramViewGroup = paramLayoutInflater.findViewById(2131822896);
  ...
  public void onPause()
  {
    ...
    super.onPause();
    if (getView() == null);
    for (View localView = null; ; localView = getView().findViewById(2131822896))
    {
      if (localView != null)
