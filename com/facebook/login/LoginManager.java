...
public class LoginManager
{
  ...
  private void finishLogin(AccessToken paramAccessToken, LoginClient.Request paramRequest, FacebookException paramFacebookException, boolean paramBoolean, FacebookCallback<LoginResult> paramFacebookCallback)
  {
    ...
    while (true)
    {
      ...
      paramRequest = null;
      break;
      label70: if (paramFacebookException != null)
      {
  ...
  public static LoginManager getInstance()
  {
    ...
    try
    {
      if (instance == null)
      {
        localLoginManager = new com/facebook/login/LoginManager;
  ...
  private void logInWithPublishPermissions(FragmentWrapper paramFragmentWrapper, Collection<String> paramCollection)
  {
    ...
    startLogin(new LoginManager.FragmentStartActivityDelegate(paramFragmentWrapper), paramCollection);
  ...
  private void reauthorizeDataAccess(FragmentWrapper paramFragmentWrapper)
  {
    ...
    startLogin(new LoginManager.FragmentStartActivityDelegate(paramFragmentWrapper), localRequest);
  ...
  private void resolveError(FragmentWrapper paramFragmentWrapper, GraphResponse paramGraphResponse)
  {
    ...
    startLogin(new LoginManager.FragmentStartActivityDelegate(paramFragmentWrapper), createLoginRequestFromResponse(paramGraphResponse));
  ...
  private void validateReadPermissions(Collection<String> paramCollection)
  {
    ...
    while (true)
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        {
          paramCollection = new FacebookException(String.format("Cannot pass a publish or manage permission (%s) to a request for read authorization", new Object[] { paramCollection }));
          AppMethodBeat.o(96907);
          throw paramCollection;
        }
      }
  ...
  boolean onActivityResult(int paramInt, Intent paramIntent, FacebookCallback<LoginResult> paramFacebookCallback)
  {
    ...
    Object localObject3 = LoginClient.Result.Code.ERROR;
    ...
    if (paramIntent != null)
    {
      localObject4 = (LoginClient.Result)paramIntent.getParcelableExtra("com.facebook.LoginFragment:Result");
      if (localObject4 == null)
        break label262;
      localRequest = ((LoginClient.Result)localObject4).request;
      localObject2 = ((LoginClient.Result)localObject4).code;
      if (paramInt == -1)
        if (((LoginClient.Result)localObject4).code == LoginClient.Result.Code.SUCCESS)
        {
          paramIntent = ((LoginClient.Result)localObject4).token;
          localObject3 = null;
          localObject4 = ((LoginClient.Result)localObject4).loggingExtras;
    ...
    for (localObject3 = localObject1; ; localObject3 = localObject1)
    {
      ...
      while (true)
      {
        label115: if ((localObject2 == null) && (localObject3 == null) && (!bool2))
          localObject2 = new FacebookException("Unexpected call to LoginManager.onActivityResult");
        while (true)
        {
          logCompleteLogin(null, paramIntent, (Map)localObject4, (Exception)localObject2, true, localRequest);
          finishLogin((AccessToken)localObject3, localRequest, (FacebookException)localObject2, bool2, paramFacebookCallback);
          AppMethodBeat.o(96891);
          return true;
          localObject3 = new FacebookAuthorizationException(((LoginClient.Result)localObject4).errorMessage);
          paramIntent = null;
          break;
          if (paramInt != 0)
            break label254;
        ...
        label234: bool2 = false;
        Object localObject5 = null;
        paramIntent = (Intent)localObject3;
        localObject2 = localObject1;
        localObject3 = localObject5;
      }
      label254: paramIntent = null;
      localObject3 = null;
      break;
      label262: localRequest = null;
      localObject4 = null;
      localObject1 = null;
      bool2 = bool1;
