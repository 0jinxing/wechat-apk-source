...
public class LoginButton extends FacebookButtonBase
{
  ...
  private void checkToolTipSettings()
  {
    ...
    while (true)
    {
      ...
      displayToolTip(getResources().getString(2131296317));
    }
  }
  ...
  private void setButtonText()
  {
    ...
    {
      return;
      localObject = localResources.getString(2131296307);
      break;
      ...
      {
        String str = localResources.getString(2131296304);
        int i = getWidth();
        localObject = str;
        if (i != 0)
        {
          ...
          if (measureButtonWidth(str) > i)
            localObject = localResources.getString(2131296303);
        }
        setText((CharSequence)localObject);
        AppMethodBeat.o(92678);
      }
  ...
  public void configureButton(Context paramContext, AttributeSet paramAttributeSet, int paramInt1, int paramInt2)
  {
    ...
    if (isInEditMode())
    {
      setBackgroundColor(getResources().getColor(2131689891));
      this.loginText = "Continue with Facebook";
    }
    while (true)
    {
      setButtonText();
      setCompoundDrawablesWithIntrinsicBounds(b.g(getContext(), 2130838381), null, null, null);
  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    paramInt2 = (int)Math.ceil(Math.abs(((Paint.FontMetrics)localObject).bottom) + f);
    ...
    if (str == null)
    {
      localObject = localResources.getString(2131296304);
    ...
    if (str == null)
      localObject = localResources.getString(2131296307);
    setMeasuredDimension(resolveSize(Math.max(k, measureButtonWidth((String)localObject)), paramInt1), j + (paramInt2 + i));
  ...
  public void setPublishPermissions(String[] paramArrayOfString)
  {
    ...
    this.properties.setPublishPermissions(Arrays.asList(paramArrayOfString));
  ...
  public void setReadPermissions(String[] paramArrayOfString)
  {
    ...
    this.properties.setReadPermissions(Arrays.asList(paramArrayOfString));
