  ...
  implements Parcelable
{
  ...
  boolean checkInternetPermission()
  {
    ...
    while (true)
    {
      ...
      if (checkPermission("android.permission.INTERNET") != 0)
      {
        ...
        String str = ((Activity)localObject).getString(2131296298);
        localObject = ((Activity)localObject).getString(2131296297);
  ...
  {
    if (this.currentHandler >= 0);
    for (LoginMethodHandler localLoginMethodHandler = this.handlersToTry[this.currentHandler]; ; localLoginMethodHandler = null)
      return localLoginMethodHandler;
  }
  ...
  public boolean onActivityResult(int paramInt1, int paramInt2, Intent paramIntent)
  {
    ...
    if (this.pendingRequest != null)
    {
      bool = getCurrentHandler().onActivityResult(paramInt1, paramInt2, paramIntent);
  ...
  boolean tryCurrentHandler()
  {
    ...
    bool = localLoginMethodHandler.tryAuthorize(this.pendingRequest);
    if (bool)
