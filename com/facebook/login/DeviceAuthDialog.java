...
public class DeviceAuthDialog extends DialogFragment
{
  ...
  private void onSuccess(String paramString, Long paramLong1, Long paramLong2)
  {
    ...
    label147: for (paramLong2 = new Date(paramLong2.longValue() * 1000L); ; paramLong2 = null)
    {
  ...
  private void presentConfirmation(final String paramString1, final Utility.PermissionsPair paramPermissionsPair, final String paramString2, String paramString3, final Date paramDate1, final Date paramDate2)
  {
    ...
    String str1 = getResources().getString(2131296316);
    String str2 = getResources().getString(2131296315);
    String str3 = getResources().getString(2131296314);
  ...
  {
    if (paramBoolean);
    for (int i = 2130969170; ; i = 2130969168)
      return i;
  }
  ...
  protected View initializeContentView(boolean paramBoolean)
  {
    ...
    this.progressBar = localView.findViewById(2131821099);
    this.confirmationCode = ((TextView)localView.findViewById(2131822893));
    ((Button)localView.findViewById(2131822895)).setOnClickListener(new DeviceAuthDialog.2(this));
    this.instructions = ((TextView)localView.findViewById(2131822894));
    this.instructions.setText(Html.fromHtml(getString(2131296295)));
