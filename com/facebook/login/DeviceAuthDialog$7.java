  ...
  public void onCompleted(GraphResponse paramGraphResponse)
  {
    ...
    while (true)
    {
      ...
      else
      {
        ...
        continue;
        label181: DeviceAuthDialog.access$900(this.this$0, paramGraphResponse, localPermissionsPair, this.val$accessToken, this.val$expirationTime, this.val$dataAccessExpirationTimeDate);
        AppMethodBeat.o(96717);
      }
    }
  }
