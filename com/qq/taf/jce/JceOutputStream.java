...
public class JceOutputStream
{
  ...
  public static void main(String[] paramArrayOfString)
  {
    ...
    paramArrayOfString = localJceOutputStream.getByteBuffer();
    System.out.println(HexUtil.bytes2HexStr(paramArrayOfString.array()));
  ...
  public <K, V> void write(Map<K, V> paramMap, int paramInt)
  {
    ...
    while (true)
    {
      ...
      write(paramMap.getKey(), 0);
      write(paramMap.getValue(), 1);
    }
  }
