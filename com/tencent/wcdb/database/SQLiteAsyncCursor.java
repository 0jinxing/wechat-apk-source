...
public class SQLiteAsyncCursor extends AbstractCursor
{
    ...
    try
    {
      synchronized (this.mWaitLock)
      {
        ...
        if (l == 0L)
          ...
          {
            CursorIndexOutOfBoundsException localCursorIndexOutOfBoundsException = new com/tencent/wcdb/CursorIndexOutOfBoundsException;
            localCursorIndexOutOfBoundsException.<init>(this.mPos, this.mCount);
  ...
  public void onDeactivateOrClose()
  {
    ...
    try
    {
      ...
      label52: this.mQueryThread = null;
      if (this.mWindow != null)
      {
        this.mWindow.close();
        this.mWindow = null;
