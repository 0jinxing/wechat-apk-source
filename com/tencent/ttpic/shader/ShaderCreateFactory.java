...
public class ShaderCreateFactory
{
  ...
  static
  {
    if (VideoModule.es_GL_EXT_shader_framebuffer_fetch)
    {
      ...
      label22: FRAGMENT_SHADER_VIDEO_FILE = str;
      if (!VideoModule.es_GL_EXT_shader_framebuffer_fetch)
        break label52;
    }
    label46: label52: for (String str = "MCCommonFragmentShaderETCExt.dat"; ; str = "MCCommonFragmentShaderETC.dat")
    {
