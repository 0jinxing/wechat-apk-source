...
class GLSurfaceView$EglHelper
{
  ...
  GL createGL()
  {
    ...
    GL localGL1 = this.mEglContext.getGL();
    ...
    if (localGLSurfaceView != null)
    {
      ...
      if (GLSurfaceView.access$600(localGLSurfaceView) != null)
        localGL2 = GLSurfaceView.access$600(localGLSurfaceView).wrap(localGL1);
    ...
    label112: for (localObject = new GLSurfaceView.LogWriter(); ; localObject = null)
    {
  ...
  public boolean createSurface()
  {
    ...
    if (localObject != null)
    {
      this.mEglSurface = GLSurfaceView.access$500((GLSurfaceView)localObject).createWindowSurface(this.mEgl, this.mEglDisplay, this.mEglConfig, ((GLSurfaceView)localObject).getHolder());
      if ((this.mEglSurface != null) && (this.mEglSurface != EGL10.EGL_NO_SURFACE))
        break label169;
    ...
    while (true)
    {
      ...
      this.mEglSurface = null;
      break;
      label169: if (!this.mEgl.eglMakeCurrent(this.mEglDisplay, this.mEglSurface, this.mEglSurface, this.mEglContext))
      {
