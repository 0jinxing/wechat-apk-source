...
public class ARMatrixUtil
{
  ...
  public static float[] calProjectionMatrix(float paramFloat1, float paramFloat2)
  {
    ...
    if (!isProjectionMatInitialized)
    {
      ...
      float f1 = renderHeight * 1.0F / renderWidth;
      float f2 = -nearRectWidth / 2.0F;
      float f3 = nearRectWidth / 2.0F;
      float f4 = -nearRectWidth / 2.0F * f1;
      f1 = nearRectWidth / 2.0F * f1;
      nearRectHeight = f1 - f4;
      near = paramFloat1;
      far = paramFloat2;
      Matrix.frustumM(mProjectionMatrix, 0, f2, f3, f4, f1, near, far);
  ...
  public static void setOrientationVector(float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4, float paramFloat5, float paramFloat6)
  {
    ...
    paramFloat3 = cameraRightY;
    paramFloat6 = cameraRightZ;
    paramFloat2 = cameraX;
    paramFloat4 = cameraY;
    paramFloat5 = cameraZ;
    float[] arrayOfFloat = vectorNormalization(vectorCrossProduct(new float[] { paramFloat1, paramFloat3, paramFloat6 }, new float[] { paramFloat2, paramFloat4, paramFloat5 }));
  ...
  public static void startOrientationSensor()
  {
    ...
    label68: label73: for (Object localObject = new ImprovedOrientationSensor2Provider((SensorManager)VideoGlobalContext.getContext().getSystemService("sensor")); ; localObject = new SimpleOrientationSensorProvider((SensorManager)VideoGlobalContext.getContext().getSystemService("sensor")))
    {
  ...
  public static void updateOrientation()
  {
    ...
    orientationProvider.getEulerAngles(arrayOfFloat1);
    if ((canUseImprovedSensorProvider) && (isSensorDataNaN(arrayOfFloat1)))
    {
    ...
    while (true)
    {
      ...
      getRotation44(arrayOfFloat1, arrayOfFloat2);
      arrayOfFloat1 = new float[16];
      Matrix.multiplyMM(arrayOfFloat1, 0, new float[] { 1.0F, 0.0F, 0.0F, 0.0F, 0.0F, 1.0F, 0.0F, 0.0F, 0.0F, 0.0F, 1.0F, 0.0F, 0.0F, 0.0F, 0.0F, 1.0F }, 0, arrayOfFloat2, 0);
      setOrientationVector(arrayOfFloat1[4], arrayOfFloat1[6], arrayOfFloat1[5], -arrayOfFloat1[8], -arrayOfFloat1[10], -arrayOfFloat1[9]);
      AppMethodBeat.o(81754);
    }
  }
