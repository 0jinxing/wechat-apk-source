...
public class GamePlaySDK
{
  ...
  public static GamePlaySDK getInstance()
  {
    try
    {
      ...
      if (mInstance == null)
      {
        localGamePlaySDK = new com/tencent/ttpic/gameplaysdk/GamePlaySDK;
        localGamePlaySDK.<init>();
        mInstance = localGamePlaySDK;
      }
  ...
  private void loadGamePlaySOForDebug()
  {
    ...
    try
    {
      if (!this.isSoLoaded)
      {
        ...
        localObject1 = Environment.getExternalStorageDirectory() + File.separator + "libgameplay.so";
        ...
        if (!localFile.exists())
        {
          ...
          ((StringBuilder)localObject1).<init>();
          ((StringBuilder)localObject1).append(localFile.getAbsolutePath()).append(" is not fond!");
        }
        localObject1 = new java/io/FileInputStream;
        ((FileInputStream)localObject1).<init>(localFile);
        Object localObject2 = context.getDir("libs", 0);
        localFile = new java/io/File;
        localFile.<init>((File)localObject2, "libgameplay.so");
        localObject2 = new java/lang/StringBuilder;
        ((StringBuilder)localObject2).<init>("### ");
        ((StringBuilder)localObject2).append(localFile.getAbsolutePath()).append(" is not exists");
  ...
  public boolean isInited()
  {
    ...
    if ((localObject != null) && ((localObject instanceof GamePlaySDK.State)))
    {
      bool = ((GamePlaySDK.State)localObject).isInited;
