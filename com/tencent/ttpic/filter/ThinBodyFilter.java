...
public class ThinBodyFilter extends VideoFilterBase
{
  ...
  public ThinBodyFilter()
  {
    ...
    for (i = 0; j < this.smoothedWithinFrames; i = k)
    {
      k = i;
      if (this.previousValidFrames[j] == 1)
      {
        k = i + 1;
        localThinBodyParameters1 = this.previousParams[j];
    ...
    if (i > 0)
    {
      ...
      localThinBodyParameters1.y0 /= i;
      localThinBodyParameters1 = this.smoothedParams;
      localThinBodyParameters1.y1 /= i;
      localThinBodyParameters1 = this.smoothedParams;
      localThinBodyParameters1.y2 /= i;
      localThinBodyParameters1 = this.smoothedParams;
      localThinBodyParameters1.middleLine /= i;
      localThinBodyParameters1 = this.smoothedParams;
      localThinBodyParameters1.waistWidth /= i;
    }
  ...
  private void calculateMiddleLineWithNormalizedPoints()
  {
    ...
    while (j < i)
    {
      PointF localPointF1 = this.pointsNormalized[leftIndexs[j]];
      PointF localPointF2 = this.pointsNormalized[rightIndexs[j]];
