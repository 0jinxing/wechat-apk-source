...
public class FabbyFilters
{
  ...
  private void updateCurrentPartIndex(Set<Integer> paramSet, long paramLong)
  {
    ...
    i = 0;
    label216: if (i < this.fabbyMvFilters.size())
    ...
    for (i = j; ; i = 1)
    {
      ...
      if (this.mMvPartIndex == this.mLastRenderPartIndex)
        break;
      l2 = this.mStartTime;
      paramLong = ((Long)this.mBaseOffsetTimeList.get(this.mLastRenderPartIndex)).longValue();
      updateTransitionParam(((FabbyMvFilter)this.fabbyMvFilters.get(this.mLastRenderPartIndex)).mvPart.transitionDuration + (l2 + paramLong) + this.mOffsetTimeFromTrigger);
      break;
    }
  }
  ...
  public h updateAndRender(h paramh, Map<Integer, h> paramMap, Map<Integer, FaceActionCounter> paramMap1, Set<Integer> paramSet, long paramLong)
  {
    ...
    while (true)
    {
      ...
      break;
      label164: this.transitionFilter.reset();
      this.mTransitionDeadLine = 0L;
    }
  }
