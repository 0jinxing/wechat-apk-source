...
public class ChannelScaleFilter extends BaseFilter
{
  ...
  public void beforeRender(int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    while (true)
    {
      ...
      f6 = (float)Math.sqrt(this.vectorL[0] * this.vectorL[0] + this.vectorL[1] * this.vectorL[1]);
      if (f6 > 0.0F)
      {
      ...
      f6 = this.vectorS[0];
      this.radiusS1 = (Math.abs((((PointF)localList.get(0)).y - this.faceCenter[1]) * this.vectorS[1] + f6 * (f2 - f3)) * 1.05F);
      f3 = ((PointF)localList.get(18)).x;
      f2 = this.faceCenter[0];
      f6 = this.vectorS[0];
      this.radiusS2 = (Math.abs((((PointF)localList.get(18)).y - this.faceCenter[1]) * this.vectorS[1] + f6 * (f3 - f2)) * 1.05F);
      addParam(new m.f("radiusS1", this.radiusS1));
      addParam(new m.f("radiusS2", this.radiusS2));
