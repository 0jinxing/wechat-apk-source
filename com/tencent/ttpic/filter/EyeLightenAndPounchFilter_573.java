...
public class EyeLightenAndPounchFilter_573 extends VideoFilterBase
{
  ...
  public void updatePointParams(List<PointF> paramList)
  {
    ...
    while (true)
    {
      ...
      addParam(new m.g("center1", new float[] { f3, f2 }));
      addParam(new m.g("center2", new float[] { f4, f1 }));
