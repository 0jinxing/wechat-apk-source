    ...
    while (true)
    {
      ...
      while (paramList2.hasNext())
      {
        ...
        while (localIterator.hasNext())
        {
          ...
          localArrayList.add(new PointF((((PointF)localObject).x + paramList1.x / paramFloat) / paramInt1 * 2.0F - 1.0F, -((((PointF)localObject).y + paramList1.y / paramFloat) / paramInt2 * 2.0F - 1.0F)));
        }
