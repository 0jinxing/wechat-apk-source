...
public abstract class WMAnimationFilterBase extends BaseFilter
{
  ...
  protected float getAnimationValue()
  {
    ...
    int i = 1;
    WMAnimationFilterBase.AnimationTimePoint localAnimationTimePoint1;
    WMAnimationFilterBase.AnimationTimePoint localAnimationTimePoint2;
    float f1;
    if (i < this.mAnimationTimePoints.size())
    {
      localAnimationTimePoint1 = (WMAnimationFilterBase.AnimationTimePoint)this.mAnimationTimePoints.get(i - 1);
      localAnimationTimePoint2 = (WMAnimationFilterBase.AnimationTimePoint)this.mAnimationTimePoints.get(i);
      if (l <= localAnimationTimePoint2.timePoint)
      {
        f1 = (float)(l - localAnimationTimePoint1.timePoint) * 1.0F / (float)(localAnimationTimePoint2.timePoint - localAnimationTimePoint1.timePoint);
        f2 = localAnimationTimePoint1.value;
      }
    }
    for (float f2 = (localAnimationTimePoint2.value - localAnimationTimePoint1.value) * f1 + f2; ; f2 = 0.0F)
    {
      return f2;
      i++;
      break;
