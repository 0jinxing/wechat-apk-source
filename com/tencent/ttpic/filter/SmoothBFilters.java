...
public class SmoothBFilters
{
  ...
  public void updateAndRender(h paramh1, h paramh2, List<List<PointF>> paramList, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    if ((this.mProcessVarianceFilter.getBlurAlpha() > 0.01F) && (paramList != null) && (paramList.size() > 0))
    {
      ...
      FrameUtil.clearFrame(this.mVarianceFrame1, 0.0F, 1.0F, 0.0F, 1.0F, 360, i);
      this.mVarianceFilter.setInFaceRect(1);
      this.mVarianceFilter.setRotation(paramInt3);
      int j = 0;
      if (j < paramList.size())
      {
        Object localObject = AlgoUtils.getFaceRectF((List)paramList.get(j));
        float f1;
        float f2;
        if (localObject != null)
        {
        ...
        while (true)
        {
          ...
          this.mVarianceFilter.renderTexture(paramh1.texture[0], 360, i);
          j++;
          break;
          label345: if (paramInt3 == 90)
          {
            f1 = ((RectF)localObject).width();
            f2 = ((RectF)localObject).height();
          ...
          else
          {
            ...
            ((RectF)localObject).left -= 0.2F * f2;
            ((RectF)localObject).top -= 0.1F * f1;
            ((RectF)localObject).right = (f2 * 0.6F + ((RectF)localObject).right);
