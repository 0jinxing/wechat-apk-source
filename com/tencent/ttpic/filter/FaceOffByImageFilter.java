...
public class FaceOffByImageFilter extends VideoFilterBase
{
  ...
  public void initAttribParams()
  {
    ...
    List localList1 = FaceOffUtil.genPoints(this.item.facePoints);
    List localList2 = FaceOffUtil.getGrayCoords(this.item.featureType);
    localList1 = FaceOffUtil.getFullCoords(localList1, 2.0F);
    localList2 = FaceOffUtil.getFullCoords(localList2, 2.0F);
    setTexCords(FaceOffUtil.initMaterialFaceTexCoords(localList1, this.faceImageWidth, this.faceImageHeight, this.texVertices));
    setGrayCords(FaceOffUtil.initMaterialFaceTexCoords(localList2, this.grayImageWidth, this.grayImageHeight, this.grayVertices));
