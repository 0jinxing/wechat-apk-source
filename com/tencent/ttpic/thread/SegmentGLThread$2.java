  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    if (this.val$horizon)
    {
      ...
      label55: if (!this.val$horizon)
        break label288;
    }
    label288: for (int j = SegmentGLThread.access$1600(); ; j = SegmentGLThread.access$1500())
    {
    ...
    label295: SegmentGLThread.access$200(this.this$0).RenderProcess(SegmentGLThread.access$1000(this.this$0).texture[0], i * 16, j * 16, -1, 0.0D, SegmentGLThread.access$900(this.this$0));
    ...
    if (this.val$horizon)
    {
      ...
      label494: if (!this.val$horizon)
        break label663;
    }
    label663: for (Bitmap localBitmap2 = SegmentGLThread.access$2100(this.this$0); ; localBitmap2 = SegmentGLThread.access$2000(this.this$0))
    {
