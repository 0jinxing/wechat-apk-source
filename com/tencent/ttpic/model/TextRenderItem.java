...
public class TextRenderItem
{
  ...
  {
    if ((this.positionX + this.itemWidth / 2 < 0) || (this.positionX - this.itemWidth / 2 > this.canvasWidth) || (this.positionY + this.itemHeight / 2 < 0) || (this.positionY - this.itemHeight / 2 > this.canvasHeight));
  ...
  public void updatePosition(float paramFloat1, float paramFloat2)
  {
    ...
    float f1 = this.positionX - this.itemWidth / 2;
    paramFloat1 = this.positionY - this.itemHeight / 2;
    paramFloat2 = this.itemWidth;
    float f2 = this.itemHeight;
    this.renderParam.position = AlgoUtils.calPositionsTriangles(f1, f2 + paramFloat1, f1 + paramFloat2, paramFloat1, this.canvasWidth, this.canvasHeight);
