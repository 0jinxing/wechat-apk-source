...
public class WMGroup
{
  ...
  public boolean updateTexture(long paramLong, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    for (paramBoolean1 = false; ; paramBoolean1 = true)
    {
      ...
      {
        label282: WMElement localWMElement;
        float f1;
        float f2;
        float f3;
        float f4;
              ...
              if ((localObject1 != null) && (!((Bitmap)localObject1).isRecycled()))
              {
                ...
                if (!TextUtils.isEmpty(localWMElement.relativeID))
                {
                  ...
                  if (localObject3 != null)
                  {
                    ...
                    {
                      f4 = ((WMElement)localObject3).finalContentRect.width();
                      f3 = ((WMElement)localObject3).finalContentRect.height();
                ...
                f2 = ((PointF)localObject1).x;
                f4 = f4 * localWMElement.relativeAnchor.x + f2 + ((PointF)localObject3).x - localWMElement.width * localWMElement.anchor.x;
                f2 = ((PointF)localObject1).y;
                f1 = f3 * localWMElement.relativeAnchor.y + f2 + ((PointF)localObject3).y - localWMElement.height * localWMElement.anchor.y;
                f2 = f4 + localWMElement.width;
                f3 = localWMElement.height + f1;
                if ((localWMElement instanceof ImageWMElement))
                {
                  localWMElement.finalContentRect.left = f4;
                  localWMElement.finalContentRect.top = f1;
                  localWMElement.finalContentRect.right = f2;
                  localWMElement.finalContentRect.bottom = f3;
                  label667: localObject1 = this.mCopyFilter;
                  if ((TextUtils.isEmpty(localWMElement.animateType)) || (!this.mAnimationFilerMap.containsKey(localWMElement.animateType)))
                    break label978;
        ...
        while (true)
        {
          ...
          ((BaseFilter)localObject1).setPositions(AlgoUtils.calPositions(f4, f3, f2, f1, this.width, this.height));
          ...
          localWMElement.finalContentRect.left = (((TextWMElement)localObject1).getTextRect().left + f4);
          localWMElement.finalContentRect.top = (((TextWMElement)localObject1).getTextRect().top + f1);
          localWMElement.finalContentRect.right = (((TextWMElement)localObject1).getTextRect().right + f4);
