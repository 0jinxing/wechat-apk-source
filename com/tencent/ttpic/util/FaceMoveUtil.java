...
public class FaceMoveUtil
{
  ...
  public static void adjustCoords(PointF[] paramArrayOfPointF1, PointF[] paramArrayOfPointF2, List<FaceMoveItem> paramList)
  {
    ...
    while (true)
    {
      ...
      for (int i = 0; i < paramList.size(); i++)
      {
        ...
        PointF localPointF3 = paramArrayOfPointF1[((FaceMoveItem)paramList.get(i)).pos1];
        PointF localPointF4 = paramArrayOfPointF1[((FaceMoveItem)paramList.get(i)).pos2];
        PointF localPointF5 = paramArrayOfPointF1[((FaceMoveItem)paramList.get(i)).position];
        localPointF4 = new PointF(localPointF3.x * localFaceMoveItem.ratio1 + localPointF4.x * (1.0F - localFaceMoveItem.ratio1), localPointF3.y * localFaceMoveItem.ratio1 + localPointF4.y * (1.0F - localFaceMoveItem.ratio1));
        f1 = localPointF4.x;
        f3 = localFaceMoveItem.ratio2;
        float f4 = localPointF5.x;
        f2 = localFaceMoveItem.ratio2;
        float f5 = localPointF4.y;
        float f6 = localFaceMoveItem.ratio2;
        localPointF5 = new PointF(f1 * f3 + f4 * (1.0F - f2), localPointF5.y * (1.0F - localFaceMoveItem.ratio2) + f5 * f6);
        int j = localFaceMoveItem.position;
        float f7 = localPointF5.x;
        f5 = localPointF1.x;
        f6 = localFaceMoveItem.dx;
        f2 = localPointF2.x;
        f3 = localFaceMoveItem.dy;
        float f8 = localPointF5.y;
        float f9 = localPointF1.y;
        f1 = localFaceMoveItem.dx;
        f4 = localPointF2.y;
        paramArrayOfPointF2[j] = new PointF(f7 + f5 * f6 + f2 * f3, localFaceMoveItem.dy * f4 + (f8 + f9 * f1));
      }
      AppMethodBeat.o(83882);
    }
  }
  ...
  public static void genFullCoords(List<PointF> paramList)
  {
    ...
    while (true)
    {
      ...
      float f2 = ((PointF)paramList.get(9)).x;
      f1 = ((PointF)paramList.get(84)).x;
      float f3 = -((PointF)paramList.get(9)).y;
      f1 = (float)Math.atan((f2 - f1) / (((PointF)paramList.get(84)).y + f3));
      ...
      f3 = (((PointF)paramList.get(51)).x + f2) / 2.0F;
      f2 = ((PointF)paramList.get(41)).y;
      localPointF1 = new PointF(f3, (((PointF)paramList.get(51)).y + f2) / 2.0F);
      f3 = AlgoUtils.getDistance((PointF)paramList.get(59), localPointF1);
      PointF localPointF2 = (PointF)paramList.get(91);
      PointF localPointF3 = (PointF)paramList.get(90);
      f2 = (float)(((PointF)paramList.get(59)).x + 2.0F * f3 * Math.sin(f1));
      double d1 = ((PointF)paramList.get(59)).y;
      double d2 = 2.0F * f3;
      localPointF1 = new PointF(f2, (float)(d1 - Math.cos(f1) * d2));
      for (int i = 2; i > 0; i--)
      {
        f1 = 0.5233334F * i;
        ((PointF)paramList.get(94 - i)).x = ((float)(localPointF1.x - (localPointF1.x - localPointF2.x) * Math.cos(f1)));
        ((PointF)paramList.get(94 - i)).y = ((float)(localPointF2.y - (localPointF2.y - localPointF1.y) * Math.sin(f1)));
      }
      for (i = 3; i > 0; i--)
      {
        f1 = 0.5233334F * i;
        ((PointF)paramList.get(97 - i)).x = ((float)(localPointF1.x - (localPointF1.x - localPointF3.x) * Math.cos(f1)));
        ((PointF)paramList.get(97 - i)).y = ((float)(localPointF3.y - (localPointF3.y - localPointF1.y) * Math.sin(f1)));
      }
      localPointF1 = (PointF)paramList.get(64);
      localPointF3 = new PointF(((PointF)paramList.get(54)).x - ((PointF)paramList.get(44)).x, ((PointF)paramList.get(54)).y - ((PointF)paramList.get(44)).y);
      f1 = localPointF3.x;
      f2 = localPointF3.x;
      f3 = localPointF3.y;
      localPointF2 = new PointF(f1 + f2, localPointF3.y + f3);
  ...
  public static void genFullCoords(PointF[] paramArrayOfPointF)
  {
    ...
    while (true)
    {
      ...
      PointF localPointF2 = paramArrayOfPointF[91];
      localPointF1 = paramArrayOfPointF[90];
      ...
      {
        f1 = i * 0.5233334F;
        paramArrayOfPointF[(94 - i)].x = ((float)(localPointF3.x - (localPointF3.x - localPointF2.x) * Math.cos(f1)));
        paramArrayOfPointF[(94 - i)].y = ((float)(localPointF2.y - (localPointF2.y - localPointF3.y) * Math.sin(f1)));
      }
      for (i = 3; i > 0; i--)
      {
        f1 = i * 0.5233334F;
        paramArrayOfPointF[(97 - i)].x = ((float)(localPointF3.x - (localPointF3.x - localPointF1.x) * Math.cos(f1)));
        paramArrayOfPointF[(97 - i)].y = ((float)(localPointF1.y - (localPointF1.y - localPointF3.y) * Math.sin(f1)));
      }
      ...
      f1 = localPointF2.x;
      f2 = localPointF2.y;
      localPointF2 = new PointF(f3 + f1, localPointF2.y + f2);
      PointF localPointF4 = new PointF(-localPointF2.y, localPointF2.x);
      paramArrayOfPointF[99].x = (localPointF1.x - localPointF2.x - localPointF4.x);
      paramArrayOfPointF[99].y = (localPointF1.y - localPointF2.y - localPointF4.y);
      paramArrayOfPointF[100].x = (localPointF1.x - localPointF2.x);
      paramArrayOfPointF[100].y = (localPointF1.y - localPointF2.y);
      paramArrayOfPointF[101].x = (localPointF1.x - localPointF2.x + localPointF4.x);
      paramArrayOfPointF[101].y = (localPointF1.y - localPointF2.y + localPointF4.y);
      paramArrayOfPointF[102].x = (localPointF1.x + localPointF4.x);
      paramArrayOfPointF[102].y = (localPointF1.y + localPointF4.y);
      paramArrayOfPointF[103].x = (localPointF1.x + localPointF2.x + localPointF4.x);
      paramArrayOfPointF[103].y = (localPointF1.y + localPointF2.y + localPointF4.y);
      paramArrayOfPointF[104].x = (localPointF1.x + localPointF2.x);
      paramArrayOfPointF[104].y = (localPointF1.y + localPointF2.y);
      paramArrayOfPointF[105].x = (localPointF1.x + localPointF2.x - localPointF4.x);
      localPointF3 = paramArrayOfPointF[105];
      f1 = localPointF1.y;
      localPointF3.y = (localPointF2.y + f1 - localPointF4.y);
      paramArrayOfPointF[106].x = (localPointF1.x - localPointF4.x);
      paramArrayOfPointF[106].y = (localPointF1.y - localPointF4.y);
      AppMethodBeat.o(83880);
    }
  }
