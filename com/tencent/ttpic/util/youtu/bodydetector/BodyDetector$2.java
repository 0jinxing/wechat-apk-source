  ...
  public void run()
  {
    ...
    for (long l1 = System.currentTimeMillis(); ; l1 = 0L)
    {
      ...
      if (!BodyDetector.access$700(this.this$0))
      {
        ...
        {
          float f6 = f5;
          if (f5 < BodyDetector.access$1200(this.this$0)[i])
          {
            ...
            f4 = BodyDetector.access$1100(this.this$0)[i];
          }
          i++;
          f5 = f6;
        }
        if ((localObject[0] > 0) && (f5 > 0.7D))
        {
          BodyDetector.access$1302(this.this$0, f1);
          BodyDetector.access$1402(this.this$0, f2);
          BodyDetector.access$1502(this.this$0, f3);
          BodyDetector.access$1602(this.this$0, f4);
          BodyDetector.access$1702(this.this$0, f5);
      ...
      label642: label654: for (boolean bool = true; ; bool = false)
      {
      ...
      while (true)
      {
        label669: this.val$listener.onBodyDataReady(localArrayList);
        if (BenchUtil.ENABLE_PERFORMANCE_RECORD)
        {
        ...
        return;
        label718: BodyDetector.access$702(this.this$0, false);
      }
    }
  }
}
