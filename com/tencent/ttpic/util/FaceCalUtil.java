...
public class FaceCalUtil
{
  ...
  public static float getDiffBrowX(List<PointF> paramList1, List<PointF> paramList2)
  {
    ...
    f2 = FaceItemCal.BROW_DIST_X.getAdjustValue(f1);
    f1 = FaceCalUtil.CAL_PARAM.BROW_DIST_X_SCALE_FACTOR.value;
  ...
  public static float getDiffBrowY(List<PointF> paramList1, List<PointF> paramList2)
  {
    ...
    f12 = (((PointF)paramList2.get(34)).y + (f3 + f4 + f5 + f6 + f7 + f8 + f9 + f10 + f11 + f12 + f13)) / 12.0F;
    f4 = ((PointF)paramList1.get(20)).y;
    f7 = ((PointF)paramList1.get(26)).y;
    f5 = ((PointF)paramList1.get(21)).y;
    f3 = ((PointF)paramList1.get(25)).y;
    float f14 = ((PointF)paramList1.get(22)).y;
    f10 = ((PointF)paramList1.get(24)).y;
    f11 = ((PointF)paramList1.get(30)).y;
    f9 = ((PointF)paramList1.get(32)).y;
    f6 = ((PointF)paramList1.get(29)).y;
    f8 = ((PointF)paramList1.get(33)).y;
    f13 = ((PointF)paramList1.get(28)).y;
    f4 = (((PointF)paramList1.get(34)).y + (f4 + f7 + f5 + f3 + f14 + f10 + f11 + f9 + f6 + f8 + f13)) / 12.0F;
    f1 = (((PointF)paramList2.get(83)).y - f12) / f1;
    f2 = (((PointF)paramList1.get(83)).y - f4) / f2 / f1;
    f2 = FaceItemCal.BROW_DIST_Y.getAdjustValue(f2);
    f1 = FaceCalUtil.CAL_PARAM.BROW_DIST_Y_SCALE_FACTOR.value;
  ...
  public static float getDiffBrowY2(List<PointF> paramList1, List<PointF> paramList2)
  {
    ...
    f2 = (f1 + f2 - (((PointF)paramList2.get(25)).y + f3)) / 2.0F;
    f2 = FaceItemCal.BROW_DIST_Y2.getAdjustValue(f2);
    f1 = FaceCalUtil.CAL_PARAM.BROW_DIST_Y_SCALE_FACTOR.value;
  ...
  public static float getDiffEyeX(List<PointF> paramList1, List<PointF> paramList2)
  {
    ...
    float f2 = AlgoUtils.getDistance((PointF)paramList2.get(43), (PointF)paramList2.get(53)) / f1;
    f1 = getFaceWidth(paramList1);
    f1 = AlgoUtils.getDistance((PointF)paramList1.get(43), (PointF)paramList1.get(53)) / f1 / f2;
    f2 = FaceItemCal.EYE_DIST_X.getAdjustValue(f1);
    f1 = FaceCalUtil.CAL_PARAM.EYE_DIST_SCALE_FACTOR.value;
  ...
  public static float getDiffMouthY(List<PointF> paramList1, List<PointF> paramList2)
  {
    ...
    PointF localPointF1 = AlgoUtils.middlePoint(AlgoUtils.middlePoint((PointF)paramList2.get(8), (PointF)paramList2.get(10)), (PointF)paramList2.get(9));
    PointF localPointF2 = AlgoUtils.middlePoint(AlgoUtils.middlePoint((PointF)paramList1.get(8), (PointF)paramList1.get(10)), (PointF)paramList1.get(9));
    float f1 = AlgoUtils.getDistance((PointF)paramList2.get(59), localPointF1);
    float f2 = AlgoUtils.getDistance((PointF)paramList1.get(59), localPointF2);
    f1 = (((PointF)paramList2.get(73)).y + ((PointF)paramList2.get(81)).y - ((PointF)paramList2.get(59)).y * 2.0F) / 2.0F / f1;
    f2 = (((PointF)paramList1.get(73)).y + ((PointF)paramList1.get(81)).y - ((PointF)paramList1.get(59)).y * 2.0F) / 2.0F / f2 / f1;
    f2 = FaceItemCal.MOUTH_DIST_Y.getAdjustValue(f2);
    f1 = FaceCalUtil.CAL_PARAM.MOUTH_DIST_Y_SCALE_FACTOR.value;
  ...
  public static float getDiffMouthY2(List<PointF> paramList1, List<PointF> paramList2)
  {
    ...
    f3 = FaceCalUtil.CAL_PARAM.MOUTH_DIST_Y_SCALE_FACTOR.value;
  ...
  public static float getDiffNoseY(List<PointF> paramList1, List<PointF> paramList2)
  {
    ...
    float f1 = AlgoUtils.getDistance((PointF)paramList2.get(83), localPointF1);
    float f2 = AlgoUtils.getDistance((PointF)paramList1.get(83), localPointF2);
    f1 = AlgoUtils.getDistance((PointF)paramList2.get(83), (PointF)paramList2.get(59)) / f1;
    f2 = AlgoUtils.getDistance((PointF)paramList1.get(83), (PointF)paramList1.get(59)) / f2 / f1;
    f1 = FaceItemCal.NOSE_DIST_Y.getAdjustValue(f2);
  ...
  public static float getDiffNoseY2(List<PointF> paramList1, List<PointF> paramList2)
  {
    ...
    f2 = FaceItemCal.NOSE_DIST_Y2.getAdjustValue(f1 - f2);
    f1 = FaceCalUtil.CAL_PARAM.NOSE_DIST_Y_SCALE_FACTOR.value;
  ...
  public static float getEyeScaleX(List<PointF> paramList1, List<PointF> paramList2)
  {
    ...
    f3 = (AlgoUtils.getDistance((PointF)paramList2.get(45), (PointF)paramList2.get(49)) + f3) / 2.0F / f1;
    f1 = AlgoUtils.getDistance((PointF)paramList1.get(35), (PointF)paramList1.get(39));
    f2 = (AlgoUtils.getDistance((PointF)paramList1.get(45), (PointF)paramList1.get(49)) + f1) / 2.0F / f2 / f3;
    f2 = FaceItemCal.EYE_WIDTH.getAdjustValue(f2);
    f1 = FaceCalUtil.CAL_PARAM.EYE_WIDTH_SCALE_FACTOR.value;
  ...
  public static float getEyeScaleY(List<PointF> paramList1, List<PointF> paramList2)
  {
    ...
    f1 = (AlgoUtils.getDistance((PointF)paramList2.get(47), (PointF)paramList2.get(51)) + f3) / 2.0F / f1;
    f3 = AlgoUtils.getDistance((PointF)paramList1.get(37), (PointF)paramList1.get(41));
    f2 = (AlgoUtils.getDistance((PointF)paramList1.get(47), (PointF)paramList1.get(51)) + f3) / 2.0F / f2 / f1;
    f2 = FaceItemCal.EYE_HEIGHT.getAdjustValue(f2);
    f3 = FaceCalUtil.CAL_PARAM.EYE_HEIGHT_SCALE_FACTOR.value;
  ...
  public static double getFaceAngle(List<PointF> paramList)
  {
    ...
    List localList = getFaceOutlinePoints(paramList, false);
    paramList = AlgoUtils.linearRegression((List)localObject);
    localObject = AlgoUtils.linearRegression(localList);
    double d = Math.atan2(paramList[0] - localObject[0], paramList[0] * localObject[0] + 1.0F);
  ...
  public static float getFaceScaleX(List<PointF> paramList1, List<PointF> paramList2)
  {
    ...
    f3 = f2 / getFaceWidth(paramList1) / (f1 / f3);
    f1 = FaceItemCal.FACE_WIDTH.getAdjustValue(f3);
    f3 = FaceCalUtil.CAL_PARAM.FACE_WIDTH_SCALE_FACTOR.value;
  ...
  public static float getFaceVLevel(List<PointF> paramList1, List<PointF> paramList2)
  {
    ...
    f3 = FaceCalUtil.CAL_PARAM.FACE_V_SCALE_FACTOR.value;
  ...
  public static float getMouthScaleX(List<PointF> paramList1, List<PointF> paramList2)
  {
    ...
    float f1 = getFaceWidth(paramList2);
    float f2 = getFaceWidth(paramList1);
    f1 = AlgoUtils.getDistance((PointF)paramList2.get(65), (PointF)paramList2.get(66)) / f1;
    f2 = AlgoUtils.getDistance((PointF)paramList1.get(65), (PointF)paramList1.get(66)) / f2 / f1;
    f2 = FaceItemCal.MOUTH_WIDTH.getAdjustValue(f2);
    f1 = FaceCalUtil.CAL_PARAM.MOUTH_WIDTH_SCALE_FACTOR.value;
  ...
  public static float getMouthScaleY(List<PointF> paramList1, List<PointF> paramList2)
  {
    ...
    float f1 = AlgoUtils.getDistance((PointF)paramList2.get(83), localPointF1);
    float f2 = AlgoUtils.getDistance((PointF)paramList1.get(83), localPointF2);
    f1 = (((PointF)paramList2.get(69)).y * 2.0F - ((PointF)paramList2.get(76)).y - ((PointF)paramList2.get(78)).y) / 2.0F / f1;
    f2 = (((PointF)paramList1.get(69)).y * 2.0F - ((PointF)paramList1.get(76)).y - ((PointF)paramList1.get(78)).y) / 2.0F / f2 / f1;
    f2 = FaceItemCal.MOUTH_HEIGHT.getAdjustValue(f2);
    f1 = FaceCalUtil.CAL_PARAM.MOUTH_HEIGHT_SCALE_FACTOR.value;
  ...
  public static float getNoseScaleX(List<PointF> paramList1, List<PointF> paramList2)
  {
    ...
    float f1 = getFaceWidth(paramList2);
    float f2 = getFaceWidth(paramList1);
    f1 = AlgoUtils.getDistance((PointF)paramList2.get(57), (PointF)paramList2.get(61)) / f1;
    f2 = AlgoUtils.getDistance((PointF)paramList1.get(57), (PointF)paramList1.get(61)) / f2 / f1;
    f1 = FaceItemCal.NOSE_WIDTH.getAdjustValue(f2);
  ...
  public static PointF[] getRangePoints(List<PointF> paramList)
  {
    ...
    if (Float.compare(f1, f2) == 0)
    {
      ...
      paramList = new PointF[] { localPointF, paramList };
    }
    while (true)
    {
      return paramList;
      ...
      {
        localPointF = (PointF)paramList.get(2);
  ...
  public static PointsWithTexcoords transToStSpace(List<PointF> paramList, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    PointF localPointF1 = new PointF(((PointF)localObject).x * 1.5F, ((PointF)localObject).y * 1.5F);
    PointF localPointF2 = new PointF(-localPointF1.y, localPointF1.x);
    PointF localPointF3 = new PointF(((PointF)paramList.get(83)).x - localPointF2.x * 0.1F, ((PointF)paramList.get(83)).y - localPointF2.y * 0.1F);
    localObject = new PointF(localPointF3.x - localPointF1.x - localPointF2.x, localPointF3.y - localPointF1.y - localPointF2.y);
    PointF localPointF4 = new PointF(localPointF3.x - localPointF1.x + localPointF2.x, localPointF3.y - localPointF1.y + localPointF2.y);
    PointF localPointF5 = new PointF(localPointF3.x + localPointF1.x + localPointF2.x, localPointF3.y + localPointF1.y + localPointF2.y);
    float f1 = localPointF3.x;
    float f2 = localPointF1.x;
    float f3 = localPointF2.x;
    float f4 = localPointF3.y;
    localPointF3 = new PointF(f1 + f2 - f3, localPointF1.y + f4 - localPointF2.y);
    updateFacePoints(paramList, (PointF)localObject, localPointF3, localPointF4, paramInt3, paramInt4);
    ((PointF)localObject).x /= paramInt1;
    localPointF4.x /= paramInt1;
    localPointF5.x /= paramInt1;
    localPointF3.x /= paramInt1;
    ((PointF)localObject).y /= paramInt2;
    localPointF4.y /= paramInt2;
    localPointF5.y /= paramInt2;
    localPointF3.y /= paramInt2;
    paramList = new PointsWithTexcoords(paramList, new float[] { ((PointF)localObject).x, ((PointF)localObject).y, localPointF4.x, localPointF4.y, localPointF5.x, localPointF5.y, localPointF3.x, localPointF3.y });
  ...
  public static void updateFacePoints(List<PointF> paramList, PointF paramPointF1, PointF paramPointF2, PointF paramPointF3, int paramInt1, int paramInt2)
  {
    ...
    for (paramInt1 = 0; paramInt1 < 83; paramInt1++)
    {
