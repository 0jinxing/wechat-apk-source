...
public class FaceOffUtil
{
  ...
  public static Bitmap getFaceBitmap(String paramString, int paramInt1, int paramInt2)
  {
    ...
    while (true)
    {
      ...
      for (paramString = BitmapUtils.decodeSampledBitmapFromFile(paramString, paramInt1, paramInt2); ; paramString = BitmapUtils.decodeSampledBitmapFromAssets(VideoGlobalContext.getContext(), FileUtils.getRealPath(paramString), paramInt1, paramInt2))
      {
  ...
  public static Bitmap getFaceBitmap(String paramString, FaceItem paramFaceItem)
  {
    ...
    {
      paramString = BitmapUtils.decodeSampledBitmapFromAssets(VideoGlobalContext.getContext(), FileUtils.getRealPath(paramString) + File.separator + paramFaceItem.faceExchangeImage, 2147483647, 2147483647);
      if (BitmapUtils.isLegal(paramString))
        break label116;
      paramString = null;
    ...
    {
      return paramString;
      paramString = BitmapUtils.decodeSampledBitmapFromFile(paramString + File.separator + paramFaceItem.faceExchangeImage, 2147483647, 2147483647);
      break;
      label116: AppMethodBeat.o(83902);
    }
  }
  ...
  public static FaceOffUtil.FEATURE_TYPE getFeatureType(int paramInt)
  {
    ...
    int i = arrayOfFEATURE_TYPE.length;
    int j = 0;
    FaceOffUtil.FEATURE_TYPE localFEATURE_TYPE;
    if (j < i)
    {
      localFEATURE_TYPE = arrayOfFEATURE_TYPE[j];
    ...
    while (true)
    {
      ...
      j++;
      break;
      localFEATURE_TYPE = FaceOffUtil.FEATURE_TYPE.NO_EYE;
      AppMethodBeat.o(83899);
    }
  }
  ...
  public static List<PointF> getFullCoords(List<PointF> paramList)
  {
    ...
    PointF localPointF2 = new PointF((float)(((PointF)paramList.get(1)).x + 2.0F * f1 * Math.sin(d1)), (float)(((PointF)paramList.get(1)).y - 2.0F * f1 * Math.cos(d1)));
    paramList.add(localPointF2);
    f1 = AlgoUtils.getDistance((PointF)paramList.get(17), (PointF)paramList.get(18));
    PointF localPointF3 = new PointF((float)(((PointF)paramList.get(17)).x + 2.0F * f1 * Math.sin(d1)), (float)(((PointF)paramList.get(17)).y - 2.0F * f1 * Math.cos(d1)));
    paramList.add(localPointF3);
    f1 = (float)(AlgoUtils.getDistance((PointF)paramList.get(59), localPointF1) * 1.2D);
    localPointF1 = new PointF((float)(((PointF)paramList.get(59)).x + 2.0F * f1 * Math.sin(d1)), (float)(((PointF)paramList.get(59)).y - 2.0F * f1 * Math.cos(d1)));
    double d2;
    double d3;
    for (int i = 2; i > 0; i--)
    {
      ...
      localPointF4.x = ((float)(localPointF1.x - (localPointF1.x - localPointF3.x) * Math.cos(d2)));
      d1 = localPointF3.y;
      d3 = localPointF3.y - localPointF1.y;
      localPointF4.y = ((float)(d1 - Math.sin(d2) * d3));
    ...
    for (i = 3; i > 0; i--)
    {
      ...
      localPointF3.x = ((float)(localPointF1.x - (localPointF1.x - localPointF2.x) * Math.cos(d1)));
      d2 = localPointF2.y;
      d3 = localPointF2.y - localPointF1.y;
      localPointF3.y = ((float)(d2 - Math.sin(d1) * d3));
      paramList.add(localPointF3);
    }
    ...
    localPointF1 = new PointF(localPointF3.x - localPointF1.x, localPointF3.y - localPointF1.y);
    f1 = localPointF1.x;
    f3 = localPointF1.x;
    f2 = localPointF1.y;
    localPointF3 = new PointF(f1 + f3, localPointF1.y + f2);
    localPointF1 = new PointF(-localPointF3.y, localPointF3.x);
    paramList.add(new PointF(localPointF2.x - localPointF3.x - localPointF1.x, localPointF2.y - localPointF3.y - localPointF1.y));
    paramList.add(new PointF(localPointF2.x - localPointF3.x, localPointF2.y - localPointF3.y));
    paramList.add(new PointF(localPointF2.x - localPointF3.x + localPointF1.x, localPointF2.y - localPointF3.y + localPointF1.y));
    paramList.add(new PointF(localPointF2.x + localPointF1.x, localPointF2.y + localPointF1.y));
    paramList.add(new PointF(localPointF2.x + localPointF3.x + localPointF1.x, localPointF2.y + localPointF3.y + localPointF1.y));
    paramList.add(new PointF(localPointF2.x + localPointF3.x, localPointF2.y + localPointF3.y));
    f1 = localPointF2.x;
    float f4 = localPointF3.x;
    f3 = localPointF1.x;
    f2 = localPointF2.y;
    paramList.add(new PointF(f1 + f4 - f3, localPointF3.y + f2 - localPointF1.y));
    paramList.add(new PointF(localPointF2.x - localPointF1.x, localPointF2.y - localPointF1.y));
    paramList.get(3);
    paramList.get(15);
    paramList.get(65);
    ...
    while (i < 39)
    {
      ...
      if (Math.abs(localPointF1.x - localPointF2.x) < 1.0D)
      {
        paramList.add(new PointF(localPointF1.x, (float)(localPointF1.y + (localPointF1.y - localPointF2.y) * 0.7D)));
        i++;
      }
      else
      {
        f2 = (localPointF1.y - localPointF2.y) / (localPointF1.x - localPointF2.x);
        f3 = (float)(localPointF1.x + (localPointF1.x - localPointF2.x) * 0.7D);
        f5 = localPointF2.x;
        f4 = localPointF2.y;
        if ((i != 35) || (f3 >= ((PointF)paramList.get(0)).x))
          break label2553;
      }
    }
    label2072: label2547: label2553: for (f1 = ((PointF)paramList.get(0)).x; ; f1 = f3)
    {
      paramList.add(new PointF(f1, f4 + (f3 - f5) * f2));
      break label1513;
      ...
      if (i < 43)
      {
        localPointF1 = (PointF)paramList.get(i);
        if (Math.abs(localPointF1.x - localPointF2.x) < 1.0D)
          paramList.add(new PointF(localPointF1.x, (float)(localPointF1.y + (localPointF1.y - localPointF2.y) * 1.2D)));
        while (true)
        {
          i++;
          break;
          f3 = (localPointF1.y - localPointF2.y) / (localPointF1.x - localPointF2.x);
          f1 = (float)(localPointF1.x + (localPointF1.x - localPointF2.x) * 1.2D);
          paramList.add(new PointF(f1, f3 * (f1 - localPointF2.x) + localPointF2.y));
        }
      }
      ...
      localPointF2 = AlgoUtils.middlePoint(localPointF2, localPointF1);
      ...
      while (i < 49)
      {
        ...
        {
          f4 = (localPointF1.y - localPointF2.y) / (localPointF1.x - localPointF2.x);
          f3 = (float)(localPointF1.x + (localPointF1.x - localPointF2.x) * 0.7D);
          f5 = localPointF2.x;
          f2 = localPointF2.y;
          if ((i != 45) || (f3 <= ((PointF)paramList.get(18)).x))
            break label2547;
        }
      }
      for (f1 = ((PointF)paramList.get(18)).x; ; f1 = f3)
      {
        paramList.add(new PointF(f1, f2 + (f3 - f5) * f4));
        break label2072;
        ...
        localPointF1 = (PointF)paramList.get(j + 2);
        localPointF3 = AlgoUtils.middlePoint(localPointF3, localPointF2);
        localPointF2 = AlgoUtils.middlePoint(localPointF1, localPointF2);
        paramList.add(new PointF(localPointF3.x, localPointF3.y));
        paramList.add(new PointF(localPointF2.x, localPointF2.y));
        AppMethodBeat.o(83896);
        break;
  ...
  public static List<PointF> getFullCoords(List<PointF> paramList, float paramFloat)
  {
    ...
    f2 = -((PointF)paramList.get(9)).y;
    f1 = ((PointF)paramList.get(84)).y;
    double d1 = Math.atan2(f3 - f4, f1 + f2) + 3.141592653589793D;
    ...
    if (paramList.size() == 90)
    {
      ...
      paramList.add(localPointF2);
      f1 = AlgoUtils.getDistance((PointF)paramList.get(17), (PointF)paramList.get(18));
      PointF localPointF3 = new PointF((float)(((PointF)paramList.get(17)).x + 2.0F * f1 * Math.sin(0.0D)), (float)(((PointF)paramList.get(17)).y - 2.0F * f1 * Math.cos(0.0D)));
      paramList.add(localPointF3);
      f1 = AlgoUtils.getDistance((PointF)paramList.get(59), localPointF1);
      localPointF4 = new PointF((float)(((PointF)paramList.get(59)).x + 2.0F * f1 * Math.sin(0.0D)), (float)(((PointF)paramList.get(59)).y - 2.0F * f1 * Math.cos(0.0D)));
      double d2;
      double d3;
      double d4;
      for (i = 2; i > 0; i--)
      {
        ...
        localPointF5.x = ((float)(localPointF4.x - (localPointF4.x - localPointF3.x) * Math.cos(d2)));
        d3 = localPointF3.y;
        d4 = localPointF3.y - localPointF4.y;
        localPointF5.y = ((float)(d3 - Math.sin(d2) * d4));
        paramList.add(localPointF5);
      }
      for (i = 3; i > 0; i--)
      {
        d4 = Math.toRadians(i * 30.0F);
        localPointF5 = new PointF();
        localPointF5.x = ((float)(localPointF4.x - (localPointF4.x - localPointF2.x) * Math.cos(d4)));
        d3 = localPointF2.y;
        d2 = localPointF2.y - localPointF4.y;
        localPointF5.y = ((float)(d3 - Math.sin(d4) * d2));
        paramList.add(localPointF5);
      }
    }
    paramList.add(EMPTY_POINT);
    ...
    PointF localPointF5 = (PointF)paramList.get(44);
    localPointF2 = new PointF(localPointF2.x - localPointF5.x, localPointF2.y - localPointF5.y);
    localPointF5 = new PointF(localPointF2.x * paramFloat, localPointF2.y * paramFloat);
    localPointF2 = new PointF(-localPointF5.y, localPointF5.x);
    paramList.add(new PointF(localPointF4.x - localPointF5.x - localPointF2.x, localPointF4.y - localPointF5.y - localPointF2.y));
    paramList.add(new PointF(localPointF4.x - localPointF5.x, localPointF4.y - localPointF5.y));
    paramList.add(new PointF(localPointF4.x - localPointF5.x + localPointF2.x, localPointF4.y - localPointF5.y + localPointF2.y));
    paramList.add(new PointF(localPointF4.x + localPointF2.x, localPointF4.y + localPointF2.y));
    paramList.add(new PointF(localPointF4.x + localPointF5.x + localPointF2.x, localPointF4.y + localPointF5.y + localPointF2.y));
    paramList.add(new PointF(localPointF4.x + localPointF5.x, localPointF4.y + localPointF5.y));
    ...
    f1 = localPointF2.x;
    f4 = localPointF4.y;
    paramList.add(new PointF(paramFloat + f2 - f1, localPointF5.y + f4 - localPointF2.y));
    paramList.add(new PointF(localPointF4.x - localPointF2.x, localPointF4.y - localPointF2.y));
    paramList.get(3);
    paramList.get(15);
    paramList.get(65);
    paramList.get(66);
    localPointF4 = AlgoUtils.middlePoint((PointF)paramList.get(3), (PointF)paramList.get(65));
    paramList.add(new PointF(localPointF4.x, localPointF4.y));
    localPointF4 = AlgoUtils.middlePoint((PointF)paramList.get(15), (PointF)paramList.get(66));
    paramList.add(new PointF(localPointF4.x, localPointF4.y));
    paramList.get(2);
    paramList.get(16);
    paramList.get(39);
    ...
    while (i < 39)
    {
      ...
      if (Math.abs(localPointF2.x - localPointF4.x) < 1.0D)
      {
        paramList.add(new PointF(localPointF2.x, (float)(localPointF2.y + (localPointF2.y - localPointF4.y) * 0.7D)));
        label1732: i++;
      }
      else
      {
        f3 = (localPointF2.y - localPointF4.y) / (localPointF2.x - localPointF4.x);
        f1 = (float)(localPointF2.x + (localPointF2.x - localPointF4.x) * 0.7D);
        f4 = localPointF4.x;
        f2 = localPointF4.y;
    ...
    label2310: label2857: label2862: for (paramFloat = ((PointF)paramList.get(0)).x; ; paramFloat = f1)
    {
      paramList.add(new PointF(paramFloat, f2 + (f1 - f4) * f3));
      break label1732;
      ...
      if (i < 43)
      {
        localPointF2 = (PointF)paramList.get(i);
        if (Math.abs(localPointF2.x - localPointF4.x) < 1.0D)
          paramList.add(new PointF(localPointF2.x, (float)(localPointF2.y + (localPointF2.y - localPointF4.y) * 1.2D)));
        while (true)
        {
          i++;
          break;
          f1 = (localPointF2.y - localPointF4.y) / (localPointF2.x - localPointF4.x);
          paramFloat = (float)(localPointF2.x + (localPointF2.x - localPointF4.x) * 1.2D);
          paramList.add(new PointF(paramFloat, f1 * (paramFloat - localPointF4.x) + localPointF4.y));
        }
      }
      localPointF2 = (PointF)paramList.get(j);
      localPointF4 = (PointF)paramList.get(j + 1);
      localPointF5 = (PointF)paramList.get(j + 2);
      localPointF2 = AlgoUtils.middlePoint(localPointF2, localPointF4);
      ...
      for (paramFloat = ((PointF)paramList.get(18)).x; ; paramFloat = f1)
      {
        ...
        if (i < 53)
        {
          ...
          while (true)
          {
            i++;
            break;
            paramFloat = (localPointF2.y - localPointF4.y) / (localPointF2.x - localPointF4.x);
            f1 = (float)(localPointF2.x + (localPointF2.x - localPointF4.x) * 1.2D);
            paramList.add(new PointF(f1, paramFloat * (f1 - localPointF4.x) + localPointF4.y));
          }
        }
  ...
  public static List<PointF> getFullCoordsForFaceOffFilter(List<PointF> paramList, float paramFloat)
  {
    ...
    float f1 = ((PointF)paramList.get(41)).x;
    float f2 = (((PointF)paramList.get(51)).x + f1) / 2.0F;
    f1 = ((PointF)paramList.get(41)).y;
    PointF localPointF1 = new PointF(f2, (((PointF)paramList.get(51)).y + f1) / 2.0F);
    ...
    paramList.add(localPointF3);
    f1 = AlgoUtils.getDistance((PointF)paramList.get(59), localPointF1);
    PointF localPointF4 = new PointF((float)(((PointF)paramList.get(59)).x + 2.0F * f1 * Math.sin(0.0D)), (float)(((PointF)paramList.get(59)).y - 2.0F * f1 * Math.cos(0.0D)));
    double d2;
    double d3;
    double d4;
    for (int i = 2; i > 0; i--)
    ...
    for (i = 3; i > 0; i--)
    {
      d2 = Math.toRadians(i * 30.0F);
      localPointF3 = new PointF();
      localPointF3.x = ((float)(localPointF4.x - (localPointF4.x - localPointF2.x) * Math.cos(d2)));
      d4 = localPointF2.y;
      d3 = localPointF2.y - localPointF4.y;
      localPointF3.y = ((float)(d4 - Math.sin(d2) * d3));
      paramList.add(localPointF3);
    }
    paramList.add(EMPTY_POINT);
    paramList.add(EMPTY_POINT);
    localPointF4 = (PointF)paramList.get(64);
    localPointF3 = (PointF)paramList.get(54);
    localPointF2 = (PointF)paramList.get(44);
    localPointF2 = new PointF(localPointF3.x - localPointF2.x, localPointF3.y - localPointF2.y);
    localPointF3 = new PointF(localPointF2.x * paramFloat, localPointF2.y * paramFloat);
    localPointF2 = new PointF(-localPointF3.y, localPointF3.x);
    paramList.add(new PointF(localPointF4.x - localPointF3.x - localPointF2.x, localPointF4.y - localPointF3.y - localPointF2.y));
    paramList.add(new PointF(localPointF4.x - localPointF3.x, localPointF4.y - localPointF3.y));
    paramList.add(new PointF(localPointF4.x - localPointF3.x + localPointF2.x, localPointF4.y - localPointF3.y + localPointF2.y));
    paramList.add(new PointF(localPointF4.x + localPointF2.x, localPointF4.y + localPointF2.y));
    paramList.add(new PointF(localPointF4.x + localPointF3.x + localPointF2.x, localPointF4.y + localPointF3.y + localPointF2.y));
    paramList.add(new PointF(localPointF4.x + localPointF3.x, localPointF4.y + localPointF3.y));
    ...
    f2 = localPointF3.x;
    f1 = localPointF2.x;
    paramFloat = localPointF4.y;
    paramList.add(new PointF(f3 + f2 - f1, localPointF3.y + paramFloat - localPointF2.y));
    paramList.add(new PointF(localPointF4.x - localPointF2.x, localPointF4.y - localPointF2.y));
    paramList.get(3);
    paramList.get(15);
    paramList.get(65);
    ...
    localPointF4 = (PointF)paramList.get(45);
    ...
    paramFloat = AlgoUtils.getDistance(localPointF5, localPointF3);
    ...
    label1641: if (i < 39)
    {
      ...
      if (i == 35)
      {
        ...
        paramFloat = localPointF3.x + (localPointF3.x - localPointF6.x) * 0.9F;
    ...
    label1759: label2399: label2916: label2919: 
    while (true)
    {
      ...
      for (i = 40; i < 43; i++)
      {
        ...
        paramList.add(new PointF((float)(localPointF3.x - 16.0F * f2 * (1.0F + f1) * Math.sin(0.0D + paramFloat)), (float)(localPointF3.y - 16.0F * f2 * (f1 + 1.0F) * Math.cos(0.0D + paramFloat))));
      }
      ...
      paramList.add(new PointF(localPointF6.x, localPointF6.y));
      paramList.add(new PointF(localPointF3.x, localPointF3.y));
      localPointF6 = (PointF)paramList.get(51);
      localPointF5 = (PointF)paramList.get(47);
      localPointF3 = (PointF)paramList.get(54);
      paramList.get(63);
      paramFloat = AlgoUtils.getDistance(localPointF4, localPointF2);
      AlgoUtils.getDistance(localPointF6, localPointF5);
      f2 = paramFloat / 50.0F;
      i = 45;
      label2281: if (i < 49)
      {
        ...
        if (i == 45)
        {
          ...
          paramFloat = localPointF4.x + (localPointF4.x - localPointF3.x) * 0.9F;
          f1 = (paramFloat - localPointF3.x) * f1 + localPointF3.y;
      ...
      while (true)
      {
        ...
        break label2399;
        localPointF4 = AlgoUtils.middlePoint((PointF)paramList.get(49), (PointF)paramList.get(63));
        paramList.add(new PointF(localPointF4.x, localPointF4.y));
        j = paramList.size();
        for (i = 50; i < 53; i++)
        {
        ...
        localPointF3 = (PointF)paramList.get(j + 1);
        localPointF2 = (PointF)paramList.get(j + 2);
        localPointF4 = AlgoUtils.middlePoint(localPointF4, localPointF3);
  ...
  public static float[] initFacePositionsBaseOnFaceRect(List<PointF> paramList, float paramFloat1, float paramFloat2, float[] paramArrayOfFloat)
  {
    ...
    while (true)
    {
      ...
      for (int j = 0; j < i; j++)
      {
        ((PointF)paramList.get(j)).x -= f1;
        ((PointF)paramList.get(j)).y -= f2;
      }
      PointF[] arrayOfPointF = new PointF[3];
      i = 0;
      j = 0;
    ...
    while (true)
    {
      ...
      else
      {
        ...
        try
        {
          ...
          {
            paramString2 = new android/graphics/PointF;
            paramString2.<init>(Float.parseFloat(paramString1[(i * 2)]), Float.parseFloat(paramString1[(i * 2 + 1)]));
