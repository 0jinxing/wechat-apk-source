...
public final class EglCore
{
  ...
  public EglCore(EGLContext paramEGLContext, int paramInt)
  {
    ...
    if ((paramInt & 0x2) != 0)
    {
      EGLConfig localEGLConfig = getConfig(paramInt, 3);
      if (localEGLConfig != null)
      {
        paramEGLContext = EGL14.eglCreateContext(this.mEGLDisplay, localEGLConfig, localEGLContext, new int[] { 12440, 3, 12344 }, 0);
    ...
    if (this.mEGLContext == EGL14.EGL_NO_CONTEXT)
    {
      ...
      localEGLContext = EGL14.eglCreateContext(this.mEGLDisplay, paramEGLContext, localEGLContext, new int[] { 12440, 2, 12344 }, 0);
  ...
  private EGLConfig getConfig(int paramInt1, int paramInt2)
  {
    ...
    if (!EGL14.eglChooseConfig(this.mEGLDisplay, arrayOfInt1, 0, (EGLConfig[])localObject, 0, 1, arrayOfInt2, 0))
    {
