...
public final class bt extends BaseFilter
{
  ...
  public final void ApplyGLSLFilter(boolean paramBoolean, float paramFloat1, float paramFloat2)
  {
    ...
    localBaseFilter2.addParam(new m.o("inputImageTexture2", "sh/shishang2_curve.png", 33986));
    localBaseFilter1.setNextFilter(localBaseFilter2, null);
    localBaseFilter1 = new BaseFilter(GLSLRender.bKG);
    localBaseFilter1.addParam(new m.g("shadowsShift", new float[] { 0.0F, -0.02352941F, 0.05098039F }));
