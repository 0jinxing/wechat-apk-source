...
public final class bj extends BaseFilter
{
  ...
  public final void ApplyGLSLFilter(boolean paramBoolean, float paramFloat1, float paramFloat2)
  {
    ...
    Object localObject = new BaseFilter(GLSLRender.bLE);
    ...
    BaseFilter localBaseFilter = new BaseFilter(GLSLRender.bLE);
    ...
    localObject = new BaseFilter(GLSLRender.bKG);
    ...
    localBaseFilter = new BaseFilter(GLSLRender.bKI);
    ...
    localBaseFilter.setNextFilter((BaseFilter)localObject, null);
    localBaseFilter = new BaseFilter(GLSLRender.bJO);
