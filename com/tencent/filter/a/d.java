...
public final class d extends BaseFilter
{
  ...
  public final void ApplyGLSLFilter(boolean paramBoolean, float paramFloat1, float paramFloat2)
  {
    ...
    while (true)
    {
      ...
      this.bNH = new d.a(true);
      this.bNH.X(this.radius);
      setNextFilter(this.bNH, null);
      this.bNI = new d.a(false);
      this.bNI.X(this.radius);
      this.bNH.setNextFilter(this.bNI, null);
      this.bNG = new BaseFilter(GLSLRender.bLS);
      this.bNG.addParam(new m.m("inputImageTexture2", this.curve_static, 33986));
      this.bNG.addParam(new m.m("inputImageTexture3", this.meitu_whiten, 33987));
      this.bNG.addParam(new m.f("whiten", this.whitenmag));
      this.bNG.addParam(new m.f("opttype", this.opttype));
      this.bNG.addParam(new m.f("skinFilter", this.skinFilter));
      this.bNG.addParam(new m.f("smoothMag", this.bNK));
  ...
  public final void setParameterDic(Map<String, Object> paramMap)
  {
    ...
    {
      this.bNK = ((Float)paramMap.get("smoothMag")).floatValue();
      if (this.bNG != null)
        this.bNG.addParam(new m.f("smoothMag", this.bNK));
    }
