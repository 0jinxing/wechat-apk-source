...
public class ProxyWebViewSuperWrapper extends ProxyWebViewClientExtension
  implements com.tencent.xweb.x5.a.a.a.a.a
{
  ...
  public boolean super_notifyAutoAudioPlay(String paramString, h paramh)
  {
    AppMethodBeat.i(85081);
    boolean bool = super.notifyAutoAudioPlay(paramString, new a.c(paramh));
  ...
  public void super_onResponseReceived(n paramn, o paramo, int paramInt)
  {
    AppMethodBeat.i(85085);
    super.onResponseReceived(a.e.a(paramn), com.tencent.xweb.x5.a.b(paramo), paramInt);
