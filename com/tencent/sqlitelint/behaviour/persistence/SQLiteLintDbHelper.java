  ...
  public final void initialize(Context paramContext)
  {
    ...
    while (true)
    {
      try
      {
        if (this.mHelper == null)
        {
          InternalDbHelper localInternalDbHelper = new com/tencent/sqlitelint/behaviour/persistence/SQLiteLintDbHelper$InternalDbHelper;
          localInternalDbHelper.<init>(paramContext);
          this.mHelper = localInternalDbHelper;
        }
        return;
      }
      finally
