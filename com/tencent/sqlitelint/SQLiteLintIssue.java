  ...
  implements Parcelable
{
  ...
  public static String getLevelText(int paramInt, Context paramContext)
  {
    ...
    {
    default:
      paramContext = paramContext.getString(2131305874);
    case 1:
    case 2:
    case 3:
    case 4:
    ...
    while (true)
    {
      ...
      return paramContext;
      paramContext = paramContext.getString(2131305875);
      continue;
      paramContext = paramContext.getString(2131305874);
      continue;
      paramContext = paramContext.getString(2131305876);
      continue;
      paramContext = paramContext.getString(2131305873);
    }
  }
  ...
  public boolean equals(Object paramObject)
  {
    ...
    {
      return bool;
      bool = ((SQLiteLintIssue)paramObject).id.equals(this.id);
      AppMethodBeat.o(94014);
    }
  }
