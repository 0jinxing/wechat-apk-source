...
public class CdnLogic$C2CDownloadRequest
{
  ...
  public C2CDownloadRequest initialDownloadLength(int paramInt)
  {
    this.initialDownloadLength = paramInt;
    return this;
  }

  public C2CDownloadRequest initialDownloadOffset(int paramInt)
  {
    this.initialDownloadOffset = paramInt;
    return this;
  }
