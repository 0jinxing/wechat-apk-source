...
public class CdnLogic
{
  ...
  public static native int queryDownloadedSize(String paramString, int[] paramArrayOfInt);

  public static native int queryFilesizeLimit(int paramInt1, int paramInt2);
