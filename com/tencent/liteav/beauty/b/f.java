...
public class f extends g
{
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    while (true)
    {
      ...
      while (true)
      {
        ...
        this.B = 4.0F;
        break;
        label410: GLES20.glTexImage2D(3553, 0, 6408, this.r, this.s, 0, 6408, 5121, null);
      }
      label439: AppMethodBeat.o(67040);
    }
  }
  ...
  public int b(int paramInt)
  {
    ...
    for (int i = this.v.b(paramInt); ; i = paramInt)
    {
      ...
      int k = this.w.a(i, j, this.z[0], this.A[0]);
      i = this.x.a(k, j, this.z[1], this.A[1]);
      k = this.u.a(k, this.z[2], this.A[2]);
      int m = this.u.a(i, this.z[3], this.A[3]);
      j = k;
      i = m;
      if (this.B != 1.0F)
      {
