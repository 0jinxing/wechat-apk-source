...
public class DownloadStateChangedReceiver extends BroadcastReceiver
{
  ...
  public static DownloadStateChangedReceiver getInstance()
  {
    try
    {
      ...
      if (mInstance == null)
      {
        localDownloadStateChangedReceiver = new com/tencent/tmassistantsdk/openSDK/DownloadStateChangedReceiver;
        localDownloadStateChangedReceiver.<init>();
        mInstance = localDownloadStateChangedReceiver;
      }
