...
public class NetworkMonitorReceiver extends BroadcastReceiver
{
  ...
  public static NetworkMonitorReceiver getInstance()
  {
    try
    {
      ...
      if (mInstance == null)
      {
        localNetworkMonitorReceiver = new com/tencent/tmassistantsdk/downloadservice/NetworkMonitorReceiver;
        localNetworkMonitorReceiver.<init>();
        mInstance = localNetworkMonitorReceiver;
      }
