  ...
  public int startDownloadIfReady(boolean paramBoolean)
  {
    ...
    if ((!TextUtils.isEmpty(this.mHeaderParamString)) && ((this.mHeaderParams == null) || (this.mHeaderParams.size() <= 0)))
    {
      ...
      try
      {
        ...
        localJSONObject.<init>(this.mHeaderParamString);
    ...
    while (true)
    {
      ...
      if (localHashMap.size() <= 0)
        break;
      this.mHeaderParams = localHashMap;
      break;
      label172: this.mAutoRetry = paramBoolean;
      ...
      if (!TextUtils.isEmpty(this.mFileName))
      {
        ...
        for (this.mReceivedBytes = 0L; ; this.mReceivedBytes = l)
        {
