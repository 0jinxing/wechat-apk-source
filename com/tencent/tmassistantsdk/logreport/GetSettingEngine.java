  ...
  implements IGetSettingHttpListener
{
  ...
  public static GetSettingEngine getInstance()
  {
    try
    {
      ...
      if (mInstance == null)
      {
        localGetSettingEngine = new com/tencent/tmassistantsdk/logreport/GetSettingEngine;
        localGetSettingEngine.<init>();
        mInstance = localGetSettingEngine;
      }
  ...
  public void onSettingHttpRequestFinish(GetSettingsRequest paramGetSettingsRequest, GetSettingsResponse paramGetSettingsResponse, boolean paramBoolean)
  {
    ...
    {
      return;
      label94: TMLog.i("GetSettingEngine", "response  StatCfg is null !");
      break;
