...
public class YTAGReflectLiveCheckJNIInterface
{
  ...
  public static YTAGReflectLiveCheckJNIInterface getInstance()
  {
    try
    {
      ...
      if (instance == null)
      {
        localYTAGReflectLiveCheckJNIInterface = new com/tencent/youtu/ytagreflectlivecheck/jni/YTAGReflectLiveCheckJNIInterface;
        localYTAGReflectLiveCheckJNIInterface.<init>();
        instance = localYTAGReflectLiveCheckJNIInterface;
      }
