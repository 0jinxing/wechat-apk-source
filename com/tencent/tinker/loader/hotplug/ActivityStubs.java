...
{
  static final String ADf = ActivityStubs.class.getPackage().getName();
  static final String ADg = ADf + "." + ActivityStubs.class.getSimpleName() + "$STDStub_%02X";
  static final String ADh = ADf + "." + ActivityStubs.class.getSimpleName() + "$SGTStub_%02X";
  static final String ADi = ADf + "." + ActivityStubs.class.getSimpleName() + "$SGTKStub_%02X";
  static final String ADj = ADf + "." + ActivityStubs.class.getSimpleName() + "$SIStub_%02X";
