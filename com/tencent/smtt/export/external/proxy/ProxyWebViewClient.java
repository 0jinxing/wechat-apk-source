  ...
  implements IX5WebViewClient
{
  ...
  {
    if (this.mWebViewClient != null);
    for (paramIX5WebViewBase = this.mWebViewClient.shouldInterceptRequest(paramIX5WebViewBase, paramWebResourceRequest); ; paramIX5WebViewBase = null)
  ...
  {
    if (this.mWebViewClient != null);
    for (paramIX5WebViewBase = this.mWebViewClient.shouldInterceptRequest(paramIX5WebViewBase, paramWebResourceRequest, paramBundle); ; paramIX5WebViewBase = null)
      return paramIX5WebViewBase;
  }
  ...
  {
    if (this.mWebViewClient != null);
    for (paramIX5WebViewBase = this.mWebViewClient.shouldInterceptRequest(paramIX5WebViewBase, paramString); ; paramIX5WebViewBase = null)
      return paramIX5WebViewBase;
  }

  public boolean shouldOverrideKeyEvent(IX5WebViewBase paramIX5WebViewBase, KeyEvent paramKeyEvent)
  {
    if ((this.mWebViewClient != null) && (this.mWebViewClient.shouldOverrideKeyEvent(paramIX5WebViewBase, paramKeyEvent)));
  ...
  {
    if ((this.mWebViewClient != null) && (this.mWebViewClient.shouldOverrideUrlLoading(paramIX5WebViewBase, paramWebResourceRequest)));
    for (boolean bool = true; ; bool = false)
      return bool;
  }
  ...
  {
    if ((this.mWebViewClient != null) && (this.mWebViewClient.shouldOverrideUrlLoading(paramIX5WebViewBase, paramString)));
    for (boolean bool = true; ; bool = false)
      return bool;
  }
}
