...
class SystemWebChromeClient extends android.webkit.WebChromeClient
{
  ...
  public Bitmap getDefaultVideoPoster()
  {
    ...
    Object localObject = this.b.getDefaultVideoPoster();
    if (localObject == null);
    while (true)
    {
      try
      {
        ...
        {
          Bitmap localBitmap = BitmapFactory.decodeResource(this.a.getResources(), 17301540);
    ...
    implements IX5WebChromeClient.CustomViewCallback
  {
    ...
    b(WebChromeClient.CustomViewCallback arg2)
    {
      Object localObject;
      this.a = localObject;
    }
