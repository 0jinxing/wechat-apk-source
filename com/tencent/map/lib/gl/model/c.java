...
public class c
{
  ...
  private float b()
  {
    ...
    f3 = (float)Math.sqrt((f4 - f3) * ((f4 - f1) * f4 * (f4 - f2)));
  ...
  public boolean a(float[] paramArrayOfFloat)
  {
    ...
    c localc = new c((e)localObject, this.a, this.b);
    paramArrayOfFloat = new c((e)localObject, this.a, this.c);
    localObject = new c((e)localObject, this.b, this.c);
    if (Math.abs(b() - (localc.b() + paramArrayOfFloat.b() + ((c)localObject).b())) < 0.001D)
