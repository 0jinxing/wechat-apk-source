...
public final class ic extends c
{
  ...
  public final int a(int paramInt, Object[] paramArrayOfObject)
  {
    ...
    while (true)
    {
      ...
      ((Path)localObject1).moveTo(0.3709773F, 3.937497F);
      ((Path)localObject1).lineTo(3.945679F, 3.937497F);
      ((Path)localObject1).lineTo(8.5F, 15.0F);
      ((Path)localObject1).lineTo(0.2260281F, 4.231666F);
      ((Path)localObject1).cubicTo(0.1645183F, 4.151613F, 0.1795507F, 4.036853F, 0.2596039F, 3.975344F);
      ((Path)localObject1).cubicTo(0.291545F, 3.950802F, 0.3306969F, 3.937497F, 0.3709773F, 3.937497F);
      ...
      localObject2 = c.a(localPaint2, paramArrayOfObject);
      localObject1 = c.l(paramArrayOfObject);
      ((Path)localObject1).moveTo(16.629023F, 3.937497F);
      ((Path)localObject1).lineTo(13.138271F, 3.937497F);
      ((Path)localObject1).lineTo(8.5F, 15.0F);
      ((Path)localObject1).lineTo(16.773972F, 4.231666F);
      ((Path)localObject1).cubicTo(16.835482F, 4.151613F, 16.82045F, 4.036853F, 16.740396F, 3.975344F);
      ((Path)localObject1).cubicTo(16.708456F, 3.950802F, 16.669304F, 3.937497F, 16.629023F, 3.937497F);
      ((Path)localObject1).close();
      WeChatSVGRenderC2Java.setFillType((Path)localObject1, 2);
      localCanvas.drawPath((Path)localObject1, (Paint)localObject2);
      localCanvas.restore();
      ...
      localObject2 = c.a(localPaint2, paramArrayOfObject);
      localObject1 = c.l(paramArrayOfObject);
      ((Path)localObject1).moveTo(7.555555F, 0.0F);
      ((Path)localObject1).lineTo(9.444445F, 0.0F);
      ((Path)localObject1).lineTo(11.805555F, 2.8125F);
      ((Path)localObject1).lineTo(5.194445F, 2.8125F);
      ((Path)localObject1).close();
