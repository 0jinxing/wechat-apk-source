...
public final class el extends c
{
  ...
  public final int a(int paramInt, Object[] paramArrayOfObject)
  {
    ...
    while (true)
    {
      ...
      localPaint2.setColor(-824064);
      localObject = c.l(paramArrayOfObject);
      ((Path)localObject).moveTo(0.0F, 1.6F);
      ((Path)localObject).cubicTo(0.0F, 0.7163444F, 0.7163444F, 0.0F, 1.6F, 0.0F);
      ((Path)localObject).lineTo(26.4F, 0.0F);
      ((Path)localObject).cubicTo(27.283655F, 0.0F, 28.0F, 0.7163444F, 28.0F, 1.6F);
      ((Path)localObject).lineTo(28.0F, 14.4F);
      ((Path)localObject).cubicTo(28.0F, 15.283655F, 27.283655F, 16.0F, 26.4F, 16.0F);
      ((Path)localObject).lineTo(1.6F, 16.0F);
      ((Path)localObject).cubicTo(0.7163444F, 16.0F, 0.0F, 15.283655F, 0.0F, 14.4F);
      ((Path)localObject).lineTo(0.0F, 1.6F);
