...
public final class ajf extends c
{
  ...
  public final int a(int paramInt, Object[] paramArrayOfObject)
  {
    ...
    while (true)
    {
      ...
      ((Path)localObject1).moveTo(6.009757F, 12.0F);
      ((Path)localObject1).cubicTo(3.795167F, 12.0F, 2.0F, 13.792681F, 2.0F, 16.000319F);
      ((Path)localObject1).lineTo(2.0F, 54.999683F);
      ((Path)localObject1).cubicTo(2.0F, 57.20863F, 3.789142F, 59.0F, 5.991014F, 59.0F);
      ((Path)localObject1).lineTo(72.008987F, 59.0F);
      ((Path)localObject1).cubicTo(74.21183F, 59.0F, 76.0F, 57.208717F, 76.0F, 54.999683F);
      ((Path)localObject1).lineTo(76.0F, 16.000319F);
      ((Path)localObject1).cubicTo(76.0F, 13.79181F, 74.205315F, 12.0F, 71.990242F, 12.0F);
      ((Path)localObject1).lineTo(57.5F, 12.0F);
      ((Path)localObject1).lineTo(51.196438F, 3.595249F);
      ((Path)localObject1).cubicTo(50.5825F, 2.776666F, 49.029545F, 2.0F, 48.008911F, 2.0F);
      ((Path)localObject1).lineTo(29.991091F, 2.0F);
      ((Path)localObject1).cubicTo(28.967781F, 2.0F, 27.419127F, 2.774499F, 26.803562F, 3.595249F);
      ((Path)localObject1).lineTo(20.5F, 12.0F);
      ((Path)localObject1).lineTo(6.009757F, 12.0F);
      ...
      ((Path)localObject3).moveTo(6.0F, 2.0F);
      ((Path)localObject3).lineTo(16.0F, 2.0F);
      ((Path)localObject3).lineTo(16.0F, 6.0F);
      ((Path)localObject3).lineTo(6.0F, 6.0F);
      ((Path)localObject3).lineTo(6.0F, 2.0F);
