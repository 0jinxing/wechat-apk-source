...
public final class aha extends c
{
  ...
  public final int a(int paramInt, Object[] paramArrayOfObject)
  {
    ...
    while (true)
    {
      ...
      localPaint2.setColor(-10197916);
      localObject2 = c.a((float[])localObject2, 1.0F, 0.0F, 129.0F, 0.0F, 1.0F, 40.0F);
      ...
      localCanvas.save();
      localPaint2 = c.a(localPaint1, paramArrayOfObject);
      localPaint2.setColor(-5395027);
      localObject2 = c.a((float[])localObject2, 1.0F, 0.0F, 236.0F, 0.0F, 1.0F, 250.0F);
      ((Matrix)localObject1).reset();
      ((Matrix)localObject1).setValues((float[])localObject2);
      localCanvas.concat((Matrix)localObject1);
      localCanvas.save();
      ...
      localObject2 = c.a((float[])localObject2, 1.0F, 0.0F, 303.0F, 0.0F, 1.0F, 297.0F);
      ((Matrix)localObject1).reset();
      ((Matrix)localObject1).setValues((float[])localObject2);
      localCanvas.concat((Matrix)localObject1);
      localCanvas.save();
      ...
      ((Path)localObject2).cubicTo(16.790001F, 1.21F, 26.379999F, -0.01F, 35.07F, 1.31F);
      ((Path)localObject2).cubicTo(42.099998F, 2.37F, 49.009998F, 6.23F, 52.41F, 12.66F);
      ((Path)localObject2).cubicTo(56.759998F, 20.82F, 56.82F, 31.200001F, 52.349998F, 39.330002F);
      ((Path)localObject2).cubicTo(48.860001F, 46.139999F, 43.080002F, 51.310001F, 37.75F, 56.66F);
      ((Path)localObject2).cubicTo(33.470001F, 60.799999F, 32.68F, 67.010002F, 32.41F, 72.660004F);
      ((Path)localObject2).cubicTo(28.280001F, 72.68F, 24.139999F, 72.68F, 20.01F, 72.660004F);
      ((Path)localObject2).cubicTo(20.16F, 67.110001F, 20.629999F, 61.310001F, 23.530001F, 56.439999F);
      ((Path)localObject2).cubicTo(27.9F, 49.060001F, 35.240002F, 44.130001F, 40.130001F, 37.169998F);
      ((Path)localObject2).cubicTo(44.330002F, 30.860001F, 44.52F, 21.459999F, 39.389999F, 15.62F);
      ((Path)localObject2).cubicTo(34.470001F, 10.8F, 26.41F, 10.81F, 20.440001F, 13.51F);
      ((Path)localObject2).cubicTo(15.89F, 15.53F, 13.6F, 20.4F, 13.27F, 25.15F);
      ((Path)localObject2).cubicTo(9.17F, 25.120001F, 5.07F, 25.16F, 0.98F, 25.110001F);
      ...
      ((Path)localObject1).moveTo(23.379999F, 87.5F);
      ((Path)localObject1).cubicTo(27.68F, 85.559998F, 33.849998F, 87.800003F, 34.18F, 92.970001F);
      ((Path)localObject1).cubicTo(35.23F, 98.169998F, 29.85F, 102.28F, 24.98F, 100.86F);
      ((Path)localObject1).cubicTo(18.459999F, 100.17F, 17.530001F, 89.879997F, 23.379999F, 87.5F);
      ((Path)localObject1).lineTo(23.379999F, 87.5F);
