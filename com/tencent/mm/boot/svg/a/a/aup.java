...
public final class aup extends c
{
  ...
  public final int a(int paramInt, Object[] paramArrayOfObject)
  {
    ...
    while (true)
    {
      ...
      localPaint2.setColor(-7960954);
      localObject = c.l(paramArrayOfObject);
      ((Path)localObject).moveTo(37.509998F, 0.0F);
      ((Path)localObject).lineTo(41.009998F, 0.0F);
      ((Path)localObject).cubicTo(50.900002F, 0.33F, 60.66F, 4.26F, 67.739998F, 11.21F);
      ((Path)localObject).cubicTo(74.93F, 18.030001F, 79.209999F, 27.6F, 80.0F, 37.439999F);
      ((Path)localObject).lineTo(80.0F, 41.849998F);
      ((Path)localObject).cubicTo(79.43F, 53.110001F, 73.989998F, 64.059998F, 65.120003F, 71.080002F);
      ((Path)localObject).cubicTo(58.759998F, 76.389999F, 50.68F, 79.260002F, 42.490002F, 80.0F);
      ((Path)localObject).lineTo(37.869999F, 80.0F);
      ((Path)localObject).cubicTo(29.1F, 79.360001F, 20.48F, 76.099998F, 13.87F, 70.230003F);
      ((Path)localObject).cubicTo(5.72F, 63.349998F, 0.79F, 53.07F, 0.0F, 42.48F);
      ((Path)localObject).lineTo(0.0F, 37.709999F);
      ((Path)localObject).cubicTo(0.69F, 27.780001F, 5.0F, 18.120001F, 12.23F, 11.24F);
      ((Path)localObject).cubicTo(18.959999F, 4.59F, 28.139999F, 0.8F, 37.509998F, 0.0F);
      ((Path)localObject).lineTo(37.509998F, 0.0F);
      ((Path)localObject).close();
      ((Path)localObject).moveTo(17.290001F, 19.27F);
      ((Path)localObject).cubicTo(14.37F, 19.98F, 12.73F, 23.07F, 12.98F, 25.93F);
      ((Path)localObject).cubicTo(13.01F, 35.970001F, 12.9F, 46.02F, 13.03F, 56.060001F);
      ((Path)localObject).cubicTo(12.91F, 59.669998F, 16.42F, 62.419998F, 19.879999F, 62.009998F);
      ((Path)localObject).cubicTo(33.619999F, 61.990002F, 47.349998F, 62.099998F, 61.09F, 61.959999F);
      ((Path)localObject).cubicTo(64.239998F, 62.060001F, 67.059998F, 59.240002F, 66.959999F, 56.080002F);
      ((Path)localObject).cubicTo(67.139999F, 46.73F, 66.93F, 37.380001F, 67.050003F, 28.030001F);
      ((Path)localObject).cubicTo(67.0F, 25.540001F, 67.269997F, 22.59F, 65.230003F, 20.74F);
      ((Path)localObject).cubicTo(63.09F, 18.48F, 59.73F, 19.07F, 56.939999F, 18.950001F);
      ((Path)localObject).cubicTo(43.73F, 19.209999F, 30.469999F, 18.58F, 17.290001F, 19.27F);
      ((Path)localObject).lineTo(17.290001F, 19.27F);
      ((Path)localObject).close();
