...
public final class yg extends c
{
  ...
  public final int a(int paramInt, Object[] paramArrayOfObject)
  {
    ...
    while (true)
    {
      ...
      localPaint2.setStrokeWidth(1.0F);
      localCanvas.save();
      Object localObject2 = c.a(localPaint1, paramArrayOfObject);
      ...
      ((Path)localObject3).moveTo(92.369286F, 78.0F);
      ((Path)localObject3).cubicTo(93.369957F, 78.0F, 94.176552F, 78.0F, 94.744667F, 78.0F);
      ((Path)localObject3).cubicTo(100.38519F, 78.0F, 105.0F, 73.144463F, 105.0F, 67.209633F);
      ((Path)localObject3).lineTo(105.0F, 41.733364F);
      ((Path)localObject3).cubicTo(104.99974F, 21.032589F, 89.9217F, 17.842987F, 89.9217F, 17.842987F);
      ((Path)localObject3).cubicTo(77.424179F, 8.975469F, 60.473461F, 10.228277F, 49.229244F, 21.416538F);
      ((Path)localObject3).cubicTo(42.930489F, 27.68936F, 39.0F, 36.567982F, 39.0F, 46.414097F);
      ((Path)localObject3).cubicTo(39.0F, 53.155041F, 39.0F, 61.260597F, 39.0F, 67.209633F);
      ((Path)localObject3).cubicTo(39.0F, 73.144463F, 43.614807F, 78.0F, 49.255329F, 78.0F);
      ((Path)localObject3).cubicTo(49.823959F, 78.0F, 50.568138F, 78.0F, 51.45837F, 78.0F);
      ...
      ((Path)localObject3).moveTo(53.55265F, 96.522469F);
      ((Path)localObject3).cubicTo(51.427998F, 98.403458F, 50.553375F, 109.06194F, 57.912029F, 112.0068F);
      ((Path)localObject3).lineTo(72.0F, 114.85714F);
      ((Path)localObject3).lineTo(59.999092F, 92.0F);
      ((Path)localObject3).cubicTo(57.618565F, 93.317734F, 55.469753F, 94.825226F, 53.55265F, 96.522469F);
