...
public final class d extends c
{
  ...
  public final int a(int paramInt, Object[] paramArrayOfObject)
  {
    ...
    while (true)
    {
      ...
      localObject2 = c.a((float[])localObject2, 1.0F, 0.0F, 133.0F, 0.0F, 1.0F, 40.0F);
      ...
      localObject2 = c.a((float[])localObject2, 1.0F, 0.0F, 240.0F, 0.0F, 1.0F, 250.0F);
      ((Matrix)localObject1).reset();
      ((Matrix)localObject1).setValues((float[])localObject2);
      localCanvas.concat((Matrix)localObject1);
      localCanvas.save();
      ...
      localObject2 = c.a((float[])localObject2, 1.0F, 0.0F, 328.0F, 0.0F, 1.0F, 294.0F);
      ((Matrix)localObject1).reset();
      ((Matrix)localObject1).setValues((float[])localObject2);
      localCanvas.concat((Matrix)localObject1);
      localCanvas.save();
      ...
      ((Path)localObject1).moveTo(2.09F, 1.18F);
      ((Path)localObject1).cubicTo(5.34F, 0.85F, 8.64F, 0.87F, 11.89F, 1.16F);
      ((Path)localObject1).cubicTo(13.56F, 2.19F, 12.81F, 4.37F, 13.03F, 5.98F);
      ((Path)localObject1).cubicTo(12.85F, 29.290001F, 13.24F, 52.610001F, 12.83F, 75.900002F);
      ((Path)localObject1).cubicTo(10.31F, 78.110001F, 6.2F, 76.639999F, 3.05F, 76.940002F);
      ((Path)localObject1).cubicTo(0.84F, 77.099998F, 0.92F, 74.510002F, 0.98F, 72.989998F);
      ((Path)localObject1).cubicTo(1.14F, 49.369999F, 0.76F, 25.73F, 1.17F, 2.13F);
      ((Path)localObject1).cubicTo(1.4F, 1.89F, 1.86F, 1.41F, 2.09F, 1.18F);
      ((Path)localObject1).lineTo(2.09F, 1.18F);
      ...
      ((Path)localObject3).moveTo(2.14F, 89.160004F);
      ((Path)localObject3).cubicTo(5.36F, 88.860001F, 8.63F, 88.860001F, 11.87F, 89.160004F);
      ((Path)localObject3).cubicTo(12.11F, 89.410004F, 12.59F, 89.889999F, 12.84F, 90.129997F);
      ((Path)localObject3).cubicTo(12.89F, 93.470001F, 13.67F, 97.330002F, 12.39F, 100.39F);
      ((Path)localObject3).cubicTo(9.31F, 101.66F, 5.48F, 100.89F, 2.14F, 100.84F);
      ((Path)localObject3).cubicTo(1.89F, 100.59F, 1.4F, 100.11F, 1.16F, 99.860001F);
      ((Path)localObject3).cubicTo(0.86F, 96.639999F, 0.86F, 93.379997F, 1.16F, 90.160004F);
      ((Path)localObject3).cubicTo(1.4F, 89.910004F, 1.89F, 89.410004F, 2.14F, 89.160004F);
      ((Path)localObject3).lineTo(2.14F, 89.160004F);
