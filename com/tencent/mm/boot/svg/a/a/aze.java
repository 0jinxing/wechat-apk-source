...
public final class aze extends c
{
  ...
  public final int a(int paramInt, Object[] paramArrayOfObject)
  {
    ...
    while (true)
    {
      ...
      localCanvas.save();
      Object localObject3 = c.a(localPaint, paramArrayOfObject);
      Object localObject4 = c.l(paramArrayOfObject);
      ((Path)localObject4).moveTo(5.3F, 1.27F);
      ((Path)localObject4).cubicTo(23.860001F, 0.64F, 42.5F, 1.17F, 61.09F, 1.0F);
      ((Path)localObject4).cubicTo(64.550003F, 0.58F, 68.059998F, 3.32F, 67.959999F, 6.91F);
      ((Path)localObject4).cubicTo(68.019997F, 25.290001F, 68.040001F, 43.68F, 67.949997F, 62.049999F);
      ((Path)localObject4).cubicTo(68.089996F, 65.660004F, 64.550003F, 68.440002F, 61.080002F, 68.0F);
      ((Path)localObject4).cubicTo(43.040001F, 67.970001F, 25.0F, 68.059998F, 6.96F, 67.959999F);
      ((Path)localObject4).cubicTo(3.79F, 68.07F, 0.96F, 65.230003F, 1.04F, 62.07F);
      ((Path)localObject4).cubicTo(0.94F, 44.029999F, 1.03F, 25.99F, 0.99F, 7.95F);
      ((Path)localObject4).cubicTo(0.72F, 5.07F, 2.4F, 2.01F, 5.3F, 1.27F);
      ((Path)localObject4).lineTo(5.3F, 1.27F);
      ((Path)localObject4).close();
      ((Path)localObject4).moveTo(29.0F, 8.97F);
      ((Path)localObject4).cubicTo(22.26F, 10.71F, 17.07F, 18.360001F, 19.85F, 25.17F);
      ((Path)localObject4).cubicTo(21.77F, 30.459999F, 27.73F, 32.84F, 33.009998F, 32.220001F);
      ((Path)localObject4).cubicTo(32.099998F, 34.880001F, 32.919998F, 37.5F, 34.540001F, 39.66F);
      ((Path)localObject4).cubicTo(29.02F, 40.040001F, 22.959999F, 40.740002F, 18.68F, 44.650002F);
      ((Path)localObject4).cubicTo(15.73F, 47.259998F, 14.46F, 51.93F, 16.58F, 55.439999F);
      ((Path)localObject4).cubicTo(19.110001F, 59.709999F, 24.389999F, 61.189999F, 29.040001F, 61.459999F);
      ((Path)localObject4).cubicTo(35.32F, 61.82F, 42.32F, 60.5F, 46.740002F, 55.669998F);
      ((Path)localObject4).cubicTo(49.75F, 52.48F, 50.77F, 47.34F, 48.540001F, 43.439999F);
      ((Path)localObject4).cubicTo(46.490002F, 39.880001F, 42.630001F, 38.040001F, 39.900002F, 35.119999F);
      ((Path)localObject4).cubicTo(38.900002F, 34.029999F, 39.189999F, 32.23F, 40.150002F, 31.209999F);
      ((Path)localObject4).cubicTo(42.52F, 28.58F, 46.029999F, 26.66F, 46.91F, 22.969999F);
      ((Path)localObject4).cubicTo(48.389999F, 18.27F, 46.029999F, 13.4F, 42.369999F, 10.46F);
      ((Path)localObject4).cubicTo(45.619999F, 11.0F, 48.580002F, 9.74F, 51.23F, 7.96F);
      ((Path)localObject4).cubicTo(43.830002F, 8.25F, 36.240002F, 7.08F, 29.0F, 8.97F);
      ((Path)localObject4).lineTo(29.0F, 8.97F);
      ((Path)localObject4).close();
      ...
      ((Path)localObject3).moveTo(30.389999F, 10.46F);
      ((Path)localObject3).cubicTo(37.68F, 9.08F, 41.32F, 18.059999F, 40.970001F, 24.02F);
      ((Path)localObject3).cubicTo(41.099998F, 28.74F, 35.380001F, 31.73F, 31.379999F, 29.6F);
      ((Path)localObject3).cubicTo(27.25F, 27.370001F, 25.620001F, 22.34F, 25.41F, 17.92F);
      ((Path)localObject3).cubicTo(25.139999F, 14.69F, 27.059999F, 11.17F, 30.389999F, 10.46F);
      ((Path)localObject3).lineTo(30.389999F, 10.46F);
