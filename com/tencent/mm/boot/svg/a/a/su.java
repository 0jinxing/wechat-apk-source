...
public final class su extends c
{
  ...
  public final int a(int paramInt, Object[] paramArrayOfObject)
  {
    ...
    while (true)
    {
      ...
      localCanvas.save();
      localObject3 = c.a((float[])localObject2, 1.0F, 0.0F, 25.0F, 0.0F, 1.0F, 60.0F);
      ((Matrix)localObject1).reset();
      ((Matrix)localObject1).setValues((float[])localObject3);
      localCanvas.concat((Matrix)localObject1);
      localObject2 = c.a(localPaint, paramArrayOfObject);
      ((Paint)localObject2).setColor(-1749411);
      localCanvas.save();
      ...
      ((Path)localObject1).moveTo(2.38F, 47.23F);
      ((Path)localObject1).cubicTo(5.72F, 44.959999F, 9.05F, 50.759998F, 5.36F, 52.43F);
      ((Path)localObject1).cubicTo(2.2F, 54.310001F, -0.85F, 49.09F, 2.38F, 47.23F);
      ((Path)localObject1).lineTo(2.38F, 47.23F);
