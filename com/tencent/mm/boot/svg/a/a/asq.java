...
public final class asq extends c
{
  ...
  public final int a(int paramInt, Object[] paramArrayOfObject)
  {
    ...
    while (true)
    {
      ...
      ((Path)localObject1).moveTo(1.5F, 0.45F);
      ((Path)localObject1).cubicTo(7.09F, -0.45F, 12.63F, 1.15F, 18.18F, 1.65F);
      ((Path)localObject1).cubicTo(30.799999F, 3.0F, 43.41F, 4.47F, 56.009998F, 5.98F);
      ((Path)localObject1).cubicTo(62.169998F, 6.8F, 68.5F, 6.71F, 74.480003F, 8.59F);
      ((Path)localObject1).cubicTo(75.639999F, 15.67F, 74.790001F, 22.860001F, 75.0F, 29.99F);
      ((Path)localObject1).cubicTo(74.690002F, 38.529999F, 75.660004F, 47.130001F, 74.470001F, 55.619999F);
      ((Path)localObject1).cubicTo(68.870003F, 56.279999F, 63.34F, 54.900002F, 57.790001F, 54.360001F);
      ((Path)localObject1).cubicTo(44.509998F, 52.919998F, 31.25F, 51.330002F, 17.98F, 49.82F);
      ((Path)localObject1).cubicTo(12.48F, 49.16F, 6.87F, 49.080002F, 1.54F, 47.43F);
      ((Path)localObject1).cubicTo(0.34F, 40.009998F, 1.26F, 32.470001F, 1.0F, 24.99F);
      ((Path)localObject1).cubicTo(1.25F, 16.82F, 0.36F, 8.59F, 1.5F, 0.45F);
      ((Path)localObject1).lineTo(1.5F, 0.45F);
      ...
      ((Paint)localObject1).setColor(-1644826);
      localObject3 = c.l(paramArrayOfObject);
      ((Path)localObject3).moveTo(50.357639F, 63.368923F);
      ((Path)localObject3).lineTo(113.62674F, 55.344185F);
      ((Path)localObject3).cubicTo(113.62674F, 55.344185F, 118.90408F, 54.899307F, 118.90408F, 59.134113F);
      ((Path)localObject3).cubicTo(118.90408F, 63.368923F, 118.90408F, 70.766945F, 118.90408F, 70.766945F);
      ((Path)localObject3).lineTo(50.357639F, 63.368923F);
