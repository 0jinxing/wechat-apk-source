...
public final class du extends c
{
  ...
  public final int a(int paramInt, Object[] paramArrayOfObject)
  {
    ...
    while (true)
    {
      ...
      ((Path)localObject5).moveTo(7.25F, 23.25F);
      ((Path)localObject5).lineTo(40.75F, 23.25F);
      ((Path)localObject5).lineTo(40.75F, 65.75F);
      ((Path)localObject5).lineTo(7.25F, 65.75F);
      ((Path)localObject5).lineTo(7.25F, 23.25F);
      ...
      ((Path)localObject2).cubicTo(15.0F, 0.4477152F, 15.447715F, -6.82121E-013F, 16.0F, -6.82121E-013F);
      ((Path)localObject2).lineTo(32.0F, -6.82121E-013F);
      ((Path)localObject2).cubicTo(32.552284F, -6.82121E-013F, 33.0F, 0.4477152F, 33.0F, 1.0F);
      ((Path)localObject2).lineTo(33.0F, 6.0F);
      ((Path)localObject2).cubicTo(33.0F, 6.552285F, 32.552284F, 7.0F, 32.0F, 7.0F);
      ((Path)localObject2).lineTo(16.0F, 7.0F);
      ((Path)localObject2).cubicTo(15.447715F, 7.0F, 15.0F, 6.552285F, 15.0F, 6.0F);
      ((Path)localObject2).lineTo(15.0F, 1.0F);
