...
public final class afp extends c
{
  ...
  public final int a(int paramInt, Object[] paramArrayOfObject)
  {
    ...
    while (true)
    {
      ...
      ((Paint)localObject3).setColor(-5000269);
      ...
      ((Path)localObject3).moveTo(8.89F, 2.93F);
      ((Path)localObject3).cubicTo(20.49F, -0.28F, 33.560001F, -1.0F, 44.68F, 4.33F);
      ((Path)localObject3).cubicTo(49.07F, 6.45F, 53.93F, 6.98F, 58.740002F, 7.25F);
      ((Path)localObject3).cubicTo(59.240002F, 16.49F, 59.0F, 25.77F, 58.919998F, 35.02F);
      ((Path)localObject3).cubicTo(58.950001F, 37.599998F, 55.860001F, 37.380001F, 54.07F, 37.700001F);
      ((Path)localObject3).cubicTo(46.869999F, 37.59F, 41.470001F, 44.0F, 39.5F, 50.380001F);
      ((Path)localObject3).cubicTo(37.82F, 55.080002F, 38.720001F, 60.080002F, 38.279999F, 64.919998F);
      ((Path)localObject3).cubicTo(37.470001F, 67.449997F, 34.150002F, 66.709999F, 32.459999F, 65.589996F);
      ((Path)localObject3).cubicTo(28.889999F, 63.860001F, 28.6F, 59.509998F, 28.049999F, 56.07F);
      ((Path)localObject3).cubicTo(27.309999F, 51.380001F, 27.690001F, 46.610001F, 28.709999F, 41.990002F);
      ((Path)localObject3).cubicTo(21.76F, 41.950001F, 14.81F, 42.099998F, 7.86F, 41.970001F);
      ((Path)localObject3).cubicTo(4.95F, 42.200001F, 2.17F, 39.869999F, 2.02F, 36.93F);
      ((Path)localObject3).cubicTo(1.68F, 34.73F, 3.44F, 33.139999F, 4.59F, 31.52F);
      ((Path)localObject3).cubicTo(3.14F, 30.219999F, 1.16F, 29.059999F, 1.05F, 26.889999F);
      ((Path)localObject3).cubicTo(0.58F, 24.5F, 2.49F, 22.780001F, 3.79F, 21.08F);
      ((Path)localObject3).cubicTo(3.18F, 19.48F, 2.06F, 17.92F, 2.21F, 16.139999F);
      ((Path)localObject3).cubicTo(2.35F, 14.16F, 4.07F, 12.92F, 5.22F, 11.51F);
      ((Path)localObject3).cubicTo(3.86F, 8.15F, 4.92F, 3.73F, 8.89F, 2.93F);
      ((Path)localObject3).lineTo(8.89F, 2.93F);
