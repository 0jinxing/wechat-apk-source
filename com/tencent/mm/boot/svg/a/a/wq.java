...
public final class wq extends c
{
  ...
  public final int a(int paramInt, Object[] paramArrayOfObject)
  {
    ...
    while (true)
    {
      ...
      ((Path)localObject1).moveTo(9.0F, 18.5F);
      ((Path)localObject1).cubicTo(9.0F, 17.671574F, 9.895431F, 17.0F, 11.0F, 17.0F);
      ((Path)localObject1).lineTo(28.0F, 17.0F);
      ((Path)localObject1).cubicTo(29.10457F, 17.0F, 30.0F, 17.671574F, 30.0F, 18.5F);
      ((Path)localObject1).lineTo(30.0F, 18.5F);
      ((Path)localObject1).cubicTo(30.0F, 19.328426F, 29.10457F, 20.0F, 28.0F, 20.0F);
      ((Path)localObject1).lineTo(11.0F, 20.0F);
      ((Path)localObject1).cubicTo(9.895431F, 20.0F, 9.0F, 19.328426F, 9.0F, 18.5F);
      ((Path)localObject1).lineTo(9.0F, 18.5F);
