...
public final class xz extends c
{
  ...
  public final int a(int paramInt, Object[] paramArrayOfObject)
  {
    ...
    while (true)
    {
      ...
      ((Path)localObject4).moveTo(57.0F, 93.0F);
      ((Path)localObject4).lineTo(72.0F, 111.0F);
      ((Path)localObject4).lineTo(57.0F, 117.0F);
      ((Path)localObject4).lineTo(48.0F, 93.0F);
      ...
      ((Paint)localObject2).setStrokeJoin(Paint.Join.MITER);
      localObject4 = c.l(paramArrayOfObject);
      ((Path)localObject4).moveTo(87.0F, 81.0F);
      ((Path)localObject4).lineTo(87.0F, 88.993668F);
      ((Path)localObject4).cubicTo(87.004784F, 90.675812F, 88.42321F, 92.1185F, 90.300102F, 92.344925F);
      ((Path)localObject4).lineTo(104.25684F, 93.992752F);
      ((Path)localObject4).cubicTo(114.9447F, 95.264374F, 122.99962F, 103.46318F, 122.99962F, 113.05984F);
      ((Path)localObject4).lineTo(122.99962F, 135.0F);
      localCanvas.drawPath((Path)localObject4, (Paint)localObject2);
      localCanvas.restore();
      localCanvas.save();
      localPaint1 = c.a(localPaint1, paramArrayOfObject);
