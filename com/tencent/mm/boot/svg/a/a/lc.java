...
public final class lc extends c
{
  ...
  public final int a(int paramInt, Object[] paramArrayOfObject)
  {
    ...
    while (true)
    {
      ...
      ((Path)localObject3).lineTo(78.0F, 0.0F);
      ((Path)localObject3).lineTo(78.0F, 78.0F);
      ((Path)localObject3).lineTo(0.0F, 78.0F);
      ((Path)localObject3).lineTo(0.0F, 0.0F);
      ((Path)localObject3).close();
      localCanvas.saveLayerAlpha(null, 0, 4);
      localCanvas.drawPath((Path)localObject3, c.a((Paint)localObject4, paramArrayOfObject));
      localCanvas.restore();
      localObject3 = c.a(localPaint, paramArrayOfObject);
      ((Paint)localObject3).setColor(-4114126);
      localCanvas.save();
      localObject3 = c.a((Paint)localObject3, paramArrayOfObject);
      localObject4 = c.l(paramArrayOfObject);
      ((Path)localObject4).moveTo(4.0F, 3.0F);
      ((Path)localObject4).cubicTo(4.0F, 1.343146F, 5.343145F, 0.0F, 7.0F, 0.0F);
      ((Path)localObject4).lineTo(71.0F, 0.0F);
      ((Path)localObject4).cubicTo(72.656853F, 0.0F, 74.0F, 1.343146F, 74.0F, 3.0F);
      ((Path)localObject4).lineTo(74.0F, 75.0F);
      ((Path)localObject4).cubicTo(74.0F, 76.656853F, 72.656853F, 78.0F, 71.0F, 78.0F);
      ((Path)localObject4).lineTo(7.0F, 78.0F);
      ((Path)localObject4).cubicTo(5.343145F, 78.0F, 4.0F, 76.656853F, 4.0F, 75.0F);
      ((Path)localObject4).lineTo(4.0F, 3.0F);
      ((Path)localObject4).close();
      localCanvas.drawPath((Path)localObject4, (Paint)localObject3);
      localCanvas.restore();
      localObject3 = c.a(localPaint, paramArrayOfObject);
      ((Paint)localObject3).setColor(-3195594);
      localCanvas.save();
      localObject4 = c.a((Paint)localObject3, paramArrayOfObject);
      localObject3 = c.l(paramArrayOfObject);
      ((Path)localObject3).moveTo(4.0F, 3.0F);
      ((Path)localObject3).cubicTo(4.0F, 1.343146F, 5.343145F, 0.0F, 7.0F, 0.0F);
      ((Path)localObject3).lineTo(71.0F, 0.0F);
      ((Path)localObject3).cubicTo(72.656853F, 0.0F, 74.0F, 1.343146F, 74.0F, 3.0F);
      ((Path)localObject3).lineTo(74.0F, 72.0F);
      ((Path)localObject3).cubicTo(74.0F, 73.656853F, 72.656853F, 75.0F, 71.0F, 75.0F);
      ((Path)localObject3).lineTo(7.0F, 75.0F);
      ((Path)localObject3).cubicTo(5.343145F, 75.0F, 4.0F, 73.656853F, 4.0F, 72.0F);
      ((Path)localObject3).lineTo(4.0F, 3.0F);
      ((Path)localObject3).close();
      localCanvas.drawPath((Path)localObject3, (Paint)localObject4);
      localCanvas.restore();
      localCanvas.save();
      localObject4 = c.a(localPaint, paramArrayOfObject);
      ((Paint)localObject4).setColor(-3983053);
      localObject3 = c.l(paramArrayOfObject);
      ((Path)localObject3).moveTo(38.99094F, 38.0F);
      ((Path)localObject3).cubicTo(28.32542F, 38.0F, 18.273897F, 34.220352F, 9.596006F, 29.342281F);
      ((Path)localObject3).cubicTo(7.661689F, 28.254951F, 3.994564F, 24.845966F, 4.000006F, 21.130112F);
      ((Path)localObject3).cubicTo(4.020538F, 7.110608F, 4.000006F, 7.201041F, 4.000006F, 4.003007F);
      ((Path)localObject3).cubicTo(5.01282F, 3.996242F, 5.868786F, 4.003007F, 38.99094F, 4.003007F);
      ((Path)localObject3).cubicTo(39.012661F, 17.169802F, 38.988136F, 28.86417F, 38.99094F, 38.0F);
      ((Path)localObject3).close();
      ((Path)localObject3).moveTo(39.009068F, 38.039093F);
      ((Path)localObject3).cubicTo(39.011868F, 28.893492F, 38.987331F, 17.183887F, 39.009068F, 4.00301F);
      ((Path)localObject3).cubicTo(72.146149F, 4.00301F, 72.966225F, 3.996238F, 73.979492F, 4.00301F);
      ((Path)localObject3).cubicTo(73.979492F, 7.204465F, 73.958954F, 7.115004F, 73.979492F, 21.149502F);
      ((Path)localObject3).cubicTo(73.98494F, 24.869329F, 70.316162F, 28.281961F, 68.380966F, 29.370455F);
      ((Path)localObject3).cubicTo(59.699165F, 34.253738F, 49.679394F, 38.039093F, 39.009068F, 38.039093F);
      ((Path)localObject3).close();
      ...
      localCanvas.save();
      localObject3 = c.a(localPaint, paramArrayOfObject);
      ((Paint)localObject3).setColor(-43948);
      localObject4 = c.l(paramArrayOfObject);
      ((Path)localObject4).moveTo(38.99094F, 34.0F);
      ((Path)localObject4).cubicTo(28.32542F, 34.0F, 18.273897F, 31.22035F, 9.596006F, 26.342281F);
      ((Path)localObject4).cubicTo(7.661689F, 25.254951F, 3.994564F, 21.845966F, 4.000006F, 18.130112F);
      ((Path)localObject4).cubicTo(4.020538F, 4.110608F, 4.000006F, 3.201042F, 4.000006F, 0.003006567F);
      ((Path)localObject4).cubicTo(5.01282F, -0.003758209F, 5.868786F, 0.003006567F, 38.99094F, 0.003006567F);
      ((Path)localObject4).cubicTo(39.012661F, 13.169803F, 38.988136F, 24.86417F, 38.99094F, 34.0F);
      ((Path)localObject4).close();
      ((Path)localObject4).moveTo(39.009068F, 34.039093F);
      ((Path)localObject4).cubicTo(39.011868F, 24.893492F, 38.987331F, 13.183887F, 39.009068F, 0.003009782F);
      ((Path)localObject4).cubicTo(72.146149F, 0.003009782F, 72.966225F, -0.003762228F, 73.979492F, 0.003009782F);
      ((Path)localObject4).cubicTo(73.979492F, 3.204465F, 73.958954F, 4.115004F, 73.979492F, 18.149502F);
      ((Path)localObject4).cubicTo(73.98494F, 21.869329F, 70.316162F, 25.281961F, 68.380966F, 26.370455F);
      ((Path)localObject4).cubicTo(59.699165F, 31.25374F, 49.679394F, 34.039093F, 39.009068F, 34.039093F);
      ((Path)localObject4).close();
      ...
      ((Paint)localObject2).setColor(-4507855);
      localObject1 = c.l(paramArrayOfObject);
      ((Path)localObject1).moveTo(14.0F, 0.0F);
      ((Path)localObject1).cubicTo(21.731987F, 0.0F, 28.0F, 6.939586F, 28.0F, 15.5F);
      ((Path)localObject1).cubicTo(28.0F, 24.060413F, 21.731987F, 31.0F, 14.0F, 31.0F);
      ((Path)localObject1).cubicTo(6.268013F, 31.0F, 0.0F, 24.060413F, 0.0F, 15.5F);
      ((Path)localObject1).cubicTo(0.0F, 6.939586F, 6.268013F, 0.0F, 14.0F, 0.0F);
