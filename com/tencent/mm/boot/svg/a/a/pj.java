...
public final class pj extends c
{
  ...
  public final int a(int paramInt, Object[] paramArrayOfObject)
  {
    ...
    while (true)
    {
      ...
      ((Path)localObject1).moveTo(213.0F, 273.9996F);
      ((Path)localObject1).cubicTo(213.0F, 280.06461F, 208.063F, 284.9996F, 201.994F, 284.9996F);
      ((Path)localObject1).lineTo(14.006F, 284.9996F);
      ((Path)localObject1).cubicTo(7.937F, 284.9996F, 3.0F, 280.06461F, 3.0F, 273.9996F);
      ((Path)localObject1).lineTo(3.0F, 13.9996F);
      ((Path)localObject1).cubicTo(3.0F, 7.9346F, 7.937F, 2.9996F, 14.006F, 2.9996F);
      ((Path)localObject1).lineTo(201.994F, 2.9996F);
      ((Path)localObject1).cubicTo(208.063F, 2.9996F, 213.0F, 7.9346F, 213.0F, 13.9996F);
      ((Path)localObject1).lineTo(213.0F, 273.9996F);
      ((Path)localObject1).close();
      ((Path)localObject1).moveTo(216.0F, 14.0006F);
      ((Path)localObject1).cubicTo(216.0F, 6.2666F, 209.729F, -0.0004F, 201.994F, -0.0004F);
      ((Path)localObject1).lineTo(14.006F, -0.0004F);
      ((Path)localObject1).cubicTo(6.26F, -0.0004F, 0.0F, 6.2686F, 0.0F, 14.0006F);
      ((Path)localObject1).lineTo(0.0F, 273.9996F);
      ((Path)localObject1).cubicTo(0.0F, 281.73361F, 6.271F, 287.9996F, 14.006F, 287.9996F);
      ((Path)localObject1).lineTo(201.994F, 287.9996F);
      ((Path)localObject1).cubicTo(209.74001F, 287.9996F, 216.0F, 281.7316F, 216.0F, 273.9996F);
      ((Path)localObject1).lineTo(216.0F, 14.0006F);
      ((Path)localObject1).close();
