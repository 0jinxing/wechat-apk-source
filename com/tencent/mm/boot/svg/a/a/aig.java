...
public final class aig extends c
{
  ...
  public final int a(int paramInt, Object[] paramArrayOfObject)
  {
    ...
    while (true)
    {
      ...
      ((Paint)localObject4).setColor(-14624737);
      ((Paint)localObject4).setStrokeWidth(2.0F);
      localCanvas.save();
      localObject1 = c.a((Paint)localObject1, paramArrayOfObject);
      localObject4 = c.a((Paint)localObject4, paramArrayOfObject);
      localObject2 = c.l(paramArrayOfObject);
      ((Path)localObject2).moveTo(0.0F, 1.5F);
      ((Path)localObject2).cubicTo(0.0F, 0.671573F, 0.671573F, 0.0F, 1.5F, 0.0F);
      ((Path)localObject2).lineTo(37.5F, 0.0F);
      ((Path)localObject2).cubicTo(38.328426F, 0.0F, 39.0F, 0.671573F, 39.0F, 1.5F);
      ((Path)localObject2).lineTo(39.0F, 37.5F);
      ((Path)localObject2).cubicTo(39.0F, 38.328426F, 38.328426F, 39.0F, 37.5F, 39.0F);
      ((Path)localObject2).lineTo(1.5F, 39.0F);
      ((Path)localObject2).cubicTo(0.671573F, 39.0F, 0.0F, 38.328426F, 0.0F, 37.5F);
      ((Path)localObject2).lineTo(0.0F, 1.5F);
