...
public final class rc extends bsr
{
  ...
  public final int op(int paramInt, Object[] paramArrayOfObject)
  {
    ...
    if (paramInt == 0)
    {
      ...
      paramArrayOfObject.iz(3, this.iAd);
    ...
    label434: for (paramInt = e.a.a.a.ix(1, this.BaseRequest.computeSize()) + 0; ; paramInt = 0)
    {
      ...
      paramInt = i + e.a.a.b.b.a.bs(3, this.iAd);
      AppMethodBeat.o(48819);
      break;
      if (paramInt == 2)
      {
      ...
      if (paramInt == 3)
      {
        ...
        rc localrc = (rc)paramArrayOfObject[1];
        ...
        case 1:
          ...
          for (paramInt = 0; paramInt < j; paramInt++)
          {
            ...
            localrc.BaseRequest = ((hl)localObject1);
          }
          AppMethodBeat.o(48819);
          paramInt = i;
          break;
        case 2:
          localrc.vYh = ((e.a.a.a.a)localObject1).BTU.readString();
          AppMethodBeat.o(48819);
          paramInt = i;
          break;
        case 3:
          localrc.iAd = ((e.a.a.a.a)localObject1).BTU.vd();
          AppMethodBeat.o(48819);
          paramInt = i;
          break;
        }
