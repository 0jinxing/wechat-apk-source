...
public final class vy extends com.tencent.mm.bt.a
{
  public String geZ;
  ...
  public final int op(int paramInt, Object[] paramArrayOfObject)
  {
    ...
    if (paramInt == 1)
      if (this.geZ == null)
        break label275;
    label275: for (paramInt = e.a.a.b.b.a.f(1, this.geZ) + 0; ; paramInt = 0)
    {
      AppMethodBeat.o(80047);
      break;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        vy localvy = (vy)paramArrayOfObject[1];
        ...
        default:
          ...
          break;
        case 1:
          localvy.geZ = locala.BTU.readString();
          AppMethodBeat.o(80047);
          paramInt = i;
          break;
        }
