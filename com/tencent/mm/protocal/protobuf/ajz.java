...
public final class ajz extends bsr
{
  ...
  public final int op(int paramInt, Object[] paramArrayOfObject)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.wpz != null)
        paramArrayOfObject.e(3, this.wpz);
    ...
    label454: for (i = e.a.a.a.ix(1, this.BaseRequest.computeSize()) + 0; ; i = 0)
    {
      ...
      i = paramInt;
      if (this.wpz != null)
        i = paramInt + e.a.a.b.b.a.f(3, this.wpz);
      AppMethodBeat.o(114960);
      paramInt = i;
      break;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        ajz localajz = (ajz)paramArrayOfObject[1];
        ...
        case 1:
          ...
          for (paramInt = 0; paramInt < j; paramInt++)
          {
            ...
            localajz.BaseRequest = ((hl)localObject1);
          }
          AppMethodBeat.o(114960);
          paramInt = i;
          break;
        case 2:
          localajz.csB = ((e.a.a.a.a)localObject1).BTU.readString();
          AppMethodBeat.o(114960);
          paramInt = i;
          break;
        case 3:
          localajz.wpz = ((e.a.a.a.a)localObject1).BTU.readString();
          AppMethodBeat.o(114960);
          paramInt = i;
          break;
        }
