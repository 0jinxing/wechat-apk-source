...
public final class ly extends bsr
{
  ...
  public final int op(int paramInt, Object[] paramArrayOfObject)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.vPD != null)
        paramArrayOfObject.e(3, this.vPD);
    ...
    label546: for (i = e.a.a.a.ix(1, this.BaseRequest.computeSize()) + 0; ; i = 0)
    {
      ...
      i = paramInt;
      if (this.vPD != null)
        i = paramInt + e.a.a.b.b.a.f(3, this.vPD);
      AppMethodBeat.o(56729);
      paramInt = i;
      break;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        ly locally = (ly)paramArrayOfObject[1];
        ...
        case 1:
          ...
          for (paramInt = 0; paramInt < j; paramInt++)
          {
            ...
            locally.BaseRequest = ((hl)localObject1);
          }
          AppMethodBeat.o(56729);
          paramInt = i;
          break;
        case 2:
          ...
          for (paramInt = 0; paramInt < j; paramInt++)
          {
            ...
            locally.vPn = paramArrayOfObject;
          }
          AppMethodBeat.o(56729);
          paramInt = i;
          break;
        case 3:
          locally.vPD = ((e.a.a.a.a)localObject1).BTU.readString();
          AppMethodBeat.o(56729);
          paramInt = i;
          break;
        }
