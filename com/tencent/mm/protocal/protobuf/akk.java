...
public final class akk extends btd
{
  ...
  public final int op(int paramInt, Object[] paramArrayOfObject)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.vEF != null)
      {
        paramArrayOfObject.iy(2, this.vEF.computeSize());
    ...
    label580: for (paramInt = e.a.a.a.ix(1, this.BaseResponse.computeSize()) + 0; ; paramInt = 0)
    {
      i = paramInt;
      if (this.vEF != null)
        i = paramInt + e.a.a.a.ix(2, this.vEF.computeSize());
      AppMethodBeat.o(113781);
      paramInt = i;
      break;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        akk localakk = (akk)paramArrayOfObject[1];
        ...
        case 2:
          ...
          for (paramInt = 0; paramInt < j; paramInt++)
          {
            ...
            localakk.vEF = ((SKBuiltinBuffer_t)localObject1);
          }
          AppMethodBeat.o(113781);
          paramInt = i;
          break;
