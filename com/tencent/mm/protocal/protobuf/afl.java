...
{
  public LinkedList<ke> wmS;

  public afl()
  {
    AppMethodBeat.i(11751);
    this.wmS = new LinkedList();
  ...
  public final int op(int paramInt, Object[] paramArrayOfObject)
  {
    ...
    if (paramInt == 0)
    {
      ...
      paramArrayOfObject.e(2, 8, this.wmS);
    ...
    {
      paramInt += e.a.a.a.c(2, 8, this.wmS);
      AppMethodBeat.o(11752);
      break;
      if (paramInt == 2)
      {
      ...
      if (paramInt == 3)
      {
        ...
        afl localafl = (afl)paramArrayOfObject[1];
        ...
        case 1:
          ...
          for (paramInt = 0; paramInt < j; paramInt++)
          {
            ...
            localafl.BaseRequest = ((hl)localObject1);
          }
          AppMethodBeat.o(11752);
          paramInt = i;
          break;
        case 2:
          ...
          for (paramInt = 0; paramInt < j; paramInt++)
          {
            ...
            paramArrayOfObject = new ke();
            localObject2 = new e.a.a.a.a((byte[])localObject2, unknownTagHandler);
            for (bool = true; bool; bool = paramArrayOfObject.populateBuilderWithField((e.a.a.a.a)localObject2, paramArrayOfObject, bsr.getNextFieldNumber((e.a.a.a.a)localObject2)));
            localafl.wmS.add(paramArrayOfObject);
          }
          AppMethodBeat.o(11752);
          paramInt = i;
          break;
