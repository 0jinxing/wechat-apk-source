...
{
  public int jBv;
  public LinkedList<bts> wmi;

  public aef()
  {
    AppMethodBeat.i(80059);
    this.wmi = new LinkedList();
  ...
  public final int op(int paramInt, Object[] paramArrayOfObject)
  {
    ...
    if (paramInt == 0)
    {
      ...
      paramArrayOfObject.e(3, 8, this.wmi);
    ...
    {
      paramInt = paramInt + e.a.a.b.b.a.bs(2, this.jBv) + e.a.a.a.c(3, 8, this.wmi);
      AppMethodBeat.o(80060);
      break;
      if (paramInt == 2)
      {
      ...
      if (paramInt == 3)
      {
        ...
        aef localaef = (aef)paramArrayOfObject[1];
        ...
        case 1:
          ...
          for (paramInt = 0; paramInt < j; paramInt++)
          {
            ...
            localaef.BaseRequest = paramArrayOfObject;
          }
          AppMethodBeat.o(80060);
          paramInt = i;
          break;
        case 2:
          localaef.jBv = ((e.a.a.a.a)localObject1).BTU.vd();
          AppMethodBeat.o(80060);
          paramInt = i;
          break;
        case 3:
