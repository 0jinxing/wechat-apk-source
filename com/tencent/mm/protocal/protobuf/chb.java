...
{
  public LinkedList<sr> xfV;

  public chb()
  {
    AppMethodBeat.i(11815);
    this.xfV = new LinkedList();
  ...
  public final int op(int paramInt, Object[] paramArrayOfObject)
  {
    ...
    if (paramInt == 0)
    {
      ...
      paramArrayOfObject.e(2, 8, this.xfV);
    ...
    {
      paramInt += e.a.a.a.c(2, 8, this.xfV);
      AppMethodBeat.o(11816);
      break;
      if (paramInt == 2)
      {
      ...
      if (paramInt == 3)
      {
        ...
        chb localchb = (chb)paramArrayOfObject[1];
        ...
        case 1:
          ...
          for (paramInt = 0; paramInt < j; paramInt++)
          {
            ...
            localchb.BaseRequest = ((hl)localObject1);
          }
          AppMethodBeat.o(11816);
          paramInt = i;
          break;
        case 2:
          ...
          for (paramInt = 0; paramInt < j; paramInt++)
          {
            ...
            paramArrayOfObject = new sr();
            localObject2 = new e.a.a.a.a((byte[])localObject2, unknownTagHandler);
            for (bool = true; bool; bool = paramArrayOfObject.populateBuilderWithField((e.a.a.a.a)localObject2, paramArrayOfObject, bsr.getNextFieldNumber((e.a.a.a.a)localObject2)));
            localchb.xfV.add(paramArrayOfObject);
          }
          AppMethodBeat.o(11816);
          paramInt = i;
          break;
