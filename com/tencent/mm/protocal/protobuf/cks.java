...
public final class cks extends bsr
{
  ...
  public final int op(int paramInt, Object[] paramArrayOfObject)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.wcP != null)
        paramArrayOfObject.e(7, this.wcP);
      AppMethodBeat.o(136946);
      paramInt = i;
      return paramInt;
    }
    ...
    label798: for (paramInt = e.a.a.a.ix(1, this.BaseRequest.computeSize()) + 0; ; paramInt = 0)
    {
      ...
      i = paramInt;
      if (this.wcP != null)
        i = paramInt + e.a.a.b.b.a.f(7, this.wcP);
      AppMethodBeat.o(136946);
      paramInt = i;
      break;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        cks localcks = (cks)paramArrayOfObject[1];
        ...
        case 1:
          ...
          for (paramInt = 0; paramInt < j; paramInt++)
          {
            ...
            localcks.BaseRequest = paramArrayOfObject;
          }
          AppMethodBeat.o(136946);
          paramInt = i;
          break;
        case 2:
          localcks.ptv = ((e.a.a.a.a)localObject1).BTU.readString();
          AppMethodBeat.o(136946);
          paramInt = i;
          break;
        case 3:
          localcks.ptw = ((e.a.a.a.a)localObject1).BTU.vd();
          AppMethodBeat.o(136946);
          paramInt = i;
          break;
        case 4:
          localcks.ptx = ((e.a.a.a.a)localObject1).BTU.vd();
          AppMethodBeat.o(136946);
          paramInt = i;
          break;
        case 5:
          localcks.pty = ((e.a.a.a.a)localObject1).BTU.vd();
          AppMethodBeat.o(136946);
          paramInt = i;
          break;
        case 6:
          ...
          for (paramInt = 0; paramInt < j; paramInt++)
          {
            ...
            localcks.ptz = ((SKBuiltinBuffer_t)localObject1);
          }
          AppMethodBeat.o(136946);
          paramInt = i;
          break;
        case 7:
          localcks.wcP = ((e.a.a.a.a)localObject1).BTU.readString();
          AppMethodBeat.o(136946);
          paramInt = i;
          break;
        }
