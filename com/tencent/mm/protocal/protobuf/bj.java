...
public final class bj extends bsr
{
  ...
  public final int op(int paramInt, Object[] paramArrayOfObject)
  {
    ...
    if (paramInt == 0)
    {
      ...
      paramArrayOfObject.e(2, 8, this.vDC);
    ...
    {
      paramInt += e.a.a.a.c(2, 8, this.vDC);
      AppMethodBeat.o(94494);
      break;
      if (paramInt == 2)
      {
      ...
      if (paramInt == 3)
      {
        ...
        case 1:
          ...
          for (paramInt = 0; paramInt < j; paramInt++)
          {
            ...
            localbj.BaseRequest = ((hl)localObject1);
          }
          AppMethodBeat.o(94494);
          paramInt = i;
          break;
        case 2:
          ...
          for (paramInt = 0; paramInt < j; paramInt++)
          {
            ...
            paramArrayOfObject = new bp();
            localObject2 = new e.a.a.a.a((byte[])localObject2, unknownTagHandler);
            for (bool = true; bool; bool = paramArrayOfObject.populateBuilderWithField((e.a.a.a.a)localObject2, paramArrayOfObject, bsr.getNextFieldNumber((e.a.a.a.a)localObject2)));
            localbj.vDC.add(paramArrayOfObject);
          }
          AppMethodBeat.o(94494);
          paramInt = i;
          break;
