...
{
  public com.tencent.mm.bt.b weU;
  ...
  public final int op(int paramInt, Object[] paramArrayOfObject)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.weU != null)
        paramArrayOfObject.c(2, this.weU);
      AppMethodBeat.o(28401);
      paramInt = i;
      return paramInt;
    }
    ...
    label447: for (paramInt = e.a.a.a.ix(1, this.BaseResponse.computeSize()) + 0; ; paramInt = 0)
    {
      i = paramInt;
      if (this.weU != null)
        i = paramInt + e.a.a.b.b.a.b(2, this.weU);
      AppMethodBeat.o(28401);
      paramInt = i;
      break;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        zp localzp = (zp)paramArrayOfObject[1];
        ...
        case 1:
          ...
          break;
        case 2:
          localzp.weU = ((e.a.a.a.a)localObject1).BTU.emu();
          AppMethodBeat.o(28401);
          paramInt = i;
          break;
        }
