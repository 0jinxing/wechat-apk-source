...
public final class cj extends bsr
{
  ...
  public final int op(int paramInt, Object[] paramArrayOfObject)
  {
    ...
    if (paramInt == 0)
    {
      ...
      paramArrayOfObject.e(2, 1, this.fLd);
    ...
    if (paramInt == 1)
      if (this.BaseRequest == null)
        break label394;
    label394: for (paramInt = e.a.a.a.ix(1, this.BaseRequest.computeSize()) + 0; ; paramInt = 0)
    {
      paramInt += e.a.a.a.c(2, 1, this.fLd);
      AppMethodBeat.o(28305);
      break;
      if (paramInt == 2)
      {
      ...
      if (paramInt == 3)
      {
        ...
        case 1:
          ...
          for (paramInt = 0; paramInt < j; paramInt++)
          {
            ...
            localcj.BaseRequest = paramArrayOfObject;
          }
          AppMethodBeat.o(28305);
          paramInt = i;
          break;
        case 2:
          localcj.fLd.add(((e.a.a.a.a)localObject1).BTU.readString());
          AppMethodBeat.o(28305);
          paramInt = i;
          break;
        }
