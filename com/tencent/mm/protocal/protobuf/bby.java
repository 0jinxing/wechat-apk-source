...
public final class bby extends bsr
{
  ...
  public final int op(int paramInt, Object[] paramArrayOfObject)
  {
    ...
    label433: for (paramInt = e.a.a.a.ix(1, this.BaseRequest.computeSize()) + 0; ; paramInt = 0)
    {
      ...
      paramInt = i + e.a.a.b.b.a.bs(3, this.OpCode);
      AppMethodBeat.o(62575);
      break;
      if (paramInt == 2)
      {
      ...
      if (paramInt == 3)
      {
        ...
        bby localbby = (bby)paramArrayOfObject[1];
        ...
        case 1:
          ...
          for (paramInt = 0; paramInt < j; paramInt++)
          {
            ...
            localbby.BaseRequest = paramArrayOfObject;
          }
          AppMethodBeat.o(62575);
          paramInt = i;
          break;
        case 2:
          localbby.ProductID = ((e.a.a.a.a)localObject1).BTU.readString();
          AppMethodBeat.o(62575);
          paramInt = i;
          break;
        case 3:
          localbby.OpCode = ((e.a.a.a.a)localObject1).BTU.vd();
          AppMethodBeat.o(62575);
          paramInt = i;
          break;
        }
