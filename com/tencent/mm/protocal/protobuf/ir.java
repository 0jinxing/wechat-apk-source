...
public final class ir extends bsr
{
  ...
  public final int op(int paramInt, Object[] paramArrayOfObject)
  {
    ...
    if (paramInt == 0)
    {
      ...
      paramArrayOfObject.e(2, 8, this.vKN);
    ...
    {
      paramInt += e.a.a.a.c(2, 8, this.vKN);
      AppMethodBeat.o(114952);
      break;
      if (paramInt == 2)
      {
      ...
      if (paramInt == 3)
      {
        ...
        ir localir = (ir)paramArrayOfObject[1];
        ...
        case 1:
          ...
          for (paramInt = 0; paramInt < j; paramInt++)
          {
            ...
            localir.BaseRequest = ((hl)localObject1);
          }
          AppMethodBeat.o(114952);
          paramInt = i;
          break;
        case 2:
          ...
          for (paramInt = 0; paramInt < j; paramInt++)
          {
            ...
            paramArrayOfObject = new cfx();
            localObject2 = new e.a.a.a.a((byte[])localObject2, unknownTagHandler);
            for (bool = true; bool; bool = paramArrayOfObject.populateBuilderWithField((e.a.a.a.a)localObject2, paramArrayOfObject, bsr.getNextFieldNumber((e.a.a.a.a)localObject2)));
            localir.vKN.add(paramArrayOfObject);
          }
          AppMethodBeat.o(114952);
          paramInt = i;
          break;
