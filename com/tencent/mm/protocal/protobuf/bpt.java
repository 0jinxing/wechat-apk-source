...
public final class bpt extends com.tencent.mm.bt.a
{
  public String nZa;
  public String nZb;
  public String nZc;
  ...
  public final int op(int paramInt, Object[] paramArrayOfObject)
  {
    ...
    while (true)
    {
      ...
      else if (paramInt == 3)
      {
        ...
        bpt localbpt = (bpt)paramArrayOfObject[1];
        ...
        default:
          ...
          break;
        case 1:
          localbpt.vAF = locala.BTU.vd();
          AppMethodBeat.o(56950);
          paramInt = 0;
          break;
        case 2:
          localbpt.nZa = locala.BTU.readString();
          AppMethodBeat.o(56950);
          paramInt = 0;
          break;
        case 3:
          localbpt.nZb = locala.BTU.readString();
          AppMethodBeat.o(56950);
          paramInt = 0;
          break;
        case 4:
          localbpt.nZc = locala.BTU.readString();
          AppMethodBeat.o(56950);
          paramInt = 0;
          break;
        case 5:
          localbpt.nZd = locala.BTU.readString();
          AppMethodBeat.o(56950);
          paramInt = 0;
          break;
        }
