...
public final class axx extends com.tencent.mm.bt.a
{
  public float vRp;
  public float vRq;
  public int wfG;
  ...
  public final int op(int paramInt, Object[] paramArrayOfObject)
  {
    ...
    while (true)
    {
      ...
      else if (paramInt == 3)
      {
        ...
        axx localaxx = (axx)paramArrayOfObject[1];
        ...
        default:
          ...
          break;
        case 1:
          localaxx.vRp = Float.intBitsToFloat(locala.BTU.eia());
          AppMethodBeat.o(80113);
          paramInt = 0;
          break;
        case 2:
          localaxx.vRq = Float.intBitsToFloat(locala.BTU.eia());
          AppMethodBeat.o(80113);
          paramInt = 0;
          break;
        case 3:
          localaxx.wfG = locala.BTU.vd();
          AppMethodBeat.o(80113);
          paramInt = 0;
          break;
        case 4:
          localaxx.wfH = locala.BTU.readString();
          AppMethodBeat.o(80113);
          paramInt = 0;
          break;
        case 5:
          localaxx.wfI = locala.BTU.readString();
          AppMethodBeat.o(80113);
          paramInt = 0;
          break;
        case 6:
          localaxx.wfJ = locala.BTU.vd();
          AppMethodBeat.o(80113);
          paramInt = 0;
          break;
        }
