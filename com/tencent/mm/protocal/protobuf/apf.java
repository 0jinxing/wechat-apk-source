...
public final class apf extends btd
{
  ...
  public final int op(int paramInt, Object[] paramArrayOfObject)
  {
    ...
    {
      paramInt += e.a.a.a.c(2, 8, this.wtg);
      AppMethodBeat.o(114975);
      break;
      if (paramInt == 2)
      {
      ...
      if (paramInt == 3)
      {
        ...
        apf localapf = (apf)paramArrayOfObject[1];
        ...
        case 1:
          ...
          for (paramInt = 0; paramInt < j; paramInt++)
          {
            ...
            localapf.BaseResponse = paramArrayOfObject;
          }
          AppMethodBeat.o(114975);
          paramInt = i;
          break;
        case 2:
          ...
          {
            localObject2 = (byte[])((LinkedList)localObject1).get(paramInt);
            paramArrayOfObject = new cjk();
            localObject2 = new e.a.a.a.a((byte[])localObject2, unknownTagHandler);
            for (bool = true; bool; bool = paramArrayOfObject.populateBuilderWithField((e.a.a.a.a)localObject2, paramArrayOfObject, btd.getNextFieldNumber((e.a.a.a.a)localObject2)));
            localapf.wtg.add(paramArrayOfObject);
          }
          AppMethodBeat.o(114975);
          paramInt = i;
          break;
