...
public final class cei extends com.tencent.mm.bt.a
{
  public float bEJ;
  ...
  public final int op(int paramInt, Object[] paramArrayOfObject)
  {
    ...
    while (true)
    {
      ...
      else if (paramInt == 3)
      {
        ...
        cei localcei = (cei)paramArrayOfObject[1];
        ...
        default:
          ...
          break;
        case 1:
          localcei.vRp = Float.intBitsToFloat(locala.BTU.eia());
          AppMethodBeat.o(56524);
          paramInt = 0;
          break;
        case 2:
          localcei.vRq = Float.intBitsToFloat(locala.BTU.eia());
          AppMethodBeat.o(56524);
          paramInt = 0;
          break;
        case 3:
          localcei.guP = locala.BTU.readString();
          AppMethodBeat.o(56524);
          paramInt = 0;
          break;
        case 4:
          localcei.eUu = locala.BTU.readString();
          AppMethodBeat.o(56524);
          paramInt = 0;
          break;
        case 5:
          localcei.rkg = locala.BTU.readString();
          AppMethodBeat.o(56524);
          paramInt = 0;
          break;
        case 6:
          localcei.wCC = locala.BTU.readString();
          AppMethodBeat.o(56524);
          paramInt = 0;
          break;
        case 7:
          localcei.rki = locala.BTU.vd();
          AppMethodBeat.o(56524);
          paramInt = 0;
          break;
        case 8:
          localcei.wCD = locala.BTU.readString();
          AppMethodBeat.o(56524);
          paramInt = 0;
          break;
        case 9:
          localcei.wCE = locala.BTU.vd();
          AppMethodBeat.o(56524);
          paramInt = 0;
          break;
        case 10:
          localcei.wCF = locala.BTU.vd();
          AppMethodBeat.o(56524);
          paramInt = 0;
          break;
        case 11:
          localcei.rkk = locala.BTU.vd();
          AppMethodBeat.o(56524);
          paramInt = 0;
          break;
        case 12:
          localcei.bEJ = Float.intBitsToFloat(locala.BTU.eia());
          AppMethodBeat.o(56524);
          paramInt = 0;
          break;
        case 13:
          localcei.wCG = locala.BTU.emu();
          AppMethodBeat.o(56524);
          paramInt = 0;
          break;
        case 14:
          localcei.score = locala.BTU.vd();
          AppMethodBeat.o(56524);
          paramInt = 0;
          break;
        case 15:
          localcei.wCH = locala.BTU.readString();
          AppMethodBeat.o(56524);
          paramInt = 0;
          break;
        case 16:
          localcei.country = locala.BTU.readString();
          AppMethodBeat.o(56524);
          paramInt = 0;
          break;
        }
