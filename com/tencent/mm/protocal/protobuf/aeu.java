...
public final class aeu extends btd
{
  ...
  public final int op(int paramInt, Object[] paramArrayOfObject)
  {
    ...
    label591: for (paramInt = e.a.a.a.ix(1, this.BaseResponse.computeSize()) + 0; ; paramInt = 0)
    {
      i = paramInt;
      if (this.vIn != null)
        i = paramInt + e.a.a.a.ix(2, this.vIn.computeSize());
      AppMethodBeat.o(28418);
      paramInt = i;
      break;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        aeu localaeu = (aeu)paramArrayOfObject[1];
        ...
        case 1:
          ...
          for (paramInt = 0; paramInt < j; paramInt++)
          {
            ...
            localaeu.BaseResponse = paramArrayOfObject;
          }
          AppMethodBeat.o(28418);
          paramInt = i;
          break;
        case 2:
          ...
          for (paramInt = 0; paramInt < j; paramInt++)
          {
            ...
            localaeu.vIn = ((SKBuiltinBuffer_t)localObject1);
          }
          AppMethodBeat.o(28418);
          paramInt = i;
          break;
