...
public final class lr extends btd
{
  ...
  public final int op(int paramInt, Object[] paramArrayOfObject)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.pOE != null)
      {
        paramArrayOfObject.iy(4, this.pOE.computeSize());
        this.pOE.writeFields(paramArrayOfObject);
      }
      AppMethodBeat.o(56721);
      paramInt = i;
      return paramInt;
    ...
    label641: for (paramInt = e.a.a.a.ix(1, this.BaseResponse.computeSize()) + 0; ; paramInt = 0)
    {
      ...
      i = paramInt;
      if (this.pOE != null)
        i = paramInt + e.a.a.a.ix(4, this.pOE.computeSize());
      AppMethodBeat.o(56721);
      paramInt = i;
      break;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        lr locallr = (lr)paramArrayOfObject[1];
        ...
        case 1:
          ...
          break;
        case 2:
          locallr.kdT = ((e.a.a.a.a)localObject1).BTU.vd();
          AppMethodBeat.o(56721);
          paramInt = i;
          break;
        case 3:
          locallr.kdU = ((e.a.a.a.a)localObject1).BTU.readString();
          AppMethodBeat.o(56721);
          paramInt = i;
          break;
        case 4:
          ...
          for (paramInt = 0; paramInt < j; paramInt++)
          {
            ...
            paramArrayOfObject = new lp();
            localObject2 = new e.a.a.a.a((byte[])localObject2, unknownTagHandler);
            for (bool = true; bool; bool = paramArrayOfObject.populateBuilderWithField((e.a.a.a.a)localObject2, paramArrayOfObject, btd.getNextFieldNumber((e.a.a.a.a)localObject2)));
            locallr.pOE = paramArrayOfObject;
          }
          AppMethodBeat.o(56721);
          paramInt = i;
          break;
