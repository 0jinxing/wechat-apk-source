...
{
  public LinkedList<gk> xsC;

  public cxb()
  {
    AppMethodBeat.i(115005);
    this.xsC = new LinkedList();
  ...
  public final int op(int paramInt, Object[] paramArrayOfObject)
  {
    ...
    if (paramInt == 0)
    {
      ...
      paramArrayOfObject.e(2, 8, this.xsC);
    ...
    {
      paramInt += e.a.a.a.c(2, 8, this.xsC);
      AppMethodBeat.o(115006);
      break;
      if (paramInt == 2)
      {
      ...
      if (paramInt == 3)
      {
        ...
        cxb localcxb = (cxb)paramArrayOfObject[1];
        ...
        case 1:
          ...
          for (paramInt = 0; paramInt < j; paramInt++)
          {
            ...
            localcxb.BaseRequest = paramArrayOfObject;
          }
          AppMethodBeat.o(115006);
          paramInt = i;
          break;
        case 2:
          ...
          for (paramInt = 0; paramInt < j; paramInt++)
          {
            ...
            localObject2 = new e.a.a.a.a((byte[])localObject2, unknownTagHandler);
            for (bool = true; bool; bool = paramArrayOfObject.populateBuilderWithField((e.a.a.a.a)localObject2, paramArrayOfObject, bsr.getNextFieldNumber((e.a.a.a.a)localObject2)));
            localcxb.xsC.add(paramArrayOfObject);
          }
          AppMethodBeat.o(115006);
          paramInt = i;
          break;
