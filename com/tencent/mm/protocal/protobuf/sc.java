...
public final class sc extends btd
{
  ...
  public final int op(int paramInt, Object[] paramArrayOfObject)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.vZv != null)
      {
        paramArrayOfObject.iy(7, this.vZv.computeSize());
    ...
    if (paramInt == 1)
      if (this.BaseResponse == null)
        break label930;
    label930: for (paramInt = e.a.a.a.ix(1, this.BaseResponse.computeSize()) + 0; ; paramInt = 0)
    {
      ...
      i = paramInt;
      if (this.vZv != null)
        i = paramInt + e.a.a.a.ix(7, this.vZv.computeSize());
      AppMethodBeat.o(56763);
      paramInt = i;
      break;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        sc localsc = (sc)paramArrayOfObject[1];
        ...
        case 1:
          ...
          break;
        case 2:
          localsc.luT = ((e.a.a.a.a)localObject1).BTU.vd();
          AppMethodBeat.o(56763);
          paramInt = i;
          break;
        case 3:
          localsc.luU = ((e.a.a.a.a)localObject1).BTU.readString();
          AppMethodBeat.o(56763);
          paramInt = i;
          break;
        case 4:
          localsc.token = ((e.a.a.a.a)localObject1).BTU.readString();
          AppMethodBeat.o(56763);
          paramInt = i;
          break;
        case 5:
          ...
          for (paramInt = 0; paramInt < j; paramInt++)
          {
            ...
            localsc.vYW = paramArrayOfObject;
          }
          AppMethodBeat.o(56763);
          paramInt = i;
          break;
        case 6:
          localsc.vwr = ((e.a.a.a.a)localObject1).BTU.readString();
          AppMethodBeat.o(56763);
          paramInt = i;
          break;
        case 7:
          ...
          {
            localObject2 = (byte[])((LinkedList)localObject1).get(paramInt);
            paramArrayOfObject = new chz();
            localObject2 = new e.a.a.a.a((byte[])localObject2, unknownTagHandler);
            for (bool = true; bool; bool = paramArrayOfObject.populateBuilderWithField((e.a.a.a.a)localObject2, paramArrayOfObject, btd.getNextFieldNumber((e.a.a.a.a)localObject2)));
            localsc.vZv = paramArrayOfObject;
          }
          AppMethodBeat.o(56763);
          paramInt = i;
          break;
