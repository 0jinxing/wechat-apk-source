...
public final class afm extends btd
{
  ...
  public final int op(int paramInt, Object[] paramArrayOfObject)
  {
    ...
    if (paramInt == 0)
    {
      ...
      paramArrayOfObject.e(3, 8, this.wmT);
      AppMethodBeat.o(11754);
      paramInt = i;
      return paramInt;
    }
    if (paramInt == 1)
      if (this.BaseResponse == null)
        break label737;
    label737: for (paramInt = e.a.a.a.ix(1, this.BaseResponse.computeSize()) + 0; ; paramInt = 0)
    {
      i = paramInt;
      if (this.vNh != null)
        i = paramInt + e.a.a.a.ix(2, this.vNh.computeSize());
      paramInt = i + e.a.a.a.c(3, 8, this.wmT);
      AppMethodBeat.o(11754);
      break;
      if (paramInt == 2)
      {
      ...
      if (paramInt == 3)
      {
        ...
        afm localafm = (afm)paramArrayOfObject[1];
