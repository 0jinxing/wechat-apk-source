...
public final class cav extends btd
{
  ...
  public final int op(int paramInt, Object[] paramArrayOfObject)
  {
    ...
    label579: for (paramInt = e.a.a.a.ix(1, this.BaseResponse.computeSize()) + 0; ; paramInt = 0)
    {
      i = paramInt;
      if (this.wZu != null)
        i = paramInt + e.a.a.a.ix(2, this.wZu.computeSize());
      AppMethodBeat.o(94572);
      paramInt = i;
      break;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        cav localcav = (cav)paramArrayOfObject[1];
        ...
        case 1:
          ...
          for (paramInt = 0; paramInt < j; paramInt++)
          {
            ...
            localcav.BaseResponse = paramArrayOfObject;
          }
          AppMethodBeat.o(94572);
          paramInt = i;
          break;
