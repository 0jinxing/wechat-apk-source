...
public final class byg extends btd
{
  ...
  public final int op(int paramInt, Object[] paramArrayOfObject)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.vHH != null)
      {
        paramArrayOfObject.iy(2, this.vHH.computeSize());
    ...
    label532: for (i = e.a.a.a.ix(1, this.BaseResponse.computeSize()) + 0; ; i = 0)
    {
      paramInt = i;
      if (this.vHH != null)
        paramInt = i + e.a.a.a.ix(2, this.vHH.computeSize());
      AppMethodBeat.o(123520);
      break;
      if (paramInt == 2)
      {
      ...
      if (paramInt == 3)
      {
        ...
        byg localbyg = (byg)paramArrayOfObject[1];
        ...
        case 2:
          ...
          for (paramInt = 0; paramInt < j; paramInt++)
          {
            ...
            localbyg.vHH = ((SKBuiltinBuffer_t)localObject1);
          }
          AppMethodBeat.o(123520);
          paramInt = i;
          break;
