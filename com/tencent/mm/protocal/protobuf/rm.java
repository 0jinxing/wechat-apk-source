...
public final class rm extends btd
{
  ...
  public final int op(int paramInt, Object[] paramArrayOfObject)
  {
    ...
    label482: for (paramInt = e.a.a.a.ix(1, this.BaseResponse.computeSize()) + 0; ; paramInt = 0)
    {
      i = paramInt;
      if (this.fJU != null)
        i = paramInt + e.a.a.b.b.a.f(2, this.fJU);
      ...
      if (paramInt == 3)
      {
        ...
        rm localrm = (rm)paramArrayOfObject[1];
        ...
        case 1:
          ...
          break;
        case 2:
          localrm.fJU = ((e.a.a.a.a)localObject1).BTU.readString();
          AppMethodBeat.o(105145);
          paramInt = i;
          break;
        case 3:
          localrm.Scene = ((e.a.a.a.a)localObject1).BTU.vd();
          AppMethodBeat.o(105145);
          paramInt = i;
          break;
        }
