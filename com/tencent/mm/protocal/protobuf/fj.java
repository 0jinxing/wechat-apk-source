...
public final class fj extends com.tencent.mm.bt.a
{
  public int vHo;
  public int vHp;
  public int vHq;
  ...
  public final int op(int paramInt, Object[] paramArrayOfObject)
  {
    ...
    while (true)
    {
      ...
      else if (paramInt == 3)
      {
        ...
        fj localfj = (fj)paramArrayOfObject[1];
        ...
        default:
          ...
          break;
        case 1:
          localfj.vHo = locala.BTU.vd();
          AppMethodBeat.o(28322);
          paramInt = 0;
          break;
        case 2:
          localfj.vHp = locala.BTU.vd();
          AppMethodBeat.o(28322);
          paramInt = 0;
          break;
        case 3:
          localfj.vHq = locala.BTU.vd();
          AppMethodBeat.o(28322);
          paramInt = 0;
          break;
        case 4:
          localfj.vHr = locala.BTU.vd();
          AppMethodBeat.o(28322);
          paramInt = 0;
          break;
        }
