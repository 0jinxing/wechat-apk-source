...
public final class lw extends bsr
{
  ...
  public final int op(int paramInt, Object[] paramArrayOfObject)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.vPC != null)
        paramArrayOfObject.e(3, this.vPC);
    ...
    label546: for (i = e.a.a.a.ix(1, this.BaseRequest.computeSize()) + 0; ; i = 0)
    {
      ...
      i = paramInt;
      if (this.vPC != null)
        i = paramInt + e.a.a.b.b.a.f(3, this.vPC);
      AppMethodBeat.o(56726);
      paramInt = i;
      break;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        lw locallw = (lw)paramArrayOfObject[1];
        ...
        case 1:
          ...
          for (paramInt = 0; paramInt < j; paramInt++)
          {
            ...
            locallw.BaseRequest = ((hl)localObject1);
          }
          AppMethodBeat.o(56726);
          paramInt = i;
          break;
        case 2:
          ...
          for (paramInt = 0; paramInt < j; paramInt++)
          {
            ...
            locallw.vPn = paramArrayOfObject;
          }
          AppMethodBeat.o(56726);
          paramInt = i;
          break;
        case 3:
          locallw.vPC = ((e.a.a.a.a)localObject1).BTU.readString();
          AppMethodBeat.o(56726);
          paramInt = i;
          break;
        }
