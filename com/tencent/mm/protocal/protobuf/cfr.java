...
public final class cfr extends bsr
{
  ...
  public final int op(int paramInt, Object[] paramArrayOfObject)
  {
    ...
    if (paramInt == 0)
    {
      ...
      paramArrayOfObject.aO(3, this.xeS);
      AppMethodBeat.o(14753);
      paramInt = i;
      return paramInt;
    }
    ...
    label491: for (paramInt = e.a.a.a.ix(1, this.BaseRequest.computeSize()) + 0; ; paramInt = 0)
    {
      ...
      if (paramInt == 3)
      {
        ...
        cfr localcfr = (cfr)paramArrayOfObject[1];
        ...
        case 1:
          ...
          for (paramInt = 0; paramInt < j; paramInt++)
          {
            ...
            localcfr.BaseRequest = ((hl)localObject1);
          }
          AppMethodBeat.o(14753);
          paramInt = i;
          break;
        case 2:
          localcfr.vNb = ((e.a.a.a.a)localObject1).BTU.readString();
          AppMethodBeat.o(14753);
          paramInt = i;
          break;
        case 3:
          localcfr.xeS = ((e.a.a.a.a)localObject1).BTU.ehX();
          AppMethodBeat.o(14753);
          paramInt = i;
          break;
        }
