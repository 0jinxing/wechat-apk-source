...
public final class bnu extends btd
{
  ...
  public final int op(int paramInt, Object[] paramArrayOfObject)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.wQV != null)
      {
        paramArrayOfObject.iy(4, this.wQV.computeSize());
    ...
    label593: for (paramInt = e.a.a.a.ix(1, this.BaseResponse.computeSize()) + 0; ; paramInt = 0)
    {
      ...
      i = paramInt;
      if (this.wQV != null)
        i = paramInt + e.a.a.a.ix(4, this.wQV.computeSize());
      AppMethodBeat.o(56944);
      paramInt = i;
      break;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        bnu localbnu = (bnu)paramArrayOfObject[1];
        ...
        case 1:
          ...
          break;
        case 2:
          localbnu.kdT = ((e.a.a.a.a)localObject1).BTU.vd();
          AppMethodBeat.o(56944);
          paramInt = i;
          break;
        case 3:
          localbnu.kdU = ((e.a.a.a.a)localObject1).BTU.readString();
          AppMethodBeat.o(56944);
          paramInt = i;
          break;
        case 4:
          ...
          for (paramInt = 0; paramInt < j; paramInt++)
          {
            ...
            paramArrayOfObject = new bc();
            localObject2 = new e.a.a.a.a((byte[])localObject2, unknownTagHandler);
            for (bool = true; bool; bool = paramArrayOfObject.populateBuilderWithField((e.a.a.a.a)localObject2, paramArrayOfObject, btd.getNextFieldNumber((e.a.a.a.a)localObject2)));
            localbnu.wQV = paramArrayOfObject;
          }
          AppMethodBeat.o(56944);
          paramInt = i;
          break;
