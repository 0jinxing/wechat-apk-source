...
public final class aai extends btd
{
  ...
  public final int op(int paramInt, Object[] paramArrayOfObject)
  {
    ...
    if (paramInt == 0)
    {
      ...
      paramArrayOfObject.aO(3, this.wfD);
      AppMethodBeat.o(842);
      paramInt = i;
      return paramInt;
    }
    if (paramInt == 1)
      if (this.BaseResponse == null)
        break label491;
    label491: for (paramInt = e.a.a.a.ix(1, this.BaseResponse.computeSize()) + 0; ; paramInt = 0)
    {
      i = paramInt;
      if (this.wfC != null)
      ...
      if (paramInt == 3)
      {
        ...
        aai localaai = (aai)paramArrayOfObject[1];
        ...
        case 1:
          ...
          break;
        case 2:
          localaai.wfC = ((e.a.a.a.a)localObject1).BTU.readString();
          AppMethodBeat.o(842);
          paramInt = i;
          break;
        case 3:
          localaai.wfD = ((e.a.a.a.a)localObject1).BTU.ehX();
          AppMethodBeat.o(842);
          paramInt = i;
          break;
        }
