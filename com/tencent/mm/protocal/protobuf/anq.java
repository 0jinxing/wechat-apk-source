...
{
  public LinkedList<bre> wsp;

  public anq()
  {
    AppMethodBeat.i(118273);
    this.wsp = new LinkedList();
  ...
  public final int op(int paramInt, Object[] paramArrayOfObject)
  {
    ...
    if (paramInt == 0)
    {
      ...
      paramArrayOfObject.e(2, 8, this.wsp);
      AppMethodBeat.o(118274);
      paramInt = i;
      return paramInt;
    }
    ...
    {
      paramInt += e.a.a.a.c(2, 8, this.wsp);
      AppMethodBeat.o(118274);
      break;
      if (paramInt == 2)
      {
      ...
      if (paramInt == 3)
      {
        ...
        anq localanq = (anq)paramArrayOfObject[1];
        ...
        case 2:
          ...
          for (paramInt = 0; paramInt < j; paramInt++)
          {
            ...
            paramArrayOfObject = new bre();
            localObject2 = new e.a.a.a.a((byte[])localObject2, unknownTagHandler);
            for (bool = true; bool; bool = paramArrayOfObject.populateBuilderWithField((e.a.a.a.a)localObject2, paramArrayOfObject, btd.getNextFieldNumber((e.a.a.a.a)localObject2)));
            localanq.wsp.add(paramArrayOfObject);
          }
          AppMethodBeat.o(118274);
          paramInt = i;
          break;
