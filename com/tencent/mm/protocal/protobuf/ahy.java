...
public final class ahy extends btd
{
  ...
  public final int op(int paramInt, Object[] paramArrayOfObject)
  {
    ...
    label574: for (i = e.a.a.a.ix(1, this.BaseResponse.computeSize()) + 0; ; i = 0)
    {
      paramInt = i;
      if (this.guW != null)
        paramInt = i + e.a.a.b.b.a.f(2, this.guW);
      i = paramInt;
      if (this.guO != null)
      ...
      if (paramInt == 3)
      {
        ...
        ahy localahy = (ahy)paramArrayOfObject[1];
        ...
        case 1:
          ...
          for (paramInt = 0; paramInt < j; paramInt++)
          {
            ...
            localahy.BaseResponse = paramArrayOfObject;
          }
          AppMethodBeat.o(28433);
          paramInt = i;
          break;
        case 2:
          localahy.guW = ((e.a.a.a.a)localObject1).BTU.readString();
          AppMethodBeat.o(28433);
          paramInt = i;
          break;
        case 3:
          localahy.guO = ((e.a.a.a.a)localObject1).BTU.readString();
          AppMethodBeat.o(28433);
          paramInt = i;
          break;
        case 4:
          localahy.guP = ((e.a.a.a.a)localObject1).BTU.readString();
          AppMethodBeat.o(28433);
          paramInt = i;
          break;
        }
