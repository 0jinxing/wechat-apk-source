...
{
  public LinkedList<aji> wpe;

  public ajh()
  {
    AppMethodBeat.i(96225);
    this.wpe = new LinkedList();
  ...
  public final int op(int paramInt, Object[] paramArrayOfObject)
  {
    ...
    if (paramInt == 0)
    {
      ...
      paramArrayOfObject.e(2, 8, this.wpe);
      AppMethodBeat.o(96226);
      paramInt = i;
      return paramInt;
    }
    ...
    {
      paramInt += e.a.a.a.c(2, 8, this.wpe);
      AppMethodBeat.o(96226);
      break;
      if (paramInt == 2)
      {
      ...
      if (paramInt == 3)
      {
        ...
        ajh localajh = (ajh)paramArrayOfObject[1];
        ...
        case 2:
          ...
          for (paramInt = 0; paramInt < j; paramInt++)
          {
            ...
            paramArrayOfObject = new aji();
            localObject2 = new e.a.a.a.a((byte[])localObject2, unknownTagHandler);
            for (bool = true; bool; bool = paramArrayOfObject.populateBuilderWithField((e.a.a.a.a)localObject2, paramArrayOfObject, btd.getNextFieldNumber((e.a.a.a.a)localObject2)));
            localajh.wpe.add(paramArrayOfObject);
          }
          AppMethodBeat.o(96226);
          paramInt = i;
          break;
