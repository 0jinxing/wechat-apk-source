...
public final class vx extends btd
{
  ...
  public final int op(int paramInt, Object[] paramArrayOfObject)
  {
    ...
    if (paramInt == 1)
      if (this.BaseResponse == null)
        break label471;
    label471: for (paramInt = e.a.a.a.ix(1, this.BaseResponse.computeSize()) + 0; ; paramInt = 0)
    {
      ...
      if (paramInt == 3)
      {
        ...
        vx localvx = (vx)paramArrayOfObject[1];
        ...
        case 1:
          ...
          for (paramInt = 0; paramInt < j; paramInt++)
          {
            ...
            localvx.BaseResponse = paramArrayOfObject;
          }
          AppMethodBeat.o(80046);
          paramInt = i;
          break;
