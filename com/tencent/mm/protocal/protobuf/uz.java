...
public final class uz extends com.tencent.mm.bt.a
{
  public int gvb;
  public String gvc;
  public String gvd;
  ...
  public final int op(int paramInt, Object[] paramArrayOfObject)
  {
    ...
    while (true)
    {
      ...
      else if (paramInt == 3)
      {
        ...
        uz localuz = (uz)paramArrayOfObject[1];
        ...
        default:
          ...
          break;
        case 1:
          localuz.gvb = locala.BTU.vd();
          AppMethodBeat.o(124312);
          paramInt = 0;
          break;
        case 2:
          localuz.gvc = locala.BTU.readString();
          AppMethodBeat.o(124312);
          paramInt = 0;
          break;
        case 3:
          localuz.gvd = locala.BTU.readString();
          AppMethodBeat.o(124312);
          paramInt = 0;
          break;
        case 4:
          localuz.gve = locala.BTU.readString();
          AppMethodBeat.o(124312);
          paramInt = 0;
          break;
        }
