...
public final class atl extends bsr
{
  ...
  public final int op(int paramInt, Object[] paramArrayOfObject)
  {
    ...
    if (paramInt == 1)
      if (this.BaseRequest == null)
        break label622;
    label622: for (paramInt = e.a.a.a.ix(1, this.BaseRequest.computeSize()) + 0; ; paramInt = 0)
    {
      ...
      if (paramInt == 3)
      {
        ...
        atl localatl = (atl)paramArrayOfObject[1];
        ...
        case 1:
          ...
          for (paramInt = 0; paramInt < j; paramInt++)
          {
            ...
            localatl.BaseRequest = ((hl)localObject1);
          }
          AppMethodBeat.o(70475);
          paramInt = i;
          break;
        case 2:
          localatl.wxx = ((e.a.a.a.a)localObject1).BTU.vd();
          AppMethodBeat.o(70475);
          paramInt = i;
          break;
        case 3:
          localatl.wxy = ((e.a.a.a.a)localObject1).BTU.vd();
          AppMethodBeat.o(70475);
          paramInt = i;
          break;
        case 4:
          ...
          for (paramInt = 0; paramInt < j; paramInt++)
          {
            ...
            localatl.wxz = ((SKBuiltinBuffer_t)localObject1);
          }
          AppMethodBeat.o(70475);
          paramInt = i;
          break;
