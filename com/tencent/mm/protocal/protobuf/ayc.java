...
public final class ayc extends bsr
{
  ...
  public final int op(int paramInt, Object[] paramArrayOfObject)
  {
    ...
    label391: for (paramInt = e.a.a.a.ix(1, this.BaseRequest.computeSize()) + 0; ; paramInt = 0)
    {
      i = paramInt;
      if (this.fLc != null)
        i = paramInt + e.a.a.b.b.a.f(2, this.fLc);
      AppMethodBeat.o(118276);
      paramInt = i;
      break;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        ayc localayc = (ayc)paramArrayOfObject[1];
        ...
        case 1:
          ...
          for (paramInt = 0; paramInt < j; paramInt++)
          {
            ...
            localayc.BaseRequest = ((hl)localObject1);
          }
          AppMethodBeat.o(118276);
          paramInt = i;
          break;
        case 2:
          localayc.fLc = ((e.a.a.a.a)localObject1).BTU.readString();
          AppMethodBeat.o(118276);
          paramInt = i;
          break;
        }
