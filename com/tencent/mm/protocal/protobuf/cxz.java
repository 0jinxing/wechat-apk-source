...
public final class cxz extends bsr
{
  ...
  public final int op(int paramInt, Object[] paramArrayOfObject)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.xtu != null)
        paramArrayOfObject.e(2, this.xtu);
    ...
    label391: for (paramInt = e.a.a.a.ix(1, this.BaseRequest.computeSize()) + 0; ; paramInt = 0)
    {
      i = paramInt;
      if (this.xtu != null)
        i = paramInt + e.a.a.b.b.a.f(2, this.xtu);
      AppMethodBeat.o(115026);
      paramInt = i;
      break;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        cxz localcxz = (cxz)paramArrayOfObject[1];
        ...
        case 1:
          ...
          for (paramInt = 0; paramInt < j; paramInt++)
          {
            ...
            localcxz.BaseRequest = ((hl)localObject1);
          }
          AppMethodBeat.o(115026);
          paramInt = i;
          break;
        case 2:
          localcxz.xtu = ((e.a.a.a.a)localObject1).BTU.readString();
          AppMethodBeat.o(115026);
          paramInt = i;
          break;
        }
