...
public final class ccf extends btd
{
  ...
  public final int op(int paramInt, Object[] paramArrayOfObject)
  {
    ...
    label579: for (paramInt = e.a.a.a.ix(1, this.BaseResponse.computeSize()) + 0; ; paramInt = 0)
    {
      i = paramInt;
      if (this.xbv != null)
        i = paramInt + e.a.a.a.ix(2, this.xbv.computeSize());
      AppMethodBeat.o(94615);
      paramInt = i;
      break;
      if (paramInt == 2)
      ...
      if (paramInt == 3)
      {
        ...
        ccf localccf = (ccf)paramArrayOfObject[1];
        ...
        case 1:
          ...
          for (paramInt = 0; paramInt < j; paramInt++)
          {
            ...
            localccf.BaseResponse = ((BaseResponse)localObject1);
          }
          AppMethodBeat.o(94615);
          paramInt = i;
          break;
        case 2:
          ...
          for (paramInt = 0; paramInt < j; paramInt++)
          {
            ...
            localccf.xbv = paramArrayOfObject;
          }
          AppMethodBeat.o(94615);
          paramInt = i;
          break;
