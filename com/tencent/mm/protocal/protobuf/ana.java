...
public final class ana extends bsr
{
  ...
  public final int op(int paramInt, Object[] paramArrayOfObject)
  {
    ...
    if (paramInt == 0)
    {
      ...
      paramArrayOfObject.iz(3, this.wrF);
    ...
    label621: for (paramInt = e.a.a.a.ix(1, this.BaseRequest.computeSize()) + 0; ; paramInt = 0)
    {
      ...
      paramInt = i + e.a.a.b.b.a.bs(3, this.wrF) + e.a.a.b.b.a.bs(4, this.OpCode);
      AppMethodBeat.o(80095);
      break;
      if (paramInt == 2)
      {
      ...
      if (paramInt == 3)
      {
        ...
        ana localana = (ana)paramArrayOfObject[1];
        ...
        case 1:
          ...
          for (paramInt = 0; paramInt < j; paramInt++)
          {
            ...
            localana.BaseRequest = ((hl)localObject1);
          }
          AppMethodBeat.o(80095);
          paramInt = i;
          break;
        case 2:
          ...
          for (paramInt = 0; paramInt < j; paramInt++)
          {
            ...
            localana.wcB = paramArrayOfObject;
          }
          AppMethodBeat.o(80095);
          paramInt = i;
          break;
        case 3:
          localana.wrF = ((e.a.a.a.a)localObject1).BTU.vd();
          AppMethodBeat.o(80095);
          paramInt = i;
          break;
        case 4:
          localana.OpCode = ((e.a.a.a.a)localObject1).BTU.vd();
          AppMethodBeat.o(80095);
          paramInt = i;
          break;
        }
