...
public final class d extends bsr
{
  ...
  public final int op(int paramInt, Object[] paramArrayOfObject)
  {
    ...
    if (paramInt == 1)
      if (this.BaseRequest == null)
        break label496;
    label496: for (paramInt = e.a.a.a.ix(1, this.BaseRequest.computeSize()) + 0; ; paramInt = 0)
    {
      i = paramInt;
      if (this.vzL != null)
      ...
      if (paramInt == 3)
      {
        ...
        case 1:
          ...
          for (paramInt = 0; paramInt < j; paramInt++)
          {
            ...
            locald.BaseRequest = paramArrayOfObject;
          }
          AppMethodBeat.o(56670);
          paramInt = i;
          break;
        case 2:
          locald.vzL = ((e.a.a.a.a)localObject1).BTU.readString();
          AppMethodBeat.o(56670);
          paramInt = i;
          break;
        case 3:
          locald.scene = ((e.a.a.a.a)localObject1).BTU.vd();
          AppMethodBeat.o(56670);
          paramInt = i;
          break;
        case 4:
          locald.vzM = ((e.a.a.a.a)localObject1).BTU.readString();
          AppMethodBeat.o(56670);
          paramInt = i;
          break;
        }
