...
public final class gb extends com.tencent.mm.bt.a
{
  public String name;
  public String url;
  ...
  public final int op(int paramInt, Object[] paramArrayOfObject)
  {
    ...
    label294: for (paramInt = e.a.a.b.b.a.f(1, this.name) + 0; ; paramInt = 0)
    {
      ...
      if (paramInt == 3)
      {
        ...
        gb localgb = (gb)paramArrayOfObject[1];
        ...
        default:
          ...
          break;
        case 1:
          localgb.name = locala.BTU.readString();
          AppMethodBeat.o(96198);
          paramInt = i;
          break;
        case 2:
          localgb.url = locala.BTU.readString();
          AppMethodBeat.o(96198);
          paramInt = i;
          break;
        }
