...
public final class aon extends btd
{
  ...
  public final int op(int paramInt, Object[] paramArrayOfObject)
  {
    ...
    if (paramInt == 0)
    {
      ...
      paramArrayOfObject.e(2, 8, this.wsF);
      AppMethodBeat.o(55722);
      paramInt = i;
      return paramInt;
    }
    ...
    {
      paramInt += e.a.a.a.c(2, 8, this.wsF);
      AppMethodBeat.o(55722);
      break;
      if (paramInt == 2)
      {
      ...
      if (paramInt == 3)
      {
        ...
        aon localaon = (aon)paramArrayOfObject[1];
        ...
        case 1:
          ...
          for (paramInt = 0; paramInt < j; paramInt++)
          {
            ...
            localaon.BaseResponse = paramArrayOfObject;
          }
          AppMethodBeat.o(55722);
          paramInt = i;
          break;
