...
public final class bos extends com.tencent.mm.bt.a
{
  public String cyF;
  public int ret;
  ...
  public final int op(int paramInt, Object[] paramArrayOfObject)
  {
    ...
    while (true)
    {
      ...
      if (paramInt == 1)
      {
        int i = e.a.a.b.b.a.bs(1, this.ret) + 0;
        paramInt = i;
        if (this.cyF != null)
      ...
      else if (paramInt == 3)
      {
        ...
        bos localbos = (bos)paramArrayOfObject[1];
        ...
        default:
          ...
          break;
        case 1:
          localbos.ret = locala.BTU.vd();
          AppMethodBeat.o(11798);
          paramInt = 0;
          break;
        case 2:
          localbos.cyF = locala.BTU.readString();
          AppMethodBeat.o(11798);
          paramInt = 0;
          break;
        }
