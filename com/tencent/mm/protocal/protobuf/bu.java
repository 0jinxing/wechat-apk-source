...
public final class bu extends bsr
{
  ...
  public final int op(int paramInt, Object[] paramArrayOfObject)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (this.vEb != null)
        paramArrayOfObject.e(2, this.vEb);
      if (this.csB != null)
    ...
    label463: for (i = e.a.a.a.ix(1, this.BaseRequest.computeSize()) + 0; ; i = 0)
    {
      paramInt = i;
      if (this.vEb != null)
        paramInt = i + e.a.a.b.b.a.f(2, this.vEb);
      i = paramInt;
      if (this.csB != null)
      ...
      if (paramInt == 3)
      {
        ...
        case 1:
          ...
          for (paramInt = 0; paramInt < j; paramInt++)
          {
            ...
            localbu.BaseRequest = ((hl)localObject1);
          }
          AppMethodBeat.o(10149);
          paramInt = i;
          break;
        case 2:
          localbu.vEb = ((e.a.a.a.a)localObject1).BTU.readString();
          AppMethodBeat.o(10149);
          paramInt = i;
          break;
        case 3:
          localbu.csB = ((e.a.a.a.a)localObject1).BTU.readString();
          AppMethodBeat.o(10149);
          paramInt = i;
          break;
        }
