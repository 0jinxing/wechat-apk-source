...
public abstract interface n
{
  ...
  public abstract boolean b(Context paramContext, String paramString, Object[] paramArrayOfObject);

  public abstract void bf(Context paramContext);

  public abstract c bg(Context paramContext);

  public abstract Intent bh(Context paramContext);

  public abstract void bi(Context paramContext);

  public abstract void bj(Context paramContext);
