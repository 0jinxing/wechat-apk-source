...
public abstract class MMWizardActivity extends MMActivity
{
  ...
  public static void b(Context paramContext, Intent paramIntent1, Intent paramIntent2)
  {
    try
    {
      ...
      ((StringBuilder)localObject).<init>("trans.");
      localObject = bo.yz() + "." + paramIntent2.hashCode();
      ynD.put(localObject, paramIntent2);
      paramIntent1.putExtra("WizardTransactionId", (String)localObject);
      paramIntent2 = ((Activity)paramContext).getIntent();
      if (paramIntent2 != null)
        paramIntent2.putExtra("WizardTransactionId", (String)localObject);
  ...
  protected final void cancel()
  {
    ...
    Intent localIntent = (Intent)ynD.get(str);
    ynD.remove(str);
    if (localIntent != null)
