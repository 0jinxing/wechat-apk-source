  ...
  implements ai.a
{
  public final void b(c.a parama, int paramInt, com.tencent.mm.ui.chatting.d.a parama1, bi parambi)
  {
    ...
    if ((parama1.yTx instanceof AppBrandServiceChattingUI.AppBrandServiceChattingFmUI))
    {
      ...
      parambi = ((j)g.K(j.class)).a(parambi.field_content, localBundle, new WeakReference(parama1.yTx.getContext()), new WeakReference(parama.zgE));
      if ((parambi != null) && (parambi.length() != 0))
        break label326;
      parama.mRR.setVisibility(8);
      label162: parambi = r.aiy().sU(str);
      aw.ZK();
    ...
    while (true)
    {
      parama.zgE.setOnClickListener(new at.1(this));
      ...
      paramInt = 1;
      break;
      label326: parama.mRR.setVisibility(0);
      parama.zgE.ah(parambi);
      break label162;
      label346: parama.zgE.setTextColor(parama1.yTx.getContext().getResources().getColor(2131690556));
