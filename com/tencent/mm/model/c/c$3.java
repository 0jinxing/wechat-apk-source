  ...
  implements k.a
{
  ...
  public final void a(String paramString, m paramm)
  {
    ...
    {
      paramString = c.abi().ll("100205");
      if (paramString.isValid())
      {
        paramString = paramString.dru();
        ...
        ah.getContext().getSharedPreferences("system_config_prefs", h.Mu()).edit().putInt("main_thread_watch_enable", i).putInt("main_thread_watch_timeout", j).putInt("main_thread_watch_log_loop", k).putInt("main_thread_watch_report", m).commit();
