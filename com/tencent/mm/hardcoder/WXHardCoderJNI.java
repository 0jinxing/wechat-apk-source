...
public class WXHardCoderJNI extends i
{
  ...
  public static int initHardCoder(e.a parama, j.a parama1)
  {
    ...
    while (true)
    {
      ...
      i = HardCoderJNI.initHardCoder(str, 0, ah.getPackageName() + ".hardcoder.client.sock", new HardCoderJNI.HCPerfManagerThread()
      {
  ...
  public static String readServerAddr(boolean paramBoolean)
  {
    try
    {
      ...
      try
      {
        ...
        ab.i("MicroMsg.WXHardCoderJNI", "readServerAddr, serverprop[%s], result[%s], stack[%s]", new Object[] { "persist.sys.hardcoder.name", localObject1, bo.dpG() });
        Object localObject4;
        if (paramBoolean)
        {
          if (!bo.isNullOrNil((String)localObject1))
            break label150;
          localObject4 = new com/tencent/mm/hardcoder/l;
          ((l)localObject4).<init>(true, 1, 1, false);
          reportInfo((j)localObject4);
        }
        while (true)
        {
          AppMethodBeat.o(93135);
          return localObject1;
          label150: localObject4 = new com/tencent/mm/hardcoder/l;
          ((l)localObject4).<init>(true, 2, 1, false);
          reportInfo((j)localObject4);
          localObject4 = new com/tencent/mm/hardcoder/m;
          ((m)localObject4).<init>();
          reportInfo((j)localObject4);
        }
      }
      catch (Throwable localThrowable)
      {
        while (true)
        {
          ...
          if (paramBoolean)
          {
            localObject2 = new com/tencent/mm/hardcoder/l;
            ((l)localObject2).<init>(true, 3, 1, false);
            reportInfo((j)localObject2);
          }
          Object localObject2 = "";
          AppMethodBeat.o(93135);
        }
  ...
  public static int registerANRCallback(HardCoderJNI.AnrCallback paramAnrCallback)
  {
    ...
    {
      return i;
      i = HardCoderJNI.registerANRCallback(paramAnrCallback);
      AppMethodBeat.o(93139);
    }
  }
  ...
  public static int registerSystemEventCallback(HardCoderJNI.SystemEventCallback paramSystemEventCallback)
  {
    ...
    {
      return i;
      ab.i("MicroMsg.WXHardCoderJNI", "registerSystemEventCallback, stack[%s]", new Object[] { bo.dpG() });
      i = HardCoderJNI.registerSystemEventCallback(paramSystemEventCallback);
      AppMethodBeat.o(93140);
    }
  }
  ...
  public static void reloadSPConfig(int paramInt)
  {
    ...
    ab.i("MicroMsg.WXHardCoderJNI", "reloadSPConfig scene:%d, hcDebug:%b, hcEnable:%b, hcUinHash:%d, checkEnv:%b, stack[%s]", new Object[] { Integer.valueOf(paramInt), Boolean.valueOf(HardCoderJNI.isHcDebug()), Boolean.valueOf(HardCoderJNI.isHcEnable()), Integer.valueOf(hcUinHash), Boolean.valueOf(HardCoderJNI.isCheckEnv()), bo.dpG() });
    ...
    {
      bool = true;
      label187: hcKVPerReport = bool;
      if (localSharedPreferences.getInt("KEY_HC_KV_FT", 0) >= hcUinHash)
        break label2263;
    }
    label2263: for (bool = true; ; bool = false)
    {
      hcKVFtReport = bool;
