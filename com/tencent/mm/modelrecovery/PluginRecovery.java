...
public class PluginRecovery extends f
  implements com.tencent.mm.kernel.api.bucket.c
{
  private com.tencent.mm.sdk.b.c<nv> fMF;
  private RecoveryLog.RecoveryLogImpl fMG;
  private BroadcastReceiver receiver;

  public PluginRecovery()
  {
    AppMethodBeat.i(16535);
    this.fMF = new PluginRecovery.1(this);
    this.receiver = new PluginRecovery.2(this);
    this.fMG = new RecoveryLog.RecoveryLogImpl()
    {
  ...
  public void configure(g paramg)
  {
    ...
    if (paramg.lQ(":sandbox"))
    {
      ...
      paramg = new b(WXConstantsRecovery.ArA);
      if (!paramg.exists())
        paramg.mkdirs();
    ...
    try
    {
      paramg = j.w(paramg.dMD());
      byte[] arrayOfByte = Integer.toHexString(com.tencent.mm.protocal.d.vxo).getBytes();
      e.b(paramg, arrayOfByte, arrayOfByte.length);
      label133: ab.i("MicroMsg.Recovery.PluginRecovery", "add recovery intent filter and save client verison file %d", new Object[] { Long.valueOf(System.currentTimeMillis() - l) });
