  ...
  implements am.a
{
  ...
  public ak()
  {
    ...
    if (Looper.myLooper() == null)
    {
      ...
      this.handler = new b(bo.bc(a.getTag(), "MicroMsg.MMHandler"), null, this);
    ...
    while (true)
    {
      ...
      if (getLooper().getThread().getName().equals("initThread"))
        ab.e("MicroMsg.MMHandler", "MMHandler can not init handler with initThread looper, stack %s", new Object[] { bo.dpG() });
      AppMethodBeat.o(52066);
    }
  }
  ...
  public ak(a parama)
  {
    ...
    {
      ab.w("MicroMsg.MMHandler", "[MMHandler] myLooper() == null loopTag:%s", new Object[] { a.getTag() });
      this.handler = new b(bo.bc(a.getTag(), "MicroMsg.MMHandler"), parama, this);
  ...
  public String dump(boolean paramBoolean)
  {
    ...
    Object localObject1 = new ConcurrentHashMap(this.map);
    localStringBuilder.append("tasks info size = " + ((ConcurrentHashMap)localObject1).size() + '\n');
    ...
    if (localIterator != null)
      for (int i = 0; localIterator.hasNext(); i++)
      {
        ...
        if ((localObject2 != null) && (((WeakReference)localObject2).get() != null))
        {
          ...
          localStringBuilder.append("[index = " + i + " | taskinfo:" + ((aq)localObject2).dump(paramBoolean) + "]\n");
        }
      }
  ...
  public String dumpLatestTasks(boolean paramBoolean)
  {
    ...
    if (localObject1 != null)
      for (int i = 0; ((Iterator)localObject1).hasNext(); i++)
      {
        ...
        {
          localObject2 = (aq)((WeakReference)localObject2).get();
          localStringBuilder.append("[index = " + i + "|task=" + ((aq)localObject2).dump(paramBoolean) + "]");
        }
      }
        ...
        while (true)
          if (localIterator.hasNext())
          {
            ...
            if ((localObject != null) && (((WeakReference)localObject).get() != null))
            {
              ...
              if (((aq)localObject).eOn.equals(paramString))
              {
  ...
  public Runnable findTaskByRunTime(long paramLong)
  {
    ...
    while ((localIterator != null) && (localIterator.hasNext()))
    {
      ...
      {
        localObject = (aq)((WeakReference)localObject).get();
        if ((((aq)localObject).started) && (((aq)localObject).fpi >= ((aq)localObject).cmn) && (l - ((aq)localObject).fpi > paramLong))
        {
  ...
  public final Looper getLooper()
  {
    ...
    Looper localLooper = this.handler.dnK();
  ...
  public final boolean hasMessages(int paramInt)
  {
    ...
    boolean bool = this.handler.LU(paramInt);
  ...
  public final boolean hasMessages(int paramInt, Object paramObject)
  {
    ...
    boolean bool = this.handler.q(paramInt, paramObject);
    ...
    while (true)
    {
      ...
      else
      {
        ...
        if ((localWeakReference != null) && (localWeakReference.get() != null))
          this.handler.ad((Runnable)localWeakReference.get());
        this.map.remove(paramRunnable);
        AppMethodBeat.o(52084);
      }
    }
  ...
  public final void removeCallbacks(Runnable paramRunnable, Object paramObject)
  {
    ...
    while (true)
    {
      ...
      {
        WeakReference localWeakReference = (WeakReference)this.map.get(paramRunnable);
        if ((localWeakReference != null) && (localWeakReference.get() != null) && ((paramObject == null) || (((aq)localWeakReference.get()).xxu == paramObject)))
      ...
      if (localIterator != null)
        while (localIterator.hasNext())
        {
          ...
          if (localObject != null)
          {
            ...
            if ((localObject != null) && (((WeakReference)localObject).get() != null) && (((aq)((WeakReference)localObject).get()).xxu == paramObject))
  ...
  public final void removeMessages(int paramInt, Object paramObject)
  {
    ...
    this.handler.p(paramInt, paramObject);
  ...
  public static abstract interface a extends Handler.Callback
  {
  }
