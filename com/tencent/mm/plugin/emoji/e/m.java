...
public final class m
{
  ...
  public static void a(Context paramContext, EmotionBannerSet paramEmotionBannerSet, boolean paramBoolean)
  {
    ...
    while (true)
    {
      ...
      case 0:
        ...
        h.pYm.e(13223, new Object[] { Integer.valueOf(1), Integer.valueOf(paramEmotionBannerSet.ID), paramEmotionBannerSet.Title, Integer.valueOf(0), Integer.valueOf(0) });
        AppMethodBeat.o(52990);
        break;
      case 4:
        ...
        h.pYm.e(13223, new Object[] { Integer.valueOf(1), Integer.valueOf(paramEmotionBannerSet.ID), paramEmotionBannerSet.Title, Integer.valueOf(0), Integer.valueOf(1) });
        AppMethodBeat.o(52990);
        break;
      case 3:
        ...
        h.pYm.e(13223, new Object[] { Integer.valueOf(1), Integer.valueOf(paramEmotionBannerSet.ID), paramEmotionBannerSet.Title, Integer.valueOf(0), Integer.valueOf(2) });
        AppMethodBeat.o(52990);
        break;
      case 2:
        s(paramContext, paramEmotionBannerSet.LocateUrl, paramEmotionBannerSet.Title);
        h.pYm.e(13223, new Object[] { Integer.valueOf(1), Integer.valueOf(paramEmotionBannerSet.ID), paramEmotionBannerSet.Title, Integer.valueOf(0), Integer.valueOf(3) });
        AppMethodBeat.o(52990);
      case 1:
      }
    }
    ...
    while (true)
    {
      h.pYm.e(13223, new Object[] { Integer.valueOf(1), Integer.valueOf(paramEmotionBannerSet.ID), paramEmotionBannerSet.Title, Integer.valueOf(0), Integer.valueOf(4) });
      AppMethodBeat.o(52990);
      break;
  ...
  private static void s(Context paramContext, String paramString1, String paramString2)
  {
    ...
    b.gkE.i(localIntent, paramContext);
