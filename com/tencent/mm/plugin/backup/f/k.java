...
public final class k extends a
{
  ...
  public static k.a Fk(String paramString)
  {
    AppMethodBeat.i(17473);
    if (jvL == null)
      jvL = new k();
    Object localObject = jvL;
    if (((k)localObject).jvM == null)
      ((k)localObject).aTB();
    Iterator localIterator = ((k)localObject).jvM.values().iterator();
    while (localIterator.hasNext())
    {
      localObject = (k.a)localIterator.next();
      if ((((k.a)localObject).jvO != null) && (((k.a)localObject).jvO.equals(paramString)))
      {
  ...
  public static k.a Fl(String paramString)
  {
    ...
    if (localk.jvM == null)
      localk.aTB();
    paramString = (k.a)localk.jvM.get(paramString);
  ...
  private void aTB()
  {
    ...
    //   18: putfield 56	com/tencent/mm/plugin/backup/f/k:jvM	Ljava/util/Map;
    ...
    //   84: astore 6
    //   86: aload 7
    //   88: getstatic 24	com/tencent/mm/plugin/backup/f/k:jvG	Ljava/lang/String;
    ...
    //   101: aload_3
    //   102: astore 6
    //   104: new 6	com/tencent/mm/plugin/backup/f/k$a
    //   107: astore 7
    //   109: aload 4
    //   111: astore 5
    //   113: aload_3
    //   114: astore 6
    //   116: aload 7
    //   118: invokespecial 155	com/tencent/mm/plugin/backup/f/k$a:<init>	()V
    //   121: aload 4
    //   123: astore 5
    //   125: aload_3
    //   126: astore 6
    ...
    //   145: astore 6
    //   147: aload 8
    //   149: getstatic 28	com/tencent/mm/plugin/backup/f/k:END	Ljava/lang/String;
    ...
    //   213: astore 6
    //   215: aload 8
    //   217: getstatic 32	com/tencent/mm/plugin/backup/f/k:jvH	Ljava/lang/String;
    ...
    //   233: aload 7
    //   235: aload 9
    //   237: putfield 92	com/tencent/mm/plugin/backup/f/k$a:jvO	Ljava/lang/String;
    //   240: aload 4
    //   242: astore 5
    //   244: aload_3
    //   245: astore 6
    //   247: aload_0
    //   248: getfield 56	com/tencent/mm/plugin/backup/f/k:jvM	Ljava/util/Map;
    //   251: aload 7
    //   253: getfield 176	com/tencent/mm/plugin/backup/f/k$a:jvN	Ljava/lang/String;
    //   256: aload 7
    ...
    //   337: astore 6
    //   339: aload 8
    //   341: getstatic 36	com/tencent/mm/plugin/backup/f/k:jvI	Ljava/lang/String;
    ...
    //   357: aload 7
    //   359: aload 9
    //   361: putfield 176	com/tencent/mm/plugin/backup/f/k$a:jvN	Ljava/lang/String;
    //   364: goto -124 -> 240
    //   367: astore 4
    //   369: aload 6
    //   371: astore_3
    ...
    //   404: astore 6
    //   406: aload 8
    //   408: getstatic 40	com/tencent/mm/plugin/backup/f/k:jvJ	Ljava/lang/String;
    ...
    //   424: aload 7
    //   426: aload 9
    //   428: putfield 214	com/tencent/mm/plugin/backup/f/k$a:jvP	Ljava/lang/String;
    //   431: goto -191 -> 240
    //   434: aload 4
    //   436: astore 5
    //   438: aload_3
    //   439: astore 6
    //   441: aload 8
    //   443: getstatic 44	com/tencent/mm/plugin/backup/f/k:jvK	Ljava/lang/String;
    ...
    //   459: aload 7
    //   461: aload 9
    //   463: putfield 217	com/tencent/mm/plugin/backup/f/k$a:jvQ	Ljava/lang/String;
    //   466: goto -226 -> 240
    //   469: aload 4
    //   471: astore 5
    //   473: aload_3
    ...
    //   485: iconst_0
    //   486: aload 7
    //   488: invokevirtual 222	com/tencent/mm/plugin/backup/f/k$a:toString	()Ljava/lang/String;
    //   491: aastore
