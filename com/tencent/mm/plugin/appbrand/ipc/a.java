...
public final class a
{
  ...
  static
  {
    ...
    huD = Collections.unmodifiableMap(localHashMap);
  ...
  public static <_Req extends AppBrandProxyUIProcessTask.ProcessRequest, _Result extends AppBrandProxyUIProcessTask.ProcessResult> void b(Context paramContext, _Req param_Req, AppBrandProxyUIProcessTask.b<_Result> paramb)
  {
    ...
    localObject1 = (Class)huD.get(((String)localObject1).replaceFirst((String)localObject2, ""));
    localObject2 = localObject1;
    if (localObject1 == null)
      localObject2 = AppBrandProcessProxyUI.class;
    AppBrandProcessProxyUI.a(paramContext, (Class)localObject2, param_Req, paramb, null);
