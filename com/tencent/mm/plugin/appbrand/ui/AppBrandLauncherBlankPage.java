...
public final class AppBrandLauncherBlankPage extends AppBrandLauncherUI.Fragment
{
  public static ViewGroup Y(Context paramContext, String paramString)
  {
    ...
    ((ImageView)localObject1).setImageResource(2131230854);
  ...
  public static AppBrandLauncherBlankPage cO(String paramString1, String paramString2)
  {
  ...
  public final void initView()
  {
    ...
    for (Object localObject = null; ; localObject = getArguments().getString("extra_tip"))
    {
      ...
      ((ViewGroup)this.WL).addView((View)localObject, new ViewGroup.LayoutParams(-1, -1));
  ...
  public final void onResume()
  {
    ...
    label42: for (String str = ""; ; str = getArguments().getString("extra_title"))
    {
