...
{
  public Map<String, com.tencent.mm.plugin.appbrand.canvas.action.d> hcD;
  ...
  private void a(com.tencent.mm.plugin.appbrand.canvas.action.d paramd)
  {
    ...
    this.hcD.put(paramd.getMethod(), paramd);
  ...
  public final boolean a(d paramd, Canvas paramCanvas, JSONObject paramJSONObject)
  {
    ...
    localObject = (com.tencent.mm.plugin.appbrand.canvas.action.d)this.hcD.get(localObject);
    boolean bool;
    if (localObject == null)
    {
      bool = false;
    ...
    {
      return bool;
      bool = ((com.tencent.mm.plugin.appbrand.canvas.action.d)localObject).a(paramd, paramCanvas, paramJSONObject);
      AppMethodBeat.o(103163);
    }
  }
}
