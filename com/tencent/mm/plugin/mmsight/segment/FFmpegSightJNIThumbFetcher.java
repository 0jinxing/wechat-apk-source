  ...
  implements d
{
    ...
    while (true)
    {
      ...
      while (true)
      {
        ...
        if ((this.mReusedBitmap == null) || (this.mReusedBitmap.isRecycled()) || (this.mReusedBitmap.getWidth() != this.mScaledWidth) || (this.mReusedBitmap.getHeight() != this.mScaledHeight))
        {
          ...
          this.mReusedBitmap = o.fdT.a(new o.b(this.mScaledWidth, this.mScaledHeight));
        }
  ...
  public void init(String paramString, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    int i = SightVideoJNI.getVideoWidth(this.mBufId);
    paramInt1 = SightVideoJNI.getVideoHeight(this.mBufId);
    this.mDurationMs = ((int)(SightVideoJNI.getVideoDuration(this.mBufId) * 1000.0D));
    paramString = calculateScaledLength(paramInt2, paramInt3, i, paramInt1, new Point());
    this.mScaledWidth = paramString.x;
    this.mScaledHeight = paramString.y;
    ab.i("MicroMsg.FFmpegSightJNIThumbFetcher", "FFmpegSightJNIThumbFetcher.init. scaled size is (%d, %d); raw size is (%d, %d)", new Object[] { Integer.valueOf(this.mScaledWidth), Integer.valueOf(this.mScaledHeight), Integer.valueOf(i), Integer.valueOf(paramInt1) });
    AppMethodBeat.o(3629);
  }
  ...
  public void release()
  {
    ...
    com.tencent.mm.sdk.g.d.post(new ReleaseRunnable(this.mReusedBitmap, this.mBufId, null), "release");
