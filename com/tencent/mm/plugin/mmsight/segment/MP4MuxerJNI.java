...
public final class MP4MuxerJNI
{
  ...
  public static int initH264EncoderLock(int paramInt1, int paramInt2, float paramFloat1, int paramInt3, int paramInt4, int paramInt5, int paramInt6, float paramFloat2)
  {
    AppMethodBeat.i(117290);
    synchronized (lock)
    {
      paramInt1 = initH264Encoder(paramInt1, paramInt2, paramFloat1, paramInt3, paramInt4, paramInt5, paramInt6, paramFloat2);
