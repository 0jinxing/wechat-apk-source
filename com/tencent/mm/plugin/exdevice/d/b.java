...
{
  public LinkedList<a> luI;

  public b()
  {
    AppMethodBeat.i(19416);
    this.luI = new LinkedList();
  ...
  public final int op(int paramInt, Object[] paramArrayOfObject)
  {
    ...
    if (paramInt == 0)
    {
      ((e.a.a.c.a)paramArrayOfObject[0]).e(1, 8, this.luI);
    ...
    while (true)
    {
      ...
      if (paramInt == 1)
      {
        paramInt = e.a.a.a.c(1, 8, this.luI) + 0;
        AppMethodBeat.o(19417);
      }
      else if (paramInt == 2)
      {
      ...
      else if (paramInt == 3)
      {
        ...
        case 1:
          ...
          for (paramInt = 0; paramInt < i; paramInt++)
          {
            ...
            localb.luI.add(paramArrayOfObject);
          }
          AppMethodBeat.o(19417);
          paramInt = 0;
          break;
