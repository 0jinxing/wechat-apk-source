  ...
  public final boolean a(int paramInt1, int paramInt2, org.b.d.i parami, String paramString1, List<String> paramList1, ayt paramayt, int paramInt3, boolean paramBoolean, List<String> paramList2, PInt paramPInt, String paramString2, int paramInt4, int paramInt5)
  {
    ...
    while (true)
    {
      ...
      if (bo.isNullOrNil(this.rid))
        break;
      bool2 = bool1;
      if (com.tencent.mm.at.o.ahk() == null)
        break;
      ...
      if (parami == null)
        break;
      bool2 = paramString2.a(com.tencent.mm.sdk.platformtools.d.aj(parami), this.ril, this.title, this.rij, this.rik);
      break;
      label437: paramString2.Di(0);
    }
    label447: paramString2.ar(paramString1).Df(paramInt1);
    ...
    af.cnB().cmp();
    this.crP.finish();
    parami = ((com.tencent.mm.plugin.emoji.b.d)com.tencent.mm.kernel.g.M(com.tencent.mm.plugin.emoji.b.d.class)).getEmojiMgr().Jl(this.rik);
    h.pYm.e(10993, new Object[] { Integer.valueOf(1), parami });
