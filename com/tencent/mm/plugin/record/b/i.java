...
public final class i extends h<com.tencent.mm.plugin.record.a.i>
{
  ...
  final void a(com.tencent.mm.plugin.record.a.i parami, boolean paramBoolean)
  {
    ...
    {
      localg.cRY = true;
      localg.field_priority = com.tencent.mm.i.a.efB;
    ...
    while (true)
    {
      ab.d("MicroMsg.RecordMsgCDNService", "summersafecdn doJob, isSend:%B totallen:%d, aseKey:%s, url[%s], fullPath[%s], fileType[%d], enable_hitcheck[%b], force_aeskeycdn[%b]", new Object[] { Boolean.valueOf(localg.cRY), Integer.valueOf(localg.field_totalLen), localg.field_aesKey, localg.field_fileId, localg.field_fullpath, Integer.valueOf(localg.field_fileType), Boolean.valueOf(localg.field_enable_hitcheck), Boolean.valueOf(localg.field_force_aeskeycdn) });
      AppMethodBeat.o(135673);
      break;
      localg.cRY = false;
      ...
      if (!bo.isNullOrNil(parami.field_tpdataurl))
      {
        ...
        localg.egm = parami.field_tpdataurl;
        localg.field_fileId = "";
      }
  ...
  protected final List<com.tencent.mm.plugin.record.a.i> ceF()
  {
    AppMethodBeat.i(135672);
    List localList = ((com.tencent.mm.plugin.record.a.a)com.tencent.mm.kernel.g.M(com.tencent.mm.plugin.record.a.a.class)).getRecordMsgCDNStorage().ceA();
