...
final class q$d$1
  implements g.a
{
  q$d$1(q.d paramd, aar paramaar, String paramString)
  {
  }
  ...
  public final int a(String paramString, int paramInt, c paramc, d paramd, boolean paramBoolean)
  {
    ...
    if ((paramInt == 0) && (paramd != null) && (paramd.field_retCode == 0))
      ab.i("MicroMsg.RecordMsgSendService", "[record] downloadTpUrl done id:%s, mediaId:%s, path:%s", new Object[] { this.mjL.mnd, paramString, this.bSt });
    for (int i = 1; ; i = 0)
    {
      int j;
      String str;
      ...
      {
        ab.e("MicroMsg.RecordMsgSendService", "[record] downloadTpUrl error id:%s, mediaId:%s, path:%s, err:(%d,%d)", new Object[] { str, paramString, paramc, Integer.valueOf(paramInt), Integer.valueOf(i) });
        j = 1;
        if (j != 0)
        {
