...
public class AppIconView extends AppCompatImageView
{
  ...
  protected void onDraw(Canvas paramCanvas)
  {
    ...
    if ((this.bitmap != null) && (this.kPN != null))
      if (Build.VERSION.SDK_INT < 21)
        break label207;
    label207: for (int i = paramCanvas.saveLayer(0.0F, 0.0F, getWidth(), getHeight(), null); ; i = paramCanvas.saveLayer(0.0F, 0.0F, getWidth(), getHeight(), null, 31))
    {
      ...
      localPaint.setColor(getResources().getColor(2131689735));
      paramCanvas.drawRoundRect(this.kPM, 32.0F, 32.0F, localPaint);
  ...
  protected void onSizeChanged(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    localPaint.setColor(getResources().getColor(2131689734));
    localCanvas.drawRoundRect(this.kPM, 32.0F, 32.0F, localPaint);
