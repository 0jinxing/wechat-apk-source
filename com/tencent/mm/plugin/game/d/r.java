...
public final class r extends com.tencent.mm.bt.a
{
  ...
  public final int op(int paramInt, Object[] paramArrayOfObject)
  {
    ...
    if (paramInt == 0)
    {
      ((e.a.a.c.a)paramArrayOfObject[0]).e(1, 8, this.nak);
    ...
    while (true)
    {
      ...
      if (paramInt == 1)
      {
        paramInt = e.a.a.a.c(1, 8, this.nak) + 0;
        AppMethodBeat.o(116995);
      }
      else if (paramInt == 2)
      {
      ...
      else if (paramInt == 3)
      {
        ...
        case 1:
          ...
          for (paramInt = 0; paramInt < i; paramInt++)
          {
            ...
            paramArrayOfObject = new dm();
            localObject2 = new e.a.a.a.a((byte[])localObject2, unknownTagHandler);
            for (boolean bool = true; bool; bool = paramArrayOfObject.populateBuilderWithField((e.a.a.a.a)localObject2, paramArrayOfObject, com.tencent.mm.bt.a.getNextFieldNumber((e.a.a.a.a)localObject2)));
            localr.nak.add(paramArrayOfObject);
          }
          AppMethodBeat.o(116995);
          paramInt = 0;
          break;
