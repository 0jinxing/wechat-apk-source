...
class NetStatRuler extends View
{
  ...
  public void onDraw(Canvas paramCanvas)
  {
    ...
    localTextPaint.setTextSize(getContext().getResources().getDimensionPixelSize(2131427874));
    ...
    paramCanvas.drawText(bo.my(NetStatUnit.max * 2 / 3), f2, f3 + f4, localTextPaint);
    paramCanvas.drawText(bo.my(NetStatUnit.max / 3), f2, f5 + f6, localTextPaint);
    paramCanvas.drawText(bo.my(0L), f2, f7 + f1, localTextPaint);
