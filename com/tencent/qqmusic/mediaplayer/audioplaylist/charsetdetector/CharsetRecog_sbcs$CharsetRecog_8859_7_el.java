...
class CharsetRecog_sbcs$CharsetRecog_8859_7_el extends CharsetRecog_sbcs.CharsetRecog_8859_7
{
  ...
  public CharsetMatch match(CharsetDetector paramCharsetDetector)
  {
    ...
    while (true)
    {
      ...
      str = "ISO-8859-7";
      break;
      label46: paramCharsetDetector = new CharsetMatch(paramCharsetDetector, this, i, str, "el");
      AppMethodBeat.o(104744);
    }
  }
}
