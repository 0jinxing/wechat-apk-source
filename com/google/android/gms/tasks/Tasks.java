...
import java.util.Collection<+Lcom.google.android.gms.tasks.Task<*>;>;
...
public final class Tasks
{
  ...
  public static Task<Void> whenAll(Collection<? extends Task<?>> paramCollection)
  {
    ...
    while (true)
    {
      ...
      AppMethodBeat.o(57368);
      paramCollection = (Collection<? extends Task<?>>)localObject;
    }
  }
  ...
  public static Task<Void> whenAll(Task<?>[] paramArrayOfTask)
  {
    ...
    {
      paramArrayOfTask = forResult(null);
      AppMethodBeat.o(57369);
    }
    while (true)
    {
      return paramArrayOfTask;
      paramArrayOfTask = whenAll(Arrays.asList(paramArrayOfTask));
      AppMethodBeat.o(57369);
    }
  }
  ...
  public static Task<List<Task<?>>> whenAllComplete(Task<?>[] paramArrayOfTask)
  {
    ...
    paramArrayOfTask = whenAllComplete(Arrays.asList(paramArrayOfTask));
  ...
  public static <TResult> Task<List<TResult>> whenAllSuccess(Task<?>[] paramArrayOfTask)
  {
    ...
    paramArrayOfTask = whenAllSuccess(Arrays.asList(paramArrayOfTask));
