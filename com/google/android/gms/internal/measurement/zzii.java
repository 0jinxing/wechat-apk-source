...
public final class zzii extends zzhh
{
  ...
  final void zza(zzey paramzzey, AbstractSafeParcelable paramAbstractSafeParcelable, zzdz paramzzdz)
  {
    ...
    label301: for (j = ((List)localObject).size(); ; j = 0)
    {
  ...
  final void zzdf()
  {
    ...
    while (true)
    {
      ...
      if (this.zzaoz == null)
      {
        ...
        {
          bool1 = true;
          this.zzaoz = Boolean.valueOf(bool1);
        }
      }
      else
      {
      ...
      while (true)
      {
        ...
        localObject = zzgb();
        j = GoogleApiAvailabilityLight.getInstance().isGooglePlayServicesAvailable(((zzhg)localObject).getContext(), 12451);
        switch (j)
        {
        default:
          zzge().zzip().zzg("Unexpected service status", Integer.valueOf(j));
          bool2 = false;
          j = 0;
          break;
        case 0:
      ...
      label438: Object localObject = getContext().getPackageManager().queryIntentServices(new Intent().setClassName(getContext(), "com.google.android.gms.measurement.AppMeasurementService"), 65536);
      ...
      label543: zzge().zzim().log("Unable to use remote or local measurement implementation. Please register the AppMeasurementService service in the app manifest");
      AppMethodBeat.o(69291);
    }
  }
