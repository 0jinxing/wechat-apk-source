...
public class zzgl extends zzjr
  implements zzhi
{
  ...
  public static zzgl zzg(Context paramContext)
  {
    ...
    try
    {
      if (zzame == null)
      {
        zzhj localzzhj = new com/google/android/gms/internal/measurement/zzhj;
        localzzhj.<init>(paramContext);
        paramContext = new com/google/android/gms/internal/measurement/zzgl;
        paramContext.<init>(localzzhj);
        zzame = paramContext;
      }
      paramContext = zzame;
  ...
  protected final void start()
  {
    ...
    while (true)
    {
      ...
      break;
      label400: if (!((String)localObject).equals(zzfv().getGmpAppId()))
      {
  ...
  final long zzjt()
  {
    ...
    {
      return l;
      l = Math.min(this.zzaem, localLong.longValue());
      AppMethodBeat.o(69086);
    }
  }
