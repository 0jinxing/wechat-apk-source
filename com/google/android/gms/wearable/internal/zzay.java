  ...
  implements Channel, ChannelClient.Channel
{
  ...
  public final String toString()
  {
    ...
    str1 = this.zzcl;
    localObject = String.valueOf(localObject).length() + 31 + String.valueOf(str2).length() + String.valueOf(str1).length() + "Channel{token=" + (String)localObject + ", nodeId=" + str2 + ", path=" + str1 + "}";
