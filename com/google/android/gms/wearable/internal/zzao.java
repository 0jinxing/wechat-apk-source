...
public final class zzao extends ChannelClient
{
  ...
  public final Task<Void> registerChannelCallback(ChannelClient.Channel paramChannel, ChannelClient.ChannelCallback paramChannelCallback)
  {
    ...
    {
      localObject = ListenerHolders.createListenerHolder(paramChannelCallback, (Looper)localObject, paramChannel);
      paramChannel = zzgj.zzc("com.google.android.gms.wearable.CHANNEL_EVENT");
      ...
      paramChannel = doRegisterEventListener(new zzat(paramChannelCallback, str, new IntentFilter[] { paramChannel }, (ListenerHolder)localObject, localListenerHolder), new zzau(paramChannelCallback, str, ((ListenerHolder)localObject).getListenerKey()));
  ...
  public final Task<Void> registerChannelCallback(ChannelClient.ChannelCallback paramChannelCallback)
  {
    ...
    paramChannelCallback = ListenerHolders.createListenerHolder(localzzas, getLooper(), "ChannelListener");
    paramChannelCallback = doRegisterEventListener(new zzat(localzzas, null, new IntentFilter[] { localIntentFilter }, localListenerHolder, paramChannelCallback), new zzau(localzzas, null, localListenerHolder.getListenerKey()));
