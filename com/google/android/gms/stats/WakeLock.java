...
public class WakeLock
{
  ...
  public WakeLock(Context paramContext, int paramInt, @Nonnull String paramString1, @Nullable String paramString2, @Nonnull String paramString3, @Nullable String paramString4)
  {
    ...
    {
      str = String.valueOf("*gcore*:");
      paramString2 = String.valueOf(paramString1);
      if (paramString2.length() != 0)
      {
        paramString2 = str.concat(paramString2);
        this.zzadz = paramString2;
        label117: this.zzadv = ((PowerManager)paramContext.getSystemService("power")).newWakeLock(paramInt, paramString1);
    ...
    label293: for (this.zzadw = WorkSourceUtil.fromPackageAndModuleExperimentalPi(paramContext, paramString1, paramString4); ; this.zzadw = WorkSourceUtil.fromPackage(paramContext, paramString1))
    {
  ...
  private final void zza(String paramString, long paramLong)
  {
    ...
    while (true)
    {
      ...
      label292: paramString = new String("Do not acquire with timeout on reference counted wakeLocks before ICS. wakelock: ");
    }
  }
  ...
  private final void zzc(String paramString, int paramInt)
  {
    ...
    String str = zzn(paramString);
    try
    {
      int i;
      if (this.zzaec)
      {
        paramString = (Integer[])this.zzaed.get(str);
        if (paramString != null)
          break label123;
        i = 0;
      }
      while (true)
      {
        ...
        {
          WakeLockTracker.getInstance().registerEvent(this.zzjp, StatsUtils.getEventKey(this.zzadv, str), 8, this.zzadz, str, this.zzaeb, this.zzady, zzdo());
          this.zzaee -= 1;
        }
        zzn(paramInt);
        AppMethodBeat.o(113964);
        return;
        label123: if (paramString[0].intValue() == 1)
        {
          this.zzaed.remove(str);
          i = 1;
        }
        else
        {
          paramString[0] = Integer.valueOf(paramString[0].intValue() - 1);
          i = 0;
        }
      }
    }
  ...
  public void addWorkSource(WorkSource paramWorkSource)
  {
    ...
    while (true)
    {
      ...
      return;
      label51: this.zzadw = paramWorkSource;
    }
  }
