...
public class InstanceID
{
        ...
        if (paramBundle == null)
        {
          ...
          if (paramBundle == null)
          {
            ...
            if (zzbs == null)
            {
              ...
              ((StringBuilder)localObject).<init>(i + 73);
              ((StringBuilder)localObject).append("Instance ID SDK is deprecated, ").append(paramContext).append(" should update to use Firebase Instance ID");
              paramContext = new com/google/android/gms/iid/zzak;
              paramContext.<init>(localContext);
              zzbs = paramContext;
              paramContext = new com/google/android/gms/iid/zzaf;
              paramContext.<init>(localContext);
              zzbt = paramContext;
            }
            zzbu = Integer.toString(zzg(localContext));
            Object localObject = (InstanceID)zzbq.get(paramBundle);
            paramContext = (Context)localObject;
            if (localObject == null)
            {
              paramContext = new com/google/android/gms/iid/InstanceID;
              paramContext.<init>(localContext, paramBundle);
  ...
  public String getToken(String paramString1, String paramString2, Bundle paramBundle)
  {
    ...
    while (true)
    {
      ...
      AppMethodBeat.o(57516);
      return localObject2;
      label162: localObject2 = zzbs.get("lastToken");
      j = i;
      if (localObject2 != null)
      {
  ...
  public final void zzd(String paramString1, String paramString2, Bundle paramBundle)
  {
    ...
    while (true)
    {
      ...
      break;
      label188: paramString1 = this.zzbv;
    }
  }
