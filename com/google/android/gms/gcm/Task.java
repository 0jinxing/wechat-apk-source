  ...
  implements ReflectedParcelable
{
  ...
  private static void zzd(Uri paramUri)
  {
    ...
    catch (NumberFormatException paramUri)
    {
      ...
      label265: AppMethodBeat.o(70019);
    }
  }
  ...
  public static void zzg(Bundle paramBundle)
  {
    ...
    if (paramBundle != null)
    {
      ...
      {
        localObject = paramBundle.get((String)localIterator.next());
        ...
        label165: continue;
        label167: paramBundle = new IllegalArgumentException("Only the following extra parameter types are supported: Integer, Long, Double, String, Boolean, and nested Bundles with the same restrictions.");
        AppMethodBeat.o(70018);
        throw paramBundle;
      }
    }
  ...
  public void writeToParcel(Parcel paramParcel, int paramInt)
  {
    ...
    label64: for (paramInt = i; ; paramInt = 0)
    {
      paramParcel.writeInt(paramInt);
