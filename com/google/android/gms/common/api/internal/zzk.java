...
public abstract class zzk extends LifecycleCallback
  implements DialogInterface.OnCancelListener
{
  ...
  public final void onActivityResult(int paramInt1, int paramInt2, Intent paramIntent)
  {
    ...
    default:
      ...
      break;
    case 2:
      label45: label53: i = this.zzdg.isGooglePlayServicesAvailable(getActivity());
      if (i != 0);
      break;
    case 1:
    }
  ...
  public final void onCreate(Bundle paramBundle)
  {
    ...
    label67: for (paramBundle = new zzl(new ConnectionResult(paramBundle.getInt("failed_status"), (PendingIntent)paramBundle.getParcelable("failed_resolution")), paramBundle.getInt("failed_client_id", -1)); ; paramBundle = null)
    {
