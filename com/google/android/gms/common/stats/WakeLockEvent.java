...
public final class WakeLockEvent extends StatsEvent
{
  ...
  public final String getSpecificString()
  {
    ...
    label223: label232: label241: for (String str5 = ""; ; str5 = getCodePackage())
    {
      str2 = String.valueOf(str1).length() + 45 + String.valueOf(str2).length() + String.valueOf(str3).length() + String.valueOf(str4).length() + String.valueOf(str5).length() + "\t" + str1 + "\t" + i + "\t" + str2 + "\t" + j + "\t" + str3 + "\t" + str4 + "\t" + f + "\t" + str5;
