    ...
    while (true)
    {
      while (true)
      {
        ...
        if ("com.google.android.gms".equals(str))
          localObject = null;
        paramString2 = new WakeLockEvent(l1, paramInt1, paramString2, paramInt2, paramList, paramString1, l2, i, paramString3, (String)localObject, DeviceStateUtils.getPowerPercentage(paramContext), paramLong, paramString4);
        try
        {
          paramString1 = new android/content/Intent;
          paramString1.<init>();
          paramContext.startService(paramString1.setComponent(LoggingConstants.STATS_SERVICE_COMPONENT_NAME).putExtra("com.google.android.gms.common.stats.EXTRA_LOG_EVENT", paramString2));
          AppMethodBeat.o(89990);
        }
