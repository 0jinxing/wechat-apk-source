...
public final class ConnectionEvent extends StatsEvent
{
  ...
  public final String getSpecificString()
  {
    ...
    if (this.zzyb == null);
    for (String str5 = ""; ; str5 = this.zzyb)
    {
      long l = getHeapAlloc();
      str5 = String.valueOf(str1).length() + 26 + String.valueOf(str2).length() + String.valueOf(str3).length() + String.valueOf(str4).length() + String.valueOf(str5).length() + "\t" + str1 + "/" + str2 + "\t" + str3 + "/" + str4 + "\t" + str5 + "\t" + l;
