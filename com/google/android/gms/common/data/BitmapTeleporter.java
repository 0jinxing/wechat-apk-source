  ...
  implements ReflectedParcelable
{
  ...
  private final java.io.FileOutputStream zzcj()
  {
    ...
    //   45: aload_1
    //   46: aload_2
    //   47: invokespecial 105	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   50: aload_0
    //   51: aload_2
    //   52: ldc 106
  ...
  public Bitmap get()
  {
    ...
    try
    {
      localObject2 = new byte[((DataInputStream)localObject1).readInt()];
      int i = ((DataInputStream)localObject1).readInt();
      int j = ((DataInputStream)localObject1).readInt();
      Object localObject3 = Bitmap.Config.valueOf(((DataInputStream)localObject1).readUTF());
      ...
      localObject3 = Bitmap.createBitmap(i, j, (Bitmap.Config)localObject3);
      ((Bitmap)localObject3).copyPixelsFromBuffer((Buffer)localObject1);
      this.zznc = ((Bitmap)localObject3);
      this.zznd = true;
