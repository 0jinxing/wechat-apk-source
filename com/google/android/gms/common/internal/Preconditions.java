...
public final class Preconditions
{
  ...
  public static void checkArgument(boolean paramBoolean, String paramString, Object[] paramArrayOfObject)
  {
    ...
    if (!paramBoolean)
    {
      paramString = new IllegalArgumentException(String.format(paramString, paramArrayOfObject));
  ...
  public static void checkState(boolean paramBoolean, String paramString, Object[] paramArrayOfObject)
  {
    ...
    if (!paramBoolean)
    {
      paramString = new IllegalStateException(String.format(paramString, paramArrayOfObject));
