...
public class SSLCertificateSocketFactory extends SSLSocketFactory
{
  ...
  private static byte[] zza(byte[][] paramArrayOfByte)
  {
    ...
    {
      paramArrayOfByte = new IllegalArgumentException("items.length == 0");
    ...
    while (j < i)
    {
      ...
      if ((arrayOfByte1.length == 0) || (arrayOfByte1.length > 255))
      {
        ...
        paramArrayOfByte = new IllegalArgumentException(44 + "s.length == 0 || s.length > 255: " + k);
        AppMethodBeat.o(89908);
        throw paramArrayOfByte;
      }
    ...
    for (j = 0; j < m; j++)
    {
      ...
      arrayOfByte1[k] = ((byte)(byte)arrayOfByte2.length);
      int n = arrayOfByte2.length;
      i = 0;
      k++;
      while (i < n)
      {
        arrayOfByte1[k] = ((byte)arrayOfByte2[i]);
        i++;
        k++;
      }
    }
