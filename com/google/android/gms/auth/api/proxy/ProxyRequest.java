...
public class ProxyRequest extends AbstractSafeParcelable
{
  ...
  public Map<String, String> getHeaderMap()
  {
    ...
    LinkedHashMap localLinkedHashMap = new LinkedHashMap(this.zzdw.size());
    Iterator localIterator = this.zzdw.keySet().iterator();
    while (localIterator.hasNext())
    {
      localObject = (String)localIterator.next();
      localLinkedHashMap.put(localObject, this.zzdw.getString((String)localObject));
    }
    Object localObject = Collections.unmodifiableMap(localLinkedHashMap);
