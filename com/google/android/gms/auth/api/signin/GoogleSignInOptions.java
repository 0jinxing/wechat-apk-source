  ...
  implements Api.ApiOptions.Optional, ReflectedParcelable
{
  ...
  public boolean equals(Object paramObject)
  {
    ...
    while (true)
    {
      ...
      try
      {
        ...
        {
          bool2 = this.zzr.containsAll(paramObject.getScopes());
          if (bool2);
        }
        else
        {
        ...
        if (this.zzs == null)
        {
          if (paramObject.getAccount() != null)
            break label196;
          label114: if (!TextUtils.isEmpty(this.zzw))
            break label205;
        ...
        while (true)
        {
          if ((this.zzv == paramObject.isForceCodeForRefreshToken()) && (this.zzt == paramObject.isIdTokenRequested()) && (this.zzu == paramObject.isServerAuthCodeRequested()))
          {
            ...
            bool1 = true;
            break;
            bool2 = this.zzs.equals(paramObject.getAccount());
            if (bool2)
              break label114;
          }
          label196: label205: 
          do
          {
            AppMethodBeat.o(60374);
            break;
            bool2 = this.zzw.equals(paramObject.getServerClientId());
          }
          while (!bool2);
        }
      }
  ...
  public int hashCode()
  {
    ...
    j = new HashAccumulator().addObject(localArrayList1).addObject(this.zzs).addObject(this.zzw).addBoolean(this.zzv).addBoolean(this.zzt).addBoolean(this.zzu).hash();
  ...
  public static final class Builder
  {
    ...
    public final Builder requestScopes(Scope paramScope, Scope[] paramArrayOfScope)
    {
      AppMethodBeat.i(60354);
      this.mScopes.add(paramScope);
      this.mScopes.addAll(Arrays.asList(paramArrayOfScope));
