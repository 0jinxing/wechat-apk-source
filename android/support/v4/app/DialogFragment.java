  ...
  implements DialogInterface.OnCancelListener, DialogInterface.OnDismissListener
{
  ...
  void dismissInternal(boolean paramBoolean)
  {
    ...
    while (true)
    {
      ...
      {
        m localm = getFragmentManager().beginTransaction();
        localm.a(this);
        if (paramBoolean)
          localm.commitAllowingStateLoss();
        else
          localm.commit();
      }
    }
  ...
  public int show(m paramm, String paramString)
  {
    ...
    this.mViewDestroyed = false;
    this.mBackStackId = paramm.commit();
  ...
  public void show(i parami, String paramString)
  {
    this.mDismissed = false;
    this.mShownByMe = true;
    parami = parami.beginTransaction();
    parami.a(this, paramString);
    parami.commit();
  }

  public void showNow(i parami, String paramString)
  {
    this.mDismissed = false;
    this.mShownByMe = true;
    parami = parami.beginTransaction();
