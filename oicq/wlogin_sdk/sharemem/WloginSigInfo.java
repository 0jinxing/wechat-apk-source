  ...
  implements Parcelable, Serializable
{
  ...
  public WloginSigInfo(long paramLong1, long paramLong2, long paramLong3, long paramLong4, byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, byte[] paramArrayOfByte3, byte[] paramArrayOfByte4, byte[] paramArrayOfByte5, byte[] paramArrayOfByte6, byte[] paramArrayOfByte7, byte[] paramArrayOfByte8, byte[] paramArrayOfByte9, byte[] paramArrayOfByte10, byte[] paramArrayOfByte11, byte[] paramArrayOfByte12, byte[][] paramArrayOfByte)
  {
    ...
    if (paramArrayOfByte5 != null)
    {
      ...
      label145: if (paramArrayOfByte7 == null)
        break label385;
      this._userA8 = ((byte[])paramArrayOfByte7.clone());
      label162: if (paramArrayOfByte8 == null)
        break label395;
      this._lsKey = ((byte[])paramArrayOfByte8.clone());
      label179: if (paramArrayOfByte9 == null)
        break label405;
      this._sKey = ((byte[])paramArrayOfByte9.clone());
      label196: if (paramArrayOfByte10 == null)
        break label415;
      this._userSig64 = ((byte[])paramArrayOfByte10.clone());
      label213: if (paramArrayOfByte11 == null)
        break label425;
      this._openid = ((byte[])paramArrayOfByte11.clone());
      label230: if (paramArrayOfByte12 == null)
        break label435;
      this._openkey = ((byte[])paramArrayOfByte12.clone());
      label247: if ((paramArrayOfByte == null) || (paramArrayOfByte.length != 7))
        break label445;
    ...
    while (true)
    {
      ...
      break;
      label375: this._userA5 = new byte[0];
      break label145;
      label385: this._userA8 = new byte[0];
      break label162;
      label395: this._lsKey = new byte[0];
      break label179;
      label405: this._sKey = new byte[0];
      break label196;
      label415: this._userSig64 = new byte[0];
      break label213;
      label425: this._openid = new byte[0];
      break label230;
      label435: this._openkey = new byte[0];
      break label247;
      label445: this._vkey = new byte[0];
  ...
  public WloginSigInfo Set(long paramLong1, long paramLong2, long paramLong3, long paramLong4, byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, byte[] paramArrayOfByte3, byte[] paramArrayOfByte4, byte[] paramArrayOfByte5, byte[] paramArrayOfByte6, byte[] paramArrayOfByte7, byte[] paramArrayOfByte8, byte[] paramArrayOfByte9, byte[] paramArrayOfByte10, byte[] paramArrayOfByte11, byte[] paramArrayOfByte12, byte[][] paramArrayOfByte)
  {
    ...
    if (paramArrayOfByte5 != null)
    {
      ...
      if (paramArrayOfByte6 == null)
        break label388;
      this._userA5 = ((byte[])paramArrayOfByte6.clone());
      label116: if (paramArrayOfByte7 == null)
        break label398;
      this._userA8 = ((byte[])paramArrayOfByte7.clone());
      label133: if (paramArrayOfByte8 == null)
        break label408;
      this._lsKey = ((byte[])paramArrayOfByte8.clone());
      label150: if (paramArrayOfByte9 == null)
        break label418;
      this._sKey = ((byte[])paramArrayOfByte9.clone());
      label167: if (paramArrayOfByte10 == null)
        break label428;
      this._userSig64 = ((byte[])paramArrayOfByte10.clone());
      label184: if (paramArrayOfByte11 == null)
        break label438;
      this._openid = ((byte[])paramArrayOfByte11.clone());
      label201: if (paramArrayOfByte12 == null)
        break label448;
      this._openkey = ((byte[])paramArrayOfByte12.clone());
      label218: if ((paramArrayOfByte == null) || (paramArrayOfByte.length != 7))
        break label468;
      this._vkey = ((byte[])paramArrayOfByte[0].clone());
      ...
      label315: this._access_token = ((byte[])paramArrayOfByte[2].clone());
      this._D2 = ((byte[])paramArrayOfByte[3].clone());
      this._D2Key = ((byte[])paramArrayOfByte[4].clone());
      this._sid = ((byte[])paramArrayOfByte[5].clone());
    }
    while (true)
    {
      ...
      this._userStWebSig = new byte[0];
      break;
      label388: this._userA5 = new byte[0];
      break label116;
      label398: this._userA8 = new byte[0];
      break label133;
      label408: this._lsKey = new byte[0];
      break label150;
      label418: this._sKey = new byte[0];
      break label167;
      label428: this._userSig64 = new byte[0];
      break label184;
      label438: this._openid = new byte[0];
      break label201;
      label448: this._openkey = new byte[0];
      break label218;
      label458: this._noPicSig = new byte[0];
      break label315;
      label468: this._vkey = new byte[0];
      this._access_token = new byte[0];
      this._D2 = new byte[0];
      this._D2Key = new byte[0];
      this._sid = new byte[0];
